...
$post_neft = [
    // "tranRefNo" => "abc1234500001were",
    // "amount" => "10",
    // // "senderAcctNo" => "0020032998",
    // // "senderIFSC" => "ICIC0000020",
    // // "beneAccNo" => "9595123456789",
    // // "beneIFSC" => "ICIC0000104",
    // // "senderAcctNo" => "000451000301",
    // // "beneAccNo" => "000405002777",
    // // "beneIFSC" => "ICIC0000011",
    // "beneName" => "USER3",
    // "narration1" => "Test Transfer",
    // "crpId" => "PRACHICIB1",
    // "crpUsr" => "USER3",
    // "aggrName" => "SAMRADDHB",
    // "aggrId" => "CUST0675",
