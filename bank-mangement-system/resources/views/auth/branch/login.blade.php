              ...
              <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    <div class="wow soneFadeLeft sign-in-box">
                      <form action="{{route('submitlogin')}}" method="post" class="contact-form" data-saasone="contact-froms" id="login-form">
                          @csrf
                          <input type="text" name="branch" placeholder="Branch Code" class="branch login_branch">
                          <input type="password" name="password" placeholder="Password" class="password login_password">
                          <div class="text-left">

                          </div>
                          <div class="text-right">
                            <input type="hidden" name="branchstatus" id="branchstatus">
                    ...
                    <div class="wow soneFadeLeft varification-box" style="display: none;">
                        <form action="javascript:void(0);" method="post" data-saasone="contact-froms" id="varification-form">
                            @csrf
                            <input type="text" name="branch" placeholder="Branch Code" class="branch n_login_branch">
