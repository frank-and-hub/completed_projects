            ...
            <div class="col-lg-12">
                <div class="card bg-white">
                    <div class="card-body page-title">
                        ...
                        <a href="{!! route('branch.associate_list') !!}" style="float:right"
                            class="btn btn-secondary">Back</a>
                    </div>
                </div>
            </div>
        </div>
        <form action="{!! route('branch.associate_save') !!}" method="post" enctype="multipart/form-data"
            id="associate_register" name="associate_register">
            @csrf
                    ...
                    <div class="card bg-white">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4">Form No<sup
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4">Application Date<sup
                                                class="required">*</sup></label>
                                        <div class="col-lg-8 error-msg">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group row text-center">
                                        <div class="col-lg-12 ">
                                            {!! Form::hidden('haveSsbAccount',old('haveSsbAccount'),['id'=>'haveSsbAccount']) !!}
                                            {!! Form::hidden('Rd_Account_Investment',old('Rd_Account_Investment'),['id'=>'Rd_Account_Investment']) !!}
            ...
            <div class="col-lg-12">
                <div class="card bg-white">
                    <div class="card-body">
                        ...
                        <h3 class="d-none card-title mb-3">SSB Account Investment Plan Detail </h3>
                        <div class="form-group row d-none">
                            <label class="col-form-label col-lg-3">SSB Account opened<sup class="required">*</sup>
                            </label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="custom-control custom-radio mb-3  ">
                                                        ...
                                                        <label class="custom-control-label"
                                                            for="ssb_first_gender_female">Female</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8 error-msg">
                                            <input type="text" name="ssb_first_age" id="ssb_first_age"
                            ...
                            <DIV id="ssb_second_no_div" style="display: none">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-4">Percentage<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="ssb_second_percentage"
                                                    id="ssb_second_percentage" class="form-control">
                                            </div>
                                        </div>
                        ...
                        <div id="RdAccountInvestment" style="display:none">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5 error-msg">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="custom-control custom-radio mb-3 ">
                                                <input type="radio" id="rd_account_yes" name="rd_account"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="custom-control custom-radio mb-3  ">
                                                <input type="radio" id="rd_account_no" name="rd_account"
                        ...
                        <div style="display: none;" id="rd_account_detail">
                            <div class="form-group row">
                                <div class="col-lg-4 error-msg">
                                    <input type="text" name="rd_account_number" id="rd_account_number"
                                        class="form-control" readonly="" placeholder="RD Account Number">
                                </div>
                                <div class="col-lg-4 error-msg">
                                    <input type="text" name="rd_account_name" id="rd_account_name" class="form-control"
                                        readonly="" placeholder="Account Holder Name">
                                </div>
                                <div class="col-lg-4 error-msg">
                                    <div class="rupee-img"></div>
                                    <input type="text" name="rd_account_amount" id="rd_account_amount"
                                        class="form-control" readonly="" placeholder="Current Balance"
                      ...
                      <div class="col-lg-5 error-msg">
                        ...
                        <div style="display: none;" id="rd_account_form">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-5">Amount<sup
                                                class="required">*</sup></label>
                                        <div class="col-lg-7 error-msg">
                                            <div class="rupee-img"></div>
                                            <input type="text" name="rd_amount" id="rd_amount"
                                                class="form-control rupee-txt" value="500" readonly="readonly">
                                        </div>
                                        <!-- <div class="col-lg-1 error-msg left-padding0">
                            <img src="{{url('/')}}/asset/images/rs.png" width="9" > 
                          </div> -->
                                ...
                                <div class="col-lg-5">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-5">Payment Mode<sup
                                                class="required">*</sup></label>
                                        <div class="col-lg-7 error-msg">
                                            <select name="payment_mode" id="payment_mode" class="form-control">
                                                ...
                                                <option data-val="online-transaction-mode" value="2">Online transaction
                                                </option>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4">Tenure<sup
                                                class="required">*</sup></label>
                                        <div class="col-lg-7 error-msg">
                                            <label class="col-form-label col-lg-10">60 Months</label>
                                            <input type="hidden" name="tenure" id="tenure" class="form-control"
                                                value="60">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input type="hidden" name="rd_amount_maturity" id="rd_amount_maturity"
                                    class="form-control rupee-txt" value="0" readonly="readonly">
                                <input type="hidden" name="rd_rate" id="rd_rate" class="form-control rupee-txt"
                                    value="0" readonly="readonly">
                                <div class="col-lg-5">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-5">Form No<sup
                                                class="required">*</sup></label>
                                        <div class="col-lg-7 error-msg">
                            ...
                            <div id="payment_mode_cheque" style="display: none">
                                ...
                                <div class=" row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-4">Cheque Number<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                ...
                                <div class=" row" style="display: none;" id="cheque_detail">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-4">Cheque Number<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="rd_cheque_no" id="rd_cheque_no"
                                                    class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-4">Branch Name<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="rd_branch_name" id="rd_branch_name"
                                                    class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-4">Cheque Amount<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <div class="rupee-img"></div>
                                                <input type="text" name="cheque-amt" id="cheque-amt"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-4">Bank Name<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="rd_bank_name" id="rd_bank_name"
                                                    class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-4">Cheque Date<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <div class="input-group">
                                                    <span class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control " name="rd_cheque_date"
                                                        id="rd_cheque_date" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                            ...
                            <div id="payment_mode_online" style="display: none">
                                ...
                                <div class=" row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3">Transaction Id<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="rd_online_id" id="rd_online_id"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3">Date<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <div class="input-group">
                                                    <span class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control " name="rd_online_date"
                                                        id="rd_online_date">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3">Deposit Bank <sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <select name="rd_online_bank_id" id="rd_online_bank_id"
                                                    class="form-control">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-3">Deposit Bank Account <sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <select name="rd_online_bank_ac_id" id="rd_online_bank_ac_id"
                                                    class="form-control">
                                                    <option value=''>---Please Select---</option>
                                                    @foreach($samraddhBanks as $bank)
                                                    @if($bank['bankAccount'])
                                                    <option style="display: none;"
                                                        class="{{ $bank->id }}-bank-account bank-account"
                                ...
                                <div class=" row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="rd_ssb_account_number"
                                                    id="rd_ssb_account_number" class="form-control" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="rd_ssb_account_amount"
                                                    id="rd_ssb_account_amount" class="form-control" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-9 error-msg">
                                            <div class="row">
                                                <div class="col-lg-9">
                                                    <div class="custom-control custom-checkbox mb-3 ">
                                                        <input type="checkbox" id="old_rd_no_detail"
                                                            name="old_rd_no_detail" class="custom-control-input"
                                                            value="1">
                                                        <label class="custom-control-label" for="old_rd_no_detail"
                                                            value="1">Yes</label>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4">Full Name<sup
                                                class="required">*</sup></label>
                                        <div class="col-lg-8 error-msg">
                                            <input type="text" name="rd_first_first_name" id="rd_first_first_name"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4">Relationship<sup
                                                class="required">*</sup></label>
                                        <div class="col-lg-8" class="form-control">
                                            <select name="rd_first_relation" id="rd_first_relation"
                                                class="form-control">
                                                <option value="">Select Relation</option>
                                                @foreach ($relations as $val)
                                                <option value="{{ $val->id }}">{{ $val->name }}</option>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4">Date of Birth<sup
                                                class="required">*</sup> </label>
                                        <div class="col-lg-8 error-msg">
                                            <div class="input-group">
                                                <span class="input-group-prepend">
                                                ...
                                                <input type="text" class="form-control " name="rd_first_dob"
                                                    id="rd_first_dob">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4">Percentage<sup
                                                class="required">*</sup></label>
                                        <div class="col-lg-8 error-msg">
                                            <input type="text" name="rd_first_percentage" id="rd_first_percentage"
                                                class="form-control">
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8 error-msg">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="custom-control custom-radio mb-3 ">
                                                        <input type="radio" id="rd_first_gender_male"
                                                            name="rd_first_gender" class="custom-control-input"
                                                            value="1">
                                                        <label class="custom-control-label"
                                                            for="rd_first_gender_male">Male</label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="custom-control custom-radio mb-3  ">
                                                        <input type="radio" id="rd_first_gender_female"
                                                            name="rd_first_gender" class="custom-control-input"
                                                            value="0">
                                                        <label class="custom-control-label"
                                                            for="rd_first_gender_female">Female</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4">Age<sup class="required">*</sup></label>
                                        <div class="col-lg-8 error-msg">
                                            <input type="text" name="rd_first_age" id="rd_first_age"
                                                class="form-control" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-4">Mobile No<sup
                                                class="required">*</sup></label>
                                        <div class="col-lg-8 error-msg">
                                            <input type="text" name="rd_first_mobile_no" id="rd_first_mobile_no"
                                                class="form-control">
                                        </div>
                                    </div>
                            ...
                            <DIV id="rd_second_no_div" style="display: none">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8" class="form-control">
                                                ...
                                                <select name="rd_second_relation" id="rd_second_relation"
                                                    class="form-control">
                                                    <option value="">Select Relation</option>
                                                    @foreach ($relations as $val)
                                                    <option value="{{ $val->id }}">{{ $val->name }}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8 error-msg">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control " name="rd_second_dob"
                                                        id="rd_second_dob">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8 error-msg">
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="custom-control custom-radio mb-3 ">
                                                            <input type="radio" id="rd_second_gender_male"
                                                                name="rd_second_gender" class="custom-control-input"
                                                                value="1">
                                                            <label class="custom-control-label"
                                                                for="rd_second_gender_male">Male</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="custom-control custom-radio mb-3  ">
                                                            <input type="radio" id="rd_second_gender_female"
                                                                name="rd_second_gender" class="custom-control-input"
                                                                value="0">
                                                            <label class="custom-control-label"
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-4">Age<sup
                                                    class="required">*</sup></label>
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="rd_second_age" id="rd_second_age"
                                                    class="form-control" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                        ...
                        <div class="form-group row text-center">
                            <div class="col-lg-12">
                                <button type="button" class="btn btn-default" id="previous_form">Previous<i
                                        class="icon-paperplane ml-2"></i></button>
                                <button type="submit" class="btn btn-primary" id="associate_register_btn">Submit<i
                                        class="icon-paperplane ml-2"></i></button>
...
@include('templates.branch.associate_management2.partials.script')
@stop