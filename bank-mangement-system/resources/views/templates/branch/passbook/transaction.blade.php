       ...
       <div class="row">
            <div class="col-lg-12">
                <div class="card bg-white shadow">
                    <div class="card-body">
                    <form   method="post" enctype="multipart/form-data" action="{!! route('branch.transaction_start') !!}" id="fillter" name="fillter">
                        @csrf
        ...
        <div class="card bg-white border-0 mb-0">
          ...
          <div class="card-body px-lg-5 py-lg-5">
            {{Form::open(['url'=>route('correction.request'),'method'=>'POST','id'=>'renew-correction-form','class'=>'','name'=>'renew-correction-form'])}}
              ...
              <div class="form-group row">
               <label class="col-form-label col-lg-3">Corrections</label>
                <div class="col-lg-12">
                    {{Form::textarea('corrections','',['id'=>'','class'=>'form-control','placeholder'=>'Corrections','rows'=>'6','cols'=>'50'])}}
                </div>
              </div>
