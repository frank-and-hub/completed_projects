...
function printDiv(elem,id) {
  $('.hide_td').css("visibility", "hidden");
   $("#"+elem).print({
                  ...
                  deferred: $.Deferred().done(function() {  $('.hide_td').css("visibility", "visible");   coverprint(id); })
                });
                  }
 ...
 function pay_print(elem,id) {
  ...
  function printDivcer(elem) {
   ...
   $("#"+elem).print({
                  ...
                  footer: null,
                    //Log to console when printing is done via a deffered callback
                    deferred: $.Deferred().done(function() { $('.remove_lable').css("visibility", "visible");  $('.tr_remove').css("visibility", "visible"); console.log('Printing done', arguments); })
                });
}

function printDivMaturity(elem,id) {
  $('.hide_td').css("visibility", "hidden");
   $("#"+elem).print({
                    //Use Global styles
                    globalStyles : false,
                  ...
                  footer: null,
                    //Log to console when printing is done via a deffered callback
                    deferred: $.Deferred().done(function() {  $('.hide_td').css("visibility", "visible");   coverprintMaurity(id); })
                });
}

function coverprintMaurity(id)
{
  swal("Success!", "Passbook maturity page print sucessfully!", "success");
  location.reload();
}
</script>
