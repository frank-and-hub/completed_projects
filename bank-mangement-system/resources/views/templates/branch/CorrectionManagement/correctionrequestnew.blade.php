              ...
              <div class="col-md-12">
                <div class="form-group text-right">
                  <div class="col-lg-12 page">
                    ...
                    <button type="button" class=" btn btn-primary legitRipple" onClick="correctionSearchForm()">Submit</button>
    ...
    <div class="col-lg-12 table-section  ">
      <div class="card bg-white shadow ">
        <div class="card-header bg-transparent header-elements-inline">
          ...
          <div class="">
            <button type="button" class="btn btn-primary legitRipple exportcorrection ml-2" data-extension="0" style="float: right;">Export Excel</button>
          </div>
        </div>
