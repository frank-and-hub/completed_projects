        ...
        <div class="col-lg-12" id="print_recipt"> 
          ...
          <div class="card bg-white" >
            <div class="card-body">
                ...
                <h3 class="card-title mb-3 mb-0 text-dark bg-md-dark px-3 py-2 text-dark my-3">
                  {{ $loanDetails['loan']->name}}
                </h3>
              ...
              <div class="row">
                ...
                <div class="col-lg-1">:</div>
                <div class="col-lg-4   ">
                  {{ getMemberCompanyDataNew(getGroupLoanDetail($loanDetails->id)->groupleader_member_id)->member_id }}
                </div>
              </div>
              <div class="row">
...
--}}
              ...
              <div class="row">
                ...
                <div class="col-lg-1">:</div>
                <div class="col-lg-7">
                  {{ $loanDetails['member']['memberCompany']->member_id }} 
                </div>
              </div>
              @endif
              <br>
                ...
                <div class="table-responsive">
                  ...
                  @php $mDetails = getMemberCompanyDataNew($groupLoanMember->customer_id);
                  $url = URL::to('branch/member-detail/' . $groupLoanMember->customer_id . '?type=0');
                  @endphp
                    <tr>
