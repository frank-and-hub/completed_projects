...
<div class="row">
    <div class="col-lg-12 ">
        ...
        @php
            $gDetails = getMemberCompanyDataNew($LoanGuarantor->member_id);
        @endphp
        ...
        <div class="row">
            ...
            <div class="col-lg-7  "> 
                {{ $gDetails ? $gDetails->member->member_id : '' }}              
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-1">:</div>
            <div class="col-lg-7  "> 
                {{ $gDetails ? $gDetails->member->email : ''}}              
            </div>
        </div>
    ...
    <div class="col-lg-12 ">
        ...
        <div class="row">
            ...
            @if($applicantAddressFiles)
                ...
                $url = ImageUpload::generatePreSignedUrl($foldeName);
                @endphp
                <div class="col-lg-7"><a href="{{ $url }}" target="blank">{{ $applicantAddressFile->file_name }}</a></div>                @endforeach
            @endif
        </div>
        <div class="row">
            ...
            @if($gUnderDocFiles)
                ...
                $url = ImageUpload::generatePreSignedUrl($foldeName);
                @endphp
                <div class="col-lg-7"><a href="{{ $url }}" target="blank">{{ $gUnderDocFile->file_name }}</a></div>                @endforeach
            @endif
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            @if($applicantIncomeFiles)
                ...
                @php
                    ...
                    $url = ImageUpload::generatePreSignedUrl($foldeName);
                @endphp
                <div class="col-lg-7"><a href="{{ $url }}" target="blank">{{ $applicantIncomeFile->file_name }}</a></div>                @endforeach
            @endif
        </div>
        <div class="row">
            ...
            <div class="row">
                ...
                @if($files)
                    ...
                    @php
                            ...
                            $url = ImageUpload::generatePreSignedUrl($foldeName);
                        @endphp
                        <div class="col-lg-7  "> <a href="{{ $url }}" target="blank">{{ $file->file_name }}</a> </div>                    @endforeach
                @endif
            </div>
        @endforeach
    </div>
