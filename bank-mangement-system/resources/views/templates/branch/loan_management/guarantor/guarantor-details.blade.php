...
<div class="form-group row guarantor-member-detail-box">
  ...
  <div class="col-lg-4">
    <input type="text" name="guarantor_dob" id="guarantor_dob" class="form-control date_of_birth">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    <input type="text" name="guarantor_dependents_number" id="guarantor_dependents_number" class="form-control" autocomplete="off">
  </div>
</div>
