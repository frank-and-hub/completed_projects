...
@section('content')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-12">Loan Type <span
                                                    class="required">*</span></label>
                                            <div class="col-lg-12 error-msg">
                                                <!-- <div class="input-group"> -->
                                                <select class="form-control loan_type" id="loan_type" name="loan_type" readonly>
                                                    <option value="L" selected>Loan</option>
                                                </select>
                                                <!-- </div> -->
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4 group_leader_div d-none">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-12">Group Leader ID </label>
                                            <div class="col-lg-12 error-msg">
                                                <input type="text" name="group_loan_common_id"
                                                    id="group_loan_common_id" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-12 error-msg">
                                                <select class="form-control" id="status" name="status">
                                                    ...
                                                    <option value="7">Approved Hold</option>
                                                    <option value="8">Cancle</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <div class="col-lg-12 text-right">
                                                ...
                                                <input type="hidden" name="loan_recovery_export"
                                                    id="loan_recovery_export" value="">
                        ...
                        <div class="card-header bg-transparent">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-right">
                                    <button type="button" class="btn btn-primary legitRipple export ml-2"
                                        data-extension="0" style="float: right;">Export Excel</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="card bg-white border-0 mb-0">
                            ...
                            <div class="card-body px-lg-5 py-lg-5">
                                <form action="{{ route('branch.loan.depositeloanemi') }}" method="post" id="loan_emi"
                                    name="loan_emi">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="application_date" id="deposite_date"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="penalty_amount" id="penalty_amount"
                                    ...
                                    <div class="form-group row gst1" style="display:none;">
                                        ...
                                        <div class="col-lg-4 gst1">
                                            <input type="text" name="cgst_amount" id="cgst_amount"
                                                class="form-control" readonly="">
                                        </div>
                                        <label class="col-form-label col-lg-2" id="label2"></label>
                                        <div class="col-lg-4 gst1">
                                            <input type="text" name="sgst_amount" id="sgst_amount"
                                                class="form-control" readonly="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row gst2" style="display:none;">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="igst_amount" id="igst_amount"
                                                class="form-control" readonly="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
    ...
    @endforeach
                                        ...
                                        <div class="col-lg-4 ssb-account" style="display: none;">
                                            <input type="text" name="ssb_account" id="ssb_account"
                                                class="form-control" readonly="">
                                        </div>
                                    </div>
    ...
    @endforeach -->
                                        ...
                                        <label class="col-form-label col-lg-2 online-transaction">UTR number / Transaction
                                            Number<sup>*</sup></label>
                                        <div class="col-lg-4 online-transaction">
                                            <input type="text" name="utr_transaction_number"
                                                id="utr_transaction_number" class="form-control">
                                        </div>
                                    </div>
                                    <div class="  " id="cheque-detail-show" style="display: none;">
                                        ...
                                        <div class=" form-group row">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" name="customer_branch_name"
                                                    id="customer_branch_name" class="form-control" readonly>
                                            </div>
                                    ...
                                    <div id="company_bank_detail">
                                        <h5 class="card-title font-weight-semibold company_bank_detail"
                                            style="display: none;">Company Bank</h5>
                                        <div class="form-group row other-bank" style="display: none;">
                                            ...
                                            <div class="col-lg-4">
                                                <select name="bank_account_number" id="bank_account_number"
                                                    ...
                                                    @foreach ($cBanks as $bank)
                                                        @if ($bank['bankAccount'])
                                                            <option
                                                                class="{{ $bank->id }}-bank-account c-bank-account"
                                                                value="{{ $bank['bankAccount']->account_no }}"
                                                                data-account="{{ $bank['bankAccount']->id }}"
                                                                style="display: none;">
    ...
    @section('script')
        ...
        $.validator.addMethod("checkFormatCustom", function(value, element, p) {
            ...
            if ($(p).val() == 1) {
                ...
                // end changes of ecs charge
                $('#company_idd').change(function(e) {
                    var company_id = $('#company_idd').val();
                    var loanType = $('#loan_type').val();
                    if (loanType == "") {
                        $(this).val('');
                        swal('Warning!', 'Please select the loan type first');
                        return false;
                    }
                    if ($(this).val() == "") {
                        return false;
