              ...
              <div class="col-lg-12">
                <select name="loan" id="loan" class="form-control" title="Please select something!" disabled="">
                  ...
                  @php
                    ...
                    if($loan->emi_option == 1)
                        $emiType  = 'Month';
                    elseif($loan->emi_option == 2)
                        $emiType  = 'Week';
                    else
                        $emiType  = 'Days';
                  @endphp
                  
                      <option value="{{ $loan->loan_id }}" >{{ $loan->name }}</option>
            ...
            @csrf
                ...
                <div class="form-group row personal-loan-section">
                  ...
                  <div class="col-lg-4">
                    ...
                    ?>
                  <input type="text" name="emi_mode_option" id="emi_mode_option" class="form-control" value="{{ $emiOptions[$loanDetails['emi_option']]  ? ucwords($emiOptions[$loanDetails['emi_option']]) :  'N/A' }}" readonly>
                    <input type="hidden" name="emi_mode_option" value="@if(isset( $loanDetails['emi_option'] )){{ $loanDetails['emi_option'] }}@else  0 @endif ">
                  </div>
                </div>
                ...
                <div class="form-group row personal-loan-section">
                  ...
                  <div class="col-lg-4">
                    <input type="text" data-val="associate" name="acc_auto_member_id" id="acc_auto_member_id" class="form-control" value="{{ getAssociateNo($loanDetails->associate_member_id) ? getAssociateNo($loanDetails->associate_member_id) : ''}}" autocomplete="on" readonly="">
