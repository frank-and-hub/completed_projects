        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-body page-title"> 
                        ...
                        <h3 class="">Associate Business Compare Listing</h3> 
                    ...
                    <div class="card-header bg-transparent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h3 class="mb-0 text-dark">Associate Business Compare Report</h3>
...
@include('templates.branch.report.partials.associate_business_compare')
