...
<div class="">
  ...
  <!-- <div class="">
    <button type="button" class="btn btn-primary legitRipple export ml-2" data-extension="0">Export Excel</button>
    
    <button type="button" class="btn btn-primary  legitRipple export" data-extension="1" style="display: none;">Export PDF</button>
  </div> -->
  <div class="col-md-12">
  ...
  <input type="hidden" name="branch_id" id="branch_id" value="{{$company_id}}">
  <div class="col-md-12 mt-4">
    <h4 class="font-weight-semibold text-center">DAYBOOK</h4>
  </div>
  <div class="d-flex my-4 col-md-12 flex-wrap">
    <div class="pr-4">
        ...
        <table class="table table-flush" id="t">
          ...
          <tbody>
            ...
            <tr class="first_row">
              ...
              <td class="child" colspan="4"> {{number_format((float)$C_balance_cash, 2, '.', '')}}</td>
            </tr>
          </tbody>
          </tr>
        </table>
  ...
  <div class="card-body ">
    <div class="row">
      <div class="col-lg-12 text-center">
        <a href="{{ URL::to('branch/print/report/day_book_duplicate/?from_date='.$start_date.'&to_date='.$end_date.'&company_id='.bin2hex($company_id))}}" target="_blank" type="submit" class="btn btn-primary">View Print<i class="icon-paperplane ml-2"></i></a>
      </div>
    </div>

    @include('templates.branch.report.dublicate.new_day_book_script')