<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '#company_id', function() {
            ...
            $.ajax({
                type: "POST",
                url: "{!! route('branch.report.maturityListing.plans') !!}",
                dataType: 'JSON',
                data: {
        ...
        maturityReport = $('#maturity_list').DataTable({
            ...
            ajax: {
                ...
                "url": "{!! route('branch.report.maturityListing') !!}",
        ...
        $('.export-maturity').on('click', function() {
            ...
            $('form#filter').attr('action', "{!! route('branch.maturity.report.export') !!}");
        ...
        //             type : "post",
        //             dataType : "json",
        //             url :  "{!! route('branch.maturity.report.export') !!}",
        //             data : formData,
        ...
        $('#status').on('change', function() {
            ...
            if (status == 0) {
                $('#start_date').val(currentDate).attr('disabled', true);
