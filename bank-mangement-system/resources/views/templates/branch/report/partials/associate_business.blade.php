    ...
    autoclose: true
     ...
     employeeTable = $('#associate_bussiness_listing').DataTable({
        ...
        ajax: {
            ...
            "url": "{!! route('branch.report.associate_business') !!}",
        ...
        columns: [
           ...
           {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            ...
            {data: 'daily_deno_sum', name: 'daily_deno_sum', 
                "render":function(data, type, row){
                     if ( row.daily_deno_sum>=0 ) {
                         return row.daily_deno_sum+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'daily_renew', name: 'daily_renew', 
                "render":function(data, type, row){
                     if ( row.daily_renew>=0 ) {
                         return row.daily_renew+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'monthly_new_ac', name: 'monthly_new_ac'},

            {data: 'monthly_deno_sum', name: 'monthly_deno_sum', 
                "render":function(data, type, row){
                     if ( row.monthly_deno_sum>=0 ) {
                         return row.monthly_deno_sum+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'monthly_renew_ac', name: 'monthly_renew_ac'},

            {data: 'monthly_renew', name: 'monthly_renew', 
                "render":function(data, type, row){
                     if ( row.monthly_renew>=0 ) {
                         return row.monthly_renew+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'fd_deno_sum', name: 'fd_deno_sum', 
                "render":function(data, type, row){
                     if ( row.fd_deno_sum>=0 ) {
                         return row.fd_deno_sum+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
           ...
           /* {data: 'fd_renew_ac', name: 'fd_renew_ac'},
            ...
            {data: 'ssb_deno_sum', name: 'ssb_deno_sum', 
                "render":function(data, type, row){
                     if ( row.ssb_deno_sum>=0 ) {
                         return row.ssb_deno_sum+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'ssb_renew', name: 'ssb_renew', 
                "render":function(data, type, row){
                     if ( row.ssb_renew>=0 ) {
                         return row.ssb_renew+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'other_mt', name: 'other_mt', 
                "render":function(data, type, row){
                     if ( row.other_mt>=0 ) {
                         return row.other_mt+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'other_stn', name: 'other_stn', 
                "render":function(data, type, row){
                     if ( row.other_stn>=0 ) {
                         return row.other_stn+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'ni_m', name: 'ni_m', 
                "render":function(data, type, row){
                     if ( row.ni_m>=0 ) {
                         return row.ni_m+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'ni', name: 'ni', 
                "render":function(data, type, row){
                     if ( row.ni>=0 ) {
                         return row.ni+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'tcc_m', name: 'tcc_m', 
                "render":function(data, type, row){
                     if ( row.tcc_m>=0 ) {
                         return row.tcc_m+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
            ...
            {data: 'loan_recovery_amount', name: 'loan_recovery_amount', 
                "render":function(data, type, row){
                     if ( row.loan_recovery_amount>=0 ) {
                         return row.loan_recovery_amount+ " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }else {
                         return "N/A";
                     }
                 }
...
/*
    $('.export').on('click',function(){
        ...
        $('form#filter').attr('action',"{!! route('branch.report.associateBusinessListExport') !!}");
...
$('.export').on('click',function(e){
    ...
    function doChunkedExport(start,limit,formData,chunkSize){
        ...
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('branch.report.associateBusinessListExport') !!}",
            data : formData,
