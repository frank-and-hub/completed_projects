      ...
      <div class="card">
        <table class="table table-flush">
          ...
          <tr>
            ...
            <td></td>
            <!--  <td>{{number_format((float)$cashInhandclosing, 2, '.', '')}}</td> <td></td>
                           -->
  ...
  <div class="card-body ">
    <div class="row">
      <div class="col-lg-12 text-center">
        <a href="{{ URL::to('branch/print/report/day_book/?from_date='.$start_date.'&to_date='.$end_date)}}" target="_blank" type="submit" class="btn btn-primary">View Print<i class="icon-paperplane ml-2"></i></a>
      </div>
    </div>
