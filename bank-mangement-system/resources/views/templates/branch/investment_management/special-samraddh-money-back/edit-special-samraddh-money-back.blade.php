<div class="form-group row">
  ...
  <div class="col-lg-10">
    <input type="text" name="ssbacount" id="ssbacount" class="form-control" value="{{ $investments->ssb_account_number }}" disabled="">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    ...
    <input type="text" name="amount" id="amount" class="form-control rupee-txt ssmb-amount" value="{{ $investments->deposite_amount }}" disabled="">
