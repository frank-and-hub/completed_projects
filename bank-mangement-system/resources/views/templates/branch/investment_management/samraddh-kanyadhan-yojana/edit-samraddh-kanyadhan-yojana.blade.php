...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    <input type="text" name="guardian-ralationship" id="guardian-ralationship" class="form-control" value="{{ $investments->guardians_relation }}" disabled="">
  </div>
  <label class="col-form-label col-lg-2">Daughter name</label>
  <div class="col-lg-4">
    <input type="text" name="daughter-name" id="daughter-name" class="form-control" value="{{ $investments->daughter_name }}" disabled="">
  </div>
</div> 
  ...
  <div class="col-lg-4">
    <div class="input-group">
      <span class="input-group-prepend">
       ...
       <input type="text" name="dob" id="dob" class="form-control kanyadhan-dob" data-val="age" value="{{ $investments->dob }}" disabled="">
    </div>
  </div>
  <label class="col-form-label col-lg-2">Age</label>
  <div class="col-lg-4">
    <input type="text" name="age" id="age" class="form-control" readonly="" value="{{ $investments->age }}" disabled="">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    ...
    <input type="text" name="amount" id="amount" class="form-control rupee-txt monthly-deposite-amount"  value="{{ $investments->deposite_amount }}" disabled="">
  ...
  <div class="col-lg-4">
    <input type="text" name="tenure" id="tenure" class="form-control kanyadhan-yojna-tenure" value="{{ $investments->tenure }}" disabled="">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    <input type="text" name="phone-number" id="phone-number" class="form-control" value="{{ $investments->phone_number }}" disabled="">
  </div>
