      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
           ...
           <form  method="post" action="{{route('branch.renew.store')}}" id="renewal-form" name="renewal-form">
            @csrf
                ...
                <div class="daily-renew-investment-table renew-account-table" style="display: none;">
                  <table class="table table-flush">
                      ...
                      <tbody class="daily-renew-input-number">
                        <!-- <tr>
                          <td>
                            <input type="text" data-val="0" name="account_number[0]" class="form-control account-number account-number-0">
                            <input type="hidden" name="investment_id[0]" class="investment-id-0">
                          </td>
                          <td>
                            <input type="text" data-val="0" name="name[0]" class="form-control name-0" readonly="">
                          </td>
                          <td>
                            <input type="text" data-val="0" name="amount[0]" class="form-control renew-amount renew-amount-0">
                          </td>
                          <td>
                            <input type="text" name="deo_amount[0]" class="form-control deo-amount-0" readonly="">
                          </td>
                          <td>
                            <input type="text" data-val="0" name="associate_code[0]" class="form-control associate-code-0" readonly="">
                          </td>
                          <td>
                            <input type="text" data-val="0" name="associate_name[0]" class="form-control associate-name-0" readonly="">
                          </td>
                        </tr> -->
                      </tbody>
                  </table>
                ...
                <div class="form-group row rdfrd-renew-section" style="display: none;">
                  ...
                  <!-- <label class="col-form-label col-lg-2">Investment Plans<sup>*</sup></label>
                  <div class="col-lg-4">
                    <select name="rdfrdrenewplan" id="rdfrdrenewplan" class="form-control renewinvestmentplan" title="Please select something!">
                        <option data-val="Recurring Deposit" value="10">Recurring Deposit</option>
                        <option data-val="Flexi Recurring Deposit" value="5">Flexi Recurring Deposit</option>
...
@section('script')
@include('templates.branch.investment_management.renewal.partials.script')
@stop
