...
<div class="container-fluid mt--6">
  ...
  <div class="content-wrapper">
      ...
      <div class="col-lg-12" id="print_recipt">
          ...
          <?php //echo "<pre>"; print_r($renewFields); die; ?>
            ...
            <div class="card-body">
              ...
              <div class="  row">
                ...
                <div class="col-lg-4   ">
                  ...
                  {{ str_replace('"}','',str_replace('{"name":"','',$branchName)) }}
        ...
        <div class="col-lg-12">
          ...
          <div class="card bg-white" >            
            ...
            <div class="card-body">
              ...
              <a href="{!! route('investment.renew') !!}" class="btn btn-secondary">Back</a>
