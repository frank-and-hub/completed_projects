                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    @if ($renewFields['renewplan_id'] == 0)
                                        Daily Deposite
                                    @elseif($renewFields['renewplan_id'] == 3)
                                        Daily Deposite Money Back
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    @endphp
                                    {{ date('d/m/Y', strtotime($renewFields['renewal_date'])) }}
                                </div>
                            </div>
                            <div class="row">
                                ...
                                @if ($accountDetail)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            ?>
                                            @if (
                                                $renewFields['scheme_name'] == 'Saving Account' ||
                                                    $renewFields['scheme_name'] == 'Daily Deposite' ||
                                                    $renewFields['scheme_name'] == 'Daily Deposite Money Back ' ||
                                                    $renewFields['scheme_name'] == 'Recurring Deposit')
                                                @php
                                                $data = (array) $renewFields['name']; @endphp
                                                {{ $data[$key] }}
                                            @else
                                    ...
                                    @if ($renewFields['renewplan_id'] != 2)
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <?php $companyid = getMemberInvestmentDetails($accountDetail)->company_id; $plan_id = getMemberInvestmentDetails($accountDetail,$companyid)->plan_id; ?>
                                                {{  getPlanDetailCheck($plan_id,$companyid)->name  }}
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    @if (
                                                        $renewFields['scheme_name'] == 'Saving Account' ||
                                                            ...
                                                            $renewFields['scheme_name'] == 'Recurring Deposit')
                                                        @php
                                                        $investment_tenure = (array) $renewFields['investment_tenure']; @endphp
                                                        {{ $investment_tenure[$key] }} Years
                                                    @else
                                        ...
                                        <div class="col-lg-8">
                                            @if (
                                                $renewFields['scheme_name'] == 'Saving Account' ||
                                                    ...
                                                    $renewFields['scheme_name'] == 'Recurring Deposit')
                                                @php
                                                $amount = (array) $renewFields['amount']; @endphp
                                                {{ $amount[$key] }} <img src="{{ url('/') }}/asset/images/rs.png"
                                                    width="9">
                                            @else
                                                {{ $renewFields['amount']->$key }} <img
                                                    src="{{ url('/') }}/asset/images/rs.png" width="9">
                                            @endif
                                        </div>
                                    </div>
    ...
    <div class="row">
                            ...
                            @if (
                                $renewFields['scheme_name'] == 'Saving Account' ||
                                    ...
                                    $renewFields['scheme_name'] == 'Recurring Deposit')
    @php
    $deo_amount = (array) $renewFields['deo_amount']; @endphp
                                {{ $deo_amount[$key] }} <img src="{{ url('/') }}/asset/images/rs.png" width="9">
@else
                                            ...
                                            <div class="col-lg-8">
                                                @if (
                                                    $renewFields['scheme_name'] == 'Saving Account' ||
                                                        ...
                                                        $renewFields['scheme_name'] == 'Recurring Deposit')
                                                    @php
                                                    $acoount_associate_name = (array) $renewFields['acoount_associate_name']; @endphp
                                                    {{ $acoount_associate_name[$key] }}
                                                @else
...
@else
    -->
                            ...
                            <div class="row">
                                <label class="col-lg-4">Total Amount : </label>
                                <div class="col-lg-8">
                                    {{ $totalAmount }} <img src="{{ url('/') }}/asset/images/rs.png"
                                        width="9">
                                </div>
                            </div>
                            <!--
        ...
        auth()->user()->getPermissionNames()->toArray(),
                ...
                @endif --}}
                                <button type="submit" class="btn btn-primary"
                                    onclick="printDiv('print_recipt');">Print<i class="icon-paperplane ml-2"></i></button>
