        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" id="renewal-form" name="renewal-form"
                        action="{{route('admin.renew.new.storeajax')}}">
                        @csrf
                        ...
                        <input type="hidden" name="globalDate" id="create_application_date"
                        ...
                        <div class="form-group row daily-renew-section" style="display: none;">
                            ...
                            <div class="col-lg-4">
                                <input type="text" data-val="daily-renewal-collector-name" name="collector_code"
                                    id="collector_code" class="form-control associate-code" placeholder="Collector Code"
                                    value="" autocomplete="off">
                            </div>
                            <label class="col-form-label col-lg-2">Collector Name</label>
                            <div class="col-lg-4">
                                <input type="text" name="collector_name" id="collector_name"
                                    class="form-control daily-renewal-collector-name" placeholder="Collector Name"
                                    value="" readonly="">
                            </div>
                        </div>
                        <div class="form-group row daily-renew-section" style="display: none;">
                            ...
                            <div class="col-lg-4">
                                <input type="text" data-val="daily-renew-input-number"
                                    data-table-class="daily-renew-investment-table" name="daily_no_of_accounts"
                                    class="form-control no-of-accounts daily-no-of-accounts"
                                    placeholder="Number of accounts" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group row rdfrd-renew-section" style="display: none;">
                            <label class="col-form-label col-lg-2">Number of accounts<sup>*</sup></label>
                            <div class="col-lg-4">
                                <input type="text" data-val="rdfrd-renew-input-number"
                                    data-table-class="rdfrd-renew-investment-table" name="rdfrd_no_of_accounts"
                                    class="form-control no-of-accounts rdfrd-no-of-accounts"
                                    placeholder="Number of accounts" autocomplete="off">
                            </div>
                            <label class="col-form-label col-lg-2">Associate Code<sup>*</sup></label>
                            <div class="col-lg-4">
                                <input type="text" data-val="rdfrd-renewal-associate-name" name="rdfrd_associate_code"
                                    id="rdfrd_associate_code" class="form-control associate-code"
                                    placeholder="Associate Code" value="" autocomplete="off" required="">
                            </div>
                        </div>
                        <div class="form-group row rdfrd-renew-section" style="display: none;">
                            <label class="col-form-label col-lg-2">Associate Name</label>
                            <div class="col-lg-10">
                                <input type="text" name="rdfrd_associate_name" id="rdfrd_associate_name"
                                    class="form-control rdfrd-renewal-associate-name" placeholder="Associate Name"
                                    value="" readonly="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row deposite-saving-section" style="display: none;">
                            <label class="col-form-label col-lg-2">Associate Code<sup>*</sup></label>
                            <div class="col-lg-4">
                                <input type="text" data-val="deposite-saving-associate-name" name="associate_code"
                                    id="associate_code" class="form-control associate-code" placeholder="Associate Code"
                                    value="" autocomplete="off">
                            </div>
                            <label class="col-form-label col-lg-2">Associate Name</label>
                            <div class="col-lg-4">
                                <input type="text" name="associate_name" id="associate_name"
                                    class="form-control deposite-saving-associate-name" placeholder="Associate Name"
                                    value="" readonly="">
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" data-val="0" name="account_number[0]"
                                                class="form-control account-number account-number-0" autocomplete="off"
                                                style="width:230px;">
                                            <input type="hidden" name="investment_id[0]" class="investment-id-0">
                                            <input type="hidden" name="investment_tenure[0]"
                                                class="investment-tenure-0">
                                        ...
                                        <td>
                                            <input type="text" data-val="0" name="name[0]" class="form-control name-0"
                                                readonly="" tabIndex="-1" style="width:230px;">
                                        </td>
                                        <td>
                                            <div class="col-lg-12">
                                                <div class="rupee-img">
                        ...
                        <div class="  " id="cheque-detail-show" style="display: none;">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">Cheque Number</label>
                                <div class="col-lg-4">
                                    <input type="text" name="cheque-number" id="cheque-number" class="form-control"
                                        readonly>
                                </div>
