<div class="form-group row">
  ...
  <div class="col-lg-4">
    ...
    <input type="text" name="amount" id="amount" class="form-control rupee-txt sb-amount" autocomplete="off">
  ...
  <div class="col-lg-4">
    <input type="text" name="interest-rate" class="form-control rupee-txt sb-maturity-amount-cal" readonly>
  </div>
  <label class="col-form-label col-lg-2"> Tenure<sup></sup></label>
  <div class="col-lg-4">
    <input type="text" name="tenure" class="form-control rupee-txt sb-tenure" readonly>
    <input type="hidden" name="maturity-amount" class="form-control rupee-txt sb-maturity-amount-val" readonly>
  </div>
</div>
<h4 class="sb-maturity-amount"></h4>
</div>  
