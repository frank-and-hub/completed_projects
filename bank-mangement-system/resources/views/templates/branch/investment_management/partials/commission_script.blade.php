<script type="text/javascript">
    ...
    $(document).ready(function() {  
        ...
        commissiontable = $('#commission_listing').DataTable({
            ...
            ajax: {
                "url": "{!! route('branch.investment.commissionlisting') !!}",
                "type": "POST",
                headers: {
		...
		$("#cover").fadeIn(100);
			...
			$('form#filter').attr('action',"{!! route('branch.investmentcommission.export') !!}");
    ...
    function doChunkedExport(start,limit,formData,chunkSize){
        ...
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('branch.investmentcommission.export') !!}",
            data : formData,
