...
<div class="container-fluid mt--6">
                ...
                <div class="card-body">
                    ...
                    @csrf
                        <div class="row">
							...
							<div class="col-md-4">
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-12">Group Loan Common ID </label>
                                    <div class="col-lg-12 error-msg">
        ...
        <div class="modal-content">
          <div class="modal-body p-0">
            <div class="card bg-white border-0 mb-0">
              ...
              <div class="card-body px-lg-5 py-lg-5">
                  <form action="{{route('grouploan.depositeloanemi')}}" method="post" id="loan_emi" name="loan_emi">
                      @csrf
                      <input type="hidden" name="loan_id" id="loan_id">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4">
                            <input type="text" name="application_date" class="form-control " autocomplete="off" value="{{ headerMonthAvailability(date('d'),date('m'),date('Y'),$stateid) }}" readonly>
                          </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4">
                            <input type="text" name="loan_associate_code" id="loan_associate_code" class="form-control" required="">
                          </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4">
                            <input type="text" name="penalty_amount" id="penalty_amount" value="0" class="form-control" readonly="">
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-form-label col-lg-2 ssb-account" style="display: none;">SSB Amount</label>
 ...
 -->
                        ...
                        <h5 class="card-title font-weight-semibold other-bank" style="display: none;">Company Bank</h5>
                        <div class="form-group row other-bank" style="display: none;">
