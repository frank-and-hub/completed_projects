              ...
              <div class="card bg-white" >
                <div class="card-body">
                  <div class="text-center">
                     <button type="submit" class="btn btn-primary avoid-this" onclick="Print('print_id');" data-id="{{$data['id']}}" id="print">Print </button>
                  </div>
                </div>
              </div>
            </div>
...
@include('templates.branch.loan_management.partials.print_js')
@stop
