...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    <input type="text" data-val="applicant" name="auto_applicant_id" id="auto_applicant_id" class="form-control" value="{{ getApplicantid($loanDetails->applicant_id) }}" autocomplete="off" readonly="">
