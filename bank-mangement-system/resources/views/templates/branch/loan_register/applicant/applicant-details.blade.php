...
<!---------- Loan against Investment plan  ------------------->
<h3 class="loan-against-investment-plan" style="display: none;">Applicant's Deposit Details</h3>
<div class="loan-against-investment-plan" style="overflow: auto;display: none;">
  <table class="table table-flush">
      ...
      <tbody class="investment-plan-input-number">
      </tbody>
  </table>
</div>
<!---------- Loan against Investment plan  ------------------->
...
<div class="form-group row cheque-mode p-mode show_emp_detail" style="display:none;">
  <label class="col-form-label col-lg-2 emp_staff" style="display:none;">Employee Code<sup>*</sup></label>
    <div class="col-lg-4 emp_staff" style="display:none;">
      <input type="text" name="emp_code" id="emp_code" class="form-control" readonly>
    </div>

    <label class="col-form-label col-lg-2 show_emp_detail" style="display:none;">Employee Name<sup class="required">*</sup></label>
      <div class="col-lg-4 error-msg">
        <input type="text" name="employee_name" id="employee_name" class="form-control show_emp_detail" readonly style="display:none;"> 
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    <input type="text" name="applicant_organization" id="applicant_organization" class="form-control" value="{{old('applicant_organization')}}">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    <input type="text" name="applicant_designation" id="applicant_designation" class="form-control" readonly="">
  </div>
  <label class="col-form-label col-lg-2">Monthly Income<sup>*</sup></label>
  <div class="col-lg-4">
    <input type="text" name="applicant_monthly_income" id="applicant_monthly_income" class="form-control"  value="{{old('applicant_monthly_income')}}">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    <input type="text" name="applicant_year_from" id="applicant_year_from" class="form-control" value="{{old('applicant_year_from')}}">
  </div>
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    <input type="text" name="applicant_bank_name" id="applicant_bank_name" class="form-control" value="{{old('applicant_bank_name')}}">
  </div>
  <label class="col-form-label col-lg-2">Bank Account Number <sup>*</sup> </label>
  <div class="col-lg-4">
    <input type="text" name="applicant_bank_account_number" id="applicant_bank_account_number" class="form-control" value="{{old('applicant_bank_account_number')}}">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    <input type="text" name="applicant_ifsc_code" id="applicant_ifsc_code" class="form-control" value="{{old('applicant_bank_name')}}">
  </div>
  <label class="col-form-label col-lg-2 cheque-box">Cheque Number 1<sup>*</sup></label>
  <div class="col-lg-4 cheque-box">
    <input type="text" name="applicant_cheque_number_1" id="applicant_cheque_number_1" class="form-control" value="{{old('applicant_cheque_number_1')}}">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode cheque-box">
  ...
  <div class="col-lg-4">
    <input type="text" name="applicant_cheque_number_2" id="applicant_cheque_number_2" class="form-control" value="{{old('applicant_cheque_number_2')}}">
  </div>
</div>
...
<div class="form-group row">
  ...
  <!-- <div class="col-lg-5  error-msg">
    <div class="row">         -->          
    <div class="col-lg-4 ">
      <input type="text" name="applicant_id_number" id="applicant_id_number" class="form-control" value="{{old('applicant_id_number')}}">
    </div>
    <div class="col-lg-1 ">
...
<div class="form-group row">
  ...
  <div class="col-lg-12">
    <select name="applicant_address_id_proof" id="applicant_address_id_proof" class="form-control" title="Please select something!">
      ...
      <option data-val="applicant_address" value="1">Voter ID</option>
      <option data-val="applicant_address" value="2">DL</option>
      <option data-val="applicant_address" value="3">Aadhar card</option>
      <option data-val="applicant_address" value="4">Passport</option>
      <option data-val="applicant_address" value="5">Pan Card</option>
      <option data-val="applicant_address" value="6">Other</option>
      <option data-val="applicant_address" value="7">Electricity Bill</option>
    </select>
  </div>
</div>
...
<div class="form-group row">
  <label class="col-form-label col-lg-2">Enter Id number<sup>*</sup></label>
  <div class="col-lg-4 ">
    <input type="text" name="applicant_address_id_number" id="applicant_address_id_number" class="form-control" value="{{old('applicant_address_id_number')}}">
  </div>
  <div class="col-lg-1 ">
...
<div class="form-group row">
  ...
  <div class="col-lg-4 applicant-salary-remark" style="display: none;">
    <input type="text" name="applicant_remark" id="applicant_remark" class="form-control" value="{{old('applicant_remark')}}">
  </div>
</div>