...
<h3 class="mb-0 text-dark mb-0 text-dark bg-md-dark px-3 py-2 text-dark my-3">Co-applicant Details</h3>
        ...
        <div class="row">
            <label class=" col-lg-4">Co-Applicant Id</label>
        ...
        <div class="row">
            ...
            <div class="col-lg-1">:</div>
            <div class="col-lg-7  "> {{ $caDetails->first_name }} {{ $caDetails->last_name }}</div>
        </div>

        <div class="row">
            <label class=" col-lg-4">Father's Name</label> 
            <div class="col-lg-1">:</div>
            <div class="col-lg-7  "> {{ $caDetails->father_husband }} </div>
        </div>

        <div class="row">
            <label class=" col-lg-4">Email Id</label> 
            <div class="col-lg-1">:</div>
            <div class="col-lg-7  "> {{ $caDetails->email }} </div>
        </div>

        <div class="row">
            <label class=" col-lg-4">Mobile Number</label> 
            <div class="col-lg-1">:</div>
            <div class="col-lg-7  "> {{ $caDetails->mobile_no }} </div>
        </div>
...
<div class="col-lg-7  "> <a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/coapplicant/id_proof/'.$applicantFile->file_name.'') }}" target="blank">{{ $applicantFile->file_name }}</a> </div>
@endforeach
</div>
<div class="row">
...
<div class="row">
<label class=" col-lg-4">Upload File <sup class="required">*</sup></label> 
<div class="col-lg-1">:</div>
@php
...
@if($applicantAddressFiles)
	...
	<div class="col-lg-7"><a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/coapplicant/address_proof/'.$applicantAddressFile->file_name.'') }}" target="blank">{{ $applicantAddressFile->file_name }}</a></div>
	@endforeach
@endif
</div>
...
<div class="row">
	...
	@if($coapplicantUnderDocFiles)
		...
		<div class="col-lg-7"><a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/coapplicant/undertakingdoc/'.$coapplicantUnderDocFile->file_name.'') }}" target="blank">{{ $coapplicantUnderDocFile->file_name }}</a></div>
		@endforeach
	@endif
</div>
...
@if($applicantIncomeFiles)
	...
	<div class="col-lg-7"><a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/coapplicant/income_proof/'.$applicantIncomeFile->file_name.'') }}" target="blank">{{ $applicantIncomeFile->file_name }}</a></div>
	@endforeach
@endif
</div>
<div class="row">
