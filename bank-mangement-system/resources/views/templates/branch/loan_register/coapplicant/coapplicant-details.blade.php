...
<div class="form-group row co-applicant-form">
  ...
  <div class="col-lg-10">
    <input type="text" data-val="co-applicant" name="co-applicant_auto_member_id" id="co-applicant_auto_member_id" class="form-control" readonly>
    <input type="hidden" data-val="co-applicant" name="co-applicant_member_id" id="co-applicant_member_id" class="form-control">
  </div>
</div>

<div class="co-applicant-member-detail co-applicant-form" id="show_mwmber_detail">
</div>
...
<div class="form-group row cheque-mode p-mode co-applicant-form">
  ...
  <div class="col-lg-4">
    <input type="text" name="co-applicant_organization" id="co-applicant_organization" class="form-control" value="Samradh bestwin" value="{{old('co-applicant_organization')}}">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode co-applicant-form">
  ...
  <div class="col-lg-4">
    <input type="text" name="co-applicant_designation" id="co-applicant_designation" class="form-control" readonly="">
  </div>
  <label class="col-form-label col-lg-2">Monthly Income<sup>*</sup></label>
  <div class="col-lg-4">
    <input type="text" name="co-applicant_monthly_income" id="co-applicant_monthly_income" class="form-control" value="{{old('co-applicant_monthly_income')}}">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode co-applicant-form">
  ...
  <div class="col-lg-4">
    <input type="text" name="co-applicant_year_from" id="co-applicant_year_from" class="form-control" value="{{old('co-applicant_year_from')}}">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode co-applicant-form">
  ...
  <div class="col-lg-4">
    <input type="text" name="co-applicant_bank_name" id="co-applicant_bank_name" class="form-control" value="{{old('applicant_bank_name')}}">
  </div>
  <label class="col-form-label col-lg-2">Bank Account Number </label>
  <div class="col-lg-4">
    <input type="text" name="co-applicant_bank_account_number" id="co-applicant_bank_account_number" class="form-control" value="{{old('co-applicant_bank_account_number')}}">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode co-applicant-form">
  ...
  <div class="col-lg-4">
    <input type="text" name="co-applicant_ifsc_code" id="co-applicant_ifsc_code" class="form-control" value="{{old('co-applicant_ifsc_code')}}">
  </div>
  <label class="col-form-label col-lg-2">Cheque Number 1</label>
  <div class="col-lg-4">
    <input type="text" name="co-applicant_cheque_number_1" id="co-applicant_cheque_number-1" class="form-control" value="{{old('co-applicant_cheque_number_1')}}">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode co-applicant-form">
  ...
  <div class="col-lg-4">
    <input type="text" name="co-applicant_cheque_number_2" id="co-applicant_cheque_number_2" class="form-control" value="{{old('co-applicant_cheque_number_2')}}">
  </div>
...
<div class="form-group row co-applicant-form">
  ...
  <div class="col-lg-4 ">
    <input type="text" name="co-applicant_id_number" id="co-applicant_id_number" class="form-control" value="{{old('co-applicant_id_number')}}">
  </div>
  <div class="col-lg-1 ">
  ...
  <label class="col-form-label col-lg-2">Upload File <sup>*</sup></label>
  <div class="col-lg-3">
...
<div class="form-group row co-applicant-form">
  ...
  <label class="col-form-label col-lg-2">Enter Id number<sup>*</sup></label>
  <div class="col-lg-3">
    <input type="text" name="co-applicant_address_id_number" id="co-applicant_address_id_number" class="form-control" value="{{old('co-applicant_address_id_number')}}">
  </div>
  <div class="col-lg-1">
...
<div class="form-group row co-applicant-form">
  ...
  <div class="col-lg-4">
    <input type="file" name="co-applicant_address_id_file" id="co-applicant_address_id_file" class="form-control" value="{{old('co-applicant_address_id_file')}}">
  </div>
...
<div class="form-group row co-applicant-form">
  ...
  <div class="col-lg-4 co-applicant-salary-remark" style="display: none;">
    <input type="text" name="co_applicant_remark" id="co_applicant_remark" class="form-control" value="{{old('co_applicant_remark')}}">
  </div>
