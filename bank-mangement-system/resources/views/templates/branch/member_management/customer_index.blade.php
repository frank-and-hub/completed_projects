                        ...
                        <form action="#" method="post" enctype="multipart/form-data" id="filter" name="filter">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-right" >
                                    ...
                                    <input type="hidden" name="customer_export" id="customer_export" value="">
            ...
            <div class="col-lg-12 table-section hideTableData">                
                ...
                <div class="card bg-white shadow">
                    <div class="card-header bg-transparent">
                        <div class="row">
                            <div class="col-md-8">
                                <h3 class="mb-0 text-dark">Customer List</h3>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="table-responsive">
                        <table id="customer_listing" class="table table-flush">
                            <thead class="">
                                <tr>
                                    <th>S/N</th>
                                    <th>Join Date</th> 
...
@section('script')
@include('templates.branch.member_management.partials.customerlisting_script')
@stop