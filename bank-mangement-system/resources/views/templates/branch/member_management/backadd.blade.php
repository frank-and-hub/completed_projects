        ...
        <div class="col-lg-8">
                ...
                <div class="col-lg-12 error-msg">
                  <div class="input-group">
                    <span class="input-group-prepend">
                     ...
                     <input type="text" class="form-control  " name="application_date" id="application_date"  readonly value="{{ date('m/d/Y') }}">
                   </div>
                </div>
                </div>
                </div>
          ...
          <div class="card bg-white" >
            <div class="card-body">
              ...
              <div class="form-group row ">
                <label class="col-form-label col-lg-3">Special Categories</label>
                <div class="col-lg-9 error-msg">
                  <select class="form-control select" name="special_category" id="special_category" >  
                    <option value="0">Select Special Categories</option>
          ...
          <div class="card bg-white" >
            <div class="card-body">
              ...
              <div class="form-group row">
                <label class="col-form-label col-lg-3">Last Name<sup class="required">*</sup> </label>
                <div class="col-lg-9 error-msg">
                  <input type="text" name="nominee_last_name" id="nominee_last_name" class=" form-control"  >
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                <div class="col-lg-12 ">                  
                  <span class="text-center rounded-circle w-100">
                    <img alt="Image placeholder" src="{{url('/')}}/asset/images/user.png">
                  </span>
                </div>
