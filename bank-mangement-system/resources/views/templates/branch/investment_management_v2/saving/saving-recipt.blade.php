          ...
          <div class="card-body">
            ...
            <div class="  row">
              ...
              <div class="col-lg-8   ">
                ...
                {{ $investmentDetails[0]->memberCompany->member->member_id }}
            ...
            <div class="  row">
              ...
              <div class="col-lg-8   ">
                ...
                {{ $investmentDetails[0]->memberCompany->member->first_name }} {{ $investmentDetails[0]->memberCompany->member->last_name }}
            ...
            @if(isset($investmentDetails[0]->mi_charge) && isset($investmentDetails[0]->stn_charge ))
