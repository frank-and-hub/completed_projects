...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    <div class=" nominee-dob">
      <span class="input-group-prepend">
        <span class="input-group-text"><i class="ni ni-calendar-grid-58"></i></span>
      </span>
       <input type="text"r eadonly name="fn_dob" id="fn_dob" class="fn_dateofbirth form-control" data-val="fn_age">
...
<div class="form-group row" id="minor_hide">
                <label class=" col-lg-2">If Minor </label>
                <div class="col-lg-6 error-msg">
                  <div class="row">
                    <div class="col-lg-2">
                      <div class="custom-control custom-checkbox mb-3 ">
                        <input type="checkbox"   id="fn_as_minor" name="fn_as_minor" class="custom-control-input fn_as_minor" value="1" >
                        <label class="custom-control-label" for="fn_as_minor" value="1">Yes</label>
                      </div>
                    </div> 
                  </div>
                </div> 
              ...
              <div id="nominee_parent_detail" style="display: none">
                <div class="form-group row">
				       <label class="col-form-label col-lg-2">Parent Name <sup class="required">*</sup> </label>
                  <div class="col-form-label col-lg-4 error-msg">
                    <input type="text" name="fn_parent_nominee_name" id="fn_parent_nominee_name" class=" form-control alpha-only"  >
                  </div>
			            <label class="col-form-label col-lg-2">Parent Mobile No<sup class="required">*</sup> </label>
                  <div class="col-form-label col-lg-4 error-msg">
                    <input type="text" name="fn_parent_nominee_mobile_no" id="fn_parent_nominee_mobile_no" class=" form-control">
                  </div>
...
<div class="form-group row second-nominee" style="display: none;">
  ...
  <div class="col-lg-4">
    ...
    <span class="input-group-prepend">
     ...
     <input type="text" readonly name="sn_dob" id="sn_dob" class="sn_dateofbirth form-control" data-val="sn_age">
   </div>
  </div>
...
<div class="form-group row second-nominee" style="display: none;">
  ...
  <div class="col-lg-4">
    <input type="text" name="sn_percentage" id="sn_percentage" data-id="fn_percentage" class="form-control nominee-percentage">
        ...
        <div class="form-group row second-nominee" style="display: none;" id="minor_hide">
                <label class="col-lg-2">If Minor </label>
                <div class="col-lg-6 error-msg">
                  <div class="row">
                    <div class="col-lg-2">
                      <div class="custom-control custom-checkbox mb-3 ">
                        <input type="checkbox"   id="sn_as_minor" name="sn_as_minor" class="custom-control-input sn_as_minor" value="1" >
                        <label class="custom-control-label" for="sn_as_minor" value="1">Yes</label>
                      </div>
                    </div> 
                  </div>
                </div> 
              </div>
	<div class="form-group row second-nomineef"   id="nominee_parent_second_detail" style="display: none">

	  <label class="col-form-label col-lg-2">Parent Name<sup>*</sup></label>
	  <div class="col-lg-4">
		<input type="text" name="sn_parent_nominee_name" id="sn_parent_nominee_name" class=" form-control"  >
	  </div>
	  <label class="col-form-label col-lg-2">Parent Mobile No<sup>*</sup></label>
	 <div class="col-lg-4">
		 <input type="text" name="sn_parent_nominee_mobile_no" id="sn_parent_nominee_mobile_no" class=" form-control"  >
	  </div>
