            ...
            if($row->investment_id)
                {
                    ...
                    $ac = App\Models\SavingAccount::where('member_id',$member_id)->first();
                    if($ac){
                    $ac = $ac->account_no;
                    }
                    else{
        ...
        <tr>
            ...
            <td>{{ $ac }}</td>
             <td>@if($row->investment_id!='')
               {{getMemberData($member_id)->first_name.' '.getMemberData($member_id)->last_name}}
                @else
                 @endif
            </td>
             @if($row->investment_id !='')
                <td>{{ getMemberData($associate_id)->associate_no }}</td>
            @else
                <td></td>
            @endif
            <td>
                @if($row->investment_id !='')
                    {{ getMemberData($associate_id)->first_name.' '.getMemberData($associate_id)->last_name }}
                @else
                @endif
            </td>
