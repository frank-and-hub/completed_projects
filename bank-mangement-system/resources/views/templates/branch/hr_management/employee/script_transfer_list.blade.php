  ...
  $('#end_date').datepicker({
    ...
    autoclose: true
     ...
     employeeTable = $('#emp_transfer_listing').DataTable({
        ...
        ajax: {
            "url": "{!! route('branch.hr.employee_transfer') !!}",
            "type": "POST",
    ...
    $('.export').on('click',function(){
        ...
        $('form#filter').attr('action',"{!! route('branch.hr.employee_transfer_export') !!}");
        $('form#filter').submit();
        return true;
    }); 
*/
$('.export').on('click',function(e){
    ...
    function doChunkedExport(start,limit,formData,chunkSize){
        ...
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('branch.hr.employee_transfer_export') !!}",
            data : formData,
  ...
  $(document).on('keyup','#employee_code',function(){ 
    ...
    $('#employee_transfer_time').val('');
          $.ajax({
              type: "POST",  
              url: "{!! route('branch.trasnsferCount') !!}",
              dataType: 'JSON',
              data: {'code':code},
              headers: {
                  'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
