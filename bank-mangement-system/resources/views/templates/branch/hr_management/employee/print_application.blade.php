                  ...
                  <div class="row">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td style="padding:4px;width: 16%;">Branch : 
                        </td>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 text-right">
            ...
            @if($type=='1')
               ...
               @if(in_array('Print Application', auth()->user()->getPermissionNames()->toArray()))
                 <button type="submit" class="btn btn-primary" onclick="printDiv('application_details');"> Print<i class="fas fa-print ml-2" ></i></button>
              @endif
              
              @else              
              @if(in_array('Employee Print Application', auth()->user()->getPermissionNames()->toArray()))
                 <button type="submit" class="btn btn-primary" onclick="printDiv('application_details');"> Print<i class="fas fa-print ml-2" ></i></button>
              @endif
        ...
        <div class="col-lg-6 text-left">
          ...
          @if($type=='1')
              ...
              @if(in_array('Download Application', auth()->user()->getPermissionNames()->toArray()))
              <form action="{!! route('branch.hr.employee_application_export_pdf') !!}" method="post" enctype="multipart/form-data" id="employee_register" name="employee_register"  >
    @csrf
                <input type="hidden" name="id" id="id" value="{{$employee->id}}">
                <button type="submit" class="btn btn-primary"  >Download<i class="fas fa-download ml-2" ></i></button>
              </form>
               @endif
          ...
          @if(in_array('Employee Download Application', auth()->user()->getPermissionNames()->toArray()))
              <form action="{!! route('branch.hr.employee_application_export_pdf') !!}" method="post" enctype="multipart/form-data" id="employee_register" name="employee_register"  >
    @csrf
                <input type="hidden" name="id" id="id" value="{{$employee->id}}">
                <button type="submit" class="btn btn-primary"  >Download<i class="fas fa-download ml-2" ></i></button>
...
@section('script')
@include('templates.branch.hr_management.employee.script_print')
@stop