                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-lg-12 error-msg">
                                 <select   name="branch" id="branch" class="form-control" >
                                    ...
                                    <option value="{{ $val->id }}" @if($employee->branch_id ==$val->id) selected @endif>{{ $val->name }}</option>
                                    @endforeach
                                 </select>
                              </div>
                           </div>
                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-lg-8 error-msg">
                           ...
                           @if(isset($_GET['type']))
            <input type="hidden" name="app_id" id="app_id" class=" form-control" value="{{ $_GET['type'] }}" >
                           @endif
                        </div>
                     </div>
                     <div class="form-group row">
               ...
               <div class="card" >
                  <div class="card-body">
                     ...
                     <div class="form-group row ">
                        ...
                        <div class="col-lg-8 error-msg">
                           <textarea name="permanent_address" id="permanent_address" class="form-control">{{ $employee->voter_id }}</textarea>
                        </div>
                     </div>
               ...
               <div class="card" >
                  <div class="card-body">
                     ...
                     <div class="form-group  row">
                        ...
                        <div class="col-lg-8 error-msg">
                           <input type="text" name="bank_address" id="bank_address" class="form-control" value="{{ $employee->bank_branch_name }}">
                        </div>
                     </div>
                     <div class="form-group row ">
                     ...
                     <div class="form-group row ">
                        <label class="col-form-label col-lg-4"> Confrom Account Number </label>
                        <div class="col-lg-8 error-msg">
                           <input type="text" name="cAccount_no" id="cAccount_no" class="form-control" >
                        </div>
                     </div>
                     <div class="form-group row ">
                        <label class="col-form-label col-lg-4">IFSC Code </label>
                        <div class="col-lg-8 error-msg">
