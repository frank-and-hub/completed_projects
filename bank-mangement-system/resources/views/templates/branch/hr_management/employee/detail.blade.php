              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                    <div class=" row">
                        ...
                        <div class="col-lg-5 ">{{date("d/m/Y", strtotime($application->status_date))}}</div>
                    </div>
                </div>
                @endif
                ...
                <div class="col-lg-4">
                    <div class=" row">
                        ...
                        <!-- <div class="col-lg-7 "><a href="{{url('/')}}/asset/employee/resign/{{$application->resign_file}}"  target='_blank'  >{{$application->resign_file}}</a></div> -->
                        <div class="col-lg-7 "><a href="{{ImageUpload::generatePreSignedUrl('employee/resign/' . $application->resign_file) }}"  target='_blank'  >{{$application->resign_file}}</a></div>
                    </div>
                </div>
                @endif
                @if($application->application_type==2)
        ...
        <div class="col-lg-7">
          <div class="card bg-white" > 
            <div class="card-body">
              ...
              <div class="row">
                ...
                <!--<div class="col-lg-6">
                  <div class="row">
                      ...
                      <div class="col-lg-7 "> 
                     @if($employee->is_employee ==1)     {{  number_format((float)$employee->salary, 2, '.', '')}} <img src='{{url('/')}}/asset/images/rs.png' width='7'>  @else N/A @endif
                      </div>
                    </div>
                </div>-->
              ...
              <div class="col-lg-6">
                  <div class="row">
                      <label class=" col-lg-5">ESI Accounnt No.: </label>
                      <div class="col-lg-7 "> 
                ...
                <div class="col-lg-6">
                  <div class="row">
                      <label class=" col-lg-5">UAN/PF  Accounnt No.: </label>
                      <div class="col-lg-7 "> 
              ...
              <div class="row">
                <div class="col-lg-12 text-center ">                  
                  <span class="text-center rounded-circle w-100">
                    ...
                    @else
                    <?php
                     $folderName = 'employee/'.$employee->photo;
                     if (ImageUpload::fileExists($folderName) && $employee->photo != '') {
                        $photo_url = ImageUpload::generatePreSignedUrl($folderName);
                     } else {
                        $photo_url = url('/') . "/asset/images/user.png";
                     }
                     ?> 
                     <img alt="Image placeholder" id="photo-preview" src="{{$photo_url}}" width="150">
                    @endif
                  </span>
                </div> 
              </div>
                            ...
                            <tbody>
                              ...
                              @foreach($app as $val)
                                <tr>
                                    ...
                                    <td style="border: 1px solid #ddd;padding: 0.5rem 0.1rem;"><div class="col-lg-12 ">
                                      <!-- <a href="{{url('/')}}/asset/employee/resign/{{$val->resign_file}}"  target='_blank'  >{{$val->resign_file}}</a></div> -->
                                      <a href="{{ImageUpload::generatePreSignedUrl('employee/resign/' . $val->resign_file) }}"  target='_blank'  >{{$val->resign_file}}</a></div>
                              ...
                              @foreach($transfer as $val)
                                <tr>
                                    ...
                                    <td style="border: 1px solid #ddd;padding: 0.5rem 0.1rem;">  <div class="col-lg-12 ">
                                     ...
                                     <td style="border: 1px solid #ddd; padding: 0.5rem 0.1rem;"><div class="col-lg-12 "> 
                                      <?php $url7 = URL::to("branch/hr/employee/transfer_letter/".$employee->id); ?><a class="" href="{{$url7}}" title="Transfer Letter"><i class="fas fa-envelope text-default mr-2 "></i></a> 
                                      <?php $url = URL::to("branch/hr/employee/transfer/detail/".$val->id.""); ?>
