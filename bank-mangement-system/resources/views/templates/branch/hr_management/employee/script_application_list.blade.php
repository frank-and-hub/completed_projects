   ...
   var Startdate = new Date();
    ...
    $('#end_date').datepicker({
     ...
     empApplicationTable = $('#emp_application_listing').DataTable({
        ...
        ajax: {
            "url": "{!! route('branch.hr.employee_application') !!}",
            "type": "POST",
    ...
    $('.export').on('click',function(){
        ...
        $('form#filter').attr('action',"{!! route('branch.hr.employee_application_export') !!}");
        $('form#filter').submit();
        return true;
    }); 
*/
$('.export').on('click',function(e){
    ...
    function doChunkedExport(start,limit,formData,chunkSize){
        ...
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('branch.hr.employee_application_export') !!}",
            data : formData,
