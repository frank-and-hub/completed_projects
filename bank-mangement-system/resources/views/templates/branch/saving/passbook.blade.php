        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body page-title">
                        <h3 class="">Passbook For : {{ $accountDetail->account_no  }}</h3>
            ...
            <div class="col-lg-12">                
                ...
                <div class="card bg-white shadow">
                    <div class="card-body">
                        ...
                        <form action="{!! route('branch.printpassbookfilter',['id'=>$accountDetail->id,'member'=>$memberDetail->id]) !!}" method="post" enctype="multipart/form-data" id="fillter" name="fillter">
                        @csrf
...
<?php } ?>                      
        ...
        <?php if(isset($is_fillter))  {?>
            <div class="col-lg-12" id="printBtn">
                  <div class="card bg-white" >            
                    <div class="card-body">
                      <div class="text-center"> 
                         
                      <button type="submit" class="btn btn-primary" onclick="printDiv('print_passbook');" >Print<i class="icon-paperplane ml-2"></i></button> 
