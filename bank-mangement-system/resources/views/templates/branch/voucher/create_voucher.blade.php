         ...
         <div class="col-lg-12">
            <div class="card bg-white">
               <div class="card-body page-title">
                  <h3 class="">Receive Voucher Request</h3>
            ...
            <div class="col-lg-12">
               <div class="card bg-white">
                  <div class="card-body">
                     ...
                     <div class="row">
                        @include('templates.GlobalTempletes.listing',[
                        ...
                        <div class="col-lg-6">
                           <div class="form-group row">
                              ...
                              <div class="col-lg-9 error-msg">
                                 ...
                                 <input type="hidden" value="{{branchName()->state_id}}" id="state_id" name="state_id">
                              </div>
                           </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group row">
                              ...
                              <div class="col-lg-9 error-msg">
                                 <select name="head" id="head" class="form-control" autocomplete="off">
                        ...
                        <div class="col-lg-6 member-section" style="display: none">
                           <div class="form-group row">
                              <label class="col-form-label col-lg-3">Member Id<sup>*</sup></label>
                              <div class="col-lg-9 error-msg">
                                 <input type="text" name="member_id" id="member_id" class="form-control" required="">
                                 <input type="hidden" name="member_auto_id" id="member_auto_id" class="form-control">
                                 <input type="hidden" name="member_register_date" id="member_register_date">
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-lg-6 member-section" style="display: none">
                           <div class="form-group row">
                              <label class="col-form-label col-lg-3">Member Name<sup>*</sup></label>
                              <div class="col-lg-9 error-msg">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group row">
                              <label class="col-form-label col-lg-3">Receive Mode<sup>*</sup></label>
                              <div class="col-lg-9 error-msg">
                                 <select name="payment_mode" id="payment_mode" class="form-control">
                                    ...
                                    <option value="2" class="payment-mode-type"> Online Transaction </option>
                                 </select>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                           <div class="form-group row">
                              <label class="col-form-label col-lg-3">Receive Amount<sup>*</sup></label>
                              <div class="col-lg-9 error-msg">
                        ...
                        <div class="gst_charge col-lg-6" style="display: none;">
                           <div class="form-group row">
                              <label class="col-form-label col-lg-3">CGST Stationary Charge<sup>*</sup></label>
                              <div class="col-lg-9 error-msg">
                                 <input type="text" name="cgst_stationary_charge" id="cgst_stationary_charge" class="form-control" readonly>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="gst_charge col-lg-6" style="display: none;">
                           <div class="form-group row">
                              <label class="col-form-label col-lg-3">SGST Stationary Charge<sup>*</sup></label>
                              <div class="col-lg-9 error-msg">
                                 <input type="text" name="sgst_stationary_charge" id="sgst_stationary_charge" class="form-control" readonly>
                              </div>
                           </div>
                        </div>

                        <div class="igst_charge col-lg-6" style="display: none;">
                           <div class="form-group row">
                              <label class="col-form-label col-lg-3">IGST Stationary Charge<sup>*</sup></label>
                              <div class="col-lg-9 error-msg">
                                 <input type="text" name="igst_stationary_charge" id="igst_stationary_charge" class="form-control" readonly>
                              </div>
                           </div>
                        </div>
