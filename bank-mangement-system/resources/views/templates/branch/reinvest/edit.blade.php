          ...
          <div class="card bg-white" > 
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 error-msg">
                  <div class="input-group">
                    <span class="input-group-prepend">
                     ...
                     <input type="text" class="form-control  " name="application_date" id="application_date"  readonly value="{{ old('application_date', date('d/m/Y', strtotime($memberDetail->re_date))) }}" disabled>
                  </div>
                </div>
                </div>
                </div>
                ...
                <div class="col-lg-12 error-msg">
                     <input type="text" class="form-control  " name="member_id" id="member_id"  readonly value="{{  $memberDetail->member_id  }}" disabled>
                ...
                <div class="col-lg-12 error-msg">
                     <select class="form-control select" name="branch_id" id="branch_id" readonly disabled="disabled">  
                    <option value="">Select branch</option>
                    @foreach( $branch as $val )
                    <option value="{{ $val->id }}"  @if(old('branch_id',$memberDetail->branch_id) == $val->id ) selected @endif  >{{ $val->name }}</option> @endforeach
                  </select>
                </div>
                </div>
                </div>
                ...
                <div class="col-lg-9 error-msg">
                  <div class="input-group">
                   <span class="input-group-prepend">
                     ...
                     <input type="text" class="form-control " readonly name="anniversary_date" id="anniversary_date" value=" @if ( $memberDetail->anniversary_date != null ) {{ old('anniversary_date', date('d/m/Y', strtotime
                     ($memberDetail->anniversary_date))) }} @endif">
                  </div>
                </div>
              </div>
              <div class="form-group row ">
