...
<div class="content" >   
 ...
 <tr>
                                       <td>{{$index+1}}</td>
                                       <td>@if($value->entry_date){{date("d/m/Y", strtotime(convertDate($value->entry_date)))}} @endif</td>
                                       <td>{{ $value->btid }}</td>
                                      
                                      <td>{{$memberAccount}} </td>
                                      <td>{{$plan_name}} </td>
                                      <td>
                                         @if($value->sub_type==43 || $value->type == 13  || $value->sub_type ==35 || $value->sub_type ==37 || $value->sub_type ==33 || $value->sub_type==34)
                                            @if($associate_name)
