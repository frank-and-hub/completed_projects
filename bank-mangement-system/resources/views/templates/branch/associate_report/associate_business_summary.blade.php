        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-body page-title"> 
                        ...
                        <h3 class="">Associate Business Summary Listing (Branch Wise)</h3> 
                    ...
                    <div class="card-header bg-transparent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <h3 class="mb-0 text-dark">Associate Business Summary Report(Branch Wise)</h3>
...
@include('templates.branch.associate_report.partials.associate_business_summary')
