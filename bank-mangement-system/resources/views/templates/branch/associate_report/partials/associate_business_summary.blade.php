...
$(document).ready(function () {
    ...
    autoclose: true
     ...
     employeeTable = $('#associate_bussiness_listing').DataTable({
        ...
        ajax: {
            ...
            "url": "{!! route('branch.associatereport.associate_business_summary') !!}",
 ...
 /*   $('.export').on('click',function(){
        ...
        $('form#filter').attr('action',"{!! route('branch.associatereport.associateBusinessSummaryExportBranchWise') !!}");
...
e.preventDefault();
		...
		$(".loaders").text("0%");
        doChunkedExportAssociateBusinessBranchWise(0,chunkAndLimit,formData,chunkAndLimit);
		$("#cover").fadeIn(100);
		}else{
		$('#emp_application_export').val(extension);
        $('form#filter').attr('action',"{!! route('branch.associatereport.associateBusinessSummaryExportBranchWise') !!}");
...
// function to trigger the ajax bit
    function doChunkedExportAssociateBusinessBranchWise(start,limit,formData,chunkSize){
        formData['start']  = start;
        formData['limit']  = limit;
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('branch.associatereport.associateBusinessSummaryExportBranchWise') !!}",
            data : formData,
			  headers: {
                  'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
              },
            success: function(response) {
                ...
                if(response.result=='next'){
                    ...
                    doChunkedExportAssociateBusinessBranchWise(start,limit,formData,chunkSize);
