            ...
            <div class="col-lg-12">
                <div class="card bg-white">
                    <div class="card-body page-title">
                        <h3 class="">Associate Loan Commission Details</h3>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-12 error-msg">
                                            ...
                                            <option value="{{ $value->year }}"  @if ($value->year == $yearG) selected @endif>{{ $value->year }}</option>
                                            @endforeach
                                            </select>
                                        </div>
                                    </div>
...
@section('script')
@include('templates.branch.associate_management.partials.listing_loan_script')
@stop