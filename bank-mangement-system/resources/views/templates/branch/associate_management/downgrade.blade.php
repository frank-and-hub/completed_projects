        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body page-title"> 
                        <h3 class="">Associate Downgrade</h3>
            ...
            <div class="col-lg-12">                
                ...
                <div class="card bg-white shadow">
                    <div class="card-header bg-transparent">
                                <h3 class="mb-0 text-dark">Downgrade Associate</h3>
                    </div>
                    <div class="card-body">
                        <form action="{!! route('branch.associate.downgrade_save') !!}" method="post" enctype="multipart/form-data" id="filter" name="filter">
                        @csrf
                        <input type="hidden" name="created_at" class="created_at">
                            <div class="row">
                             ...
                             <div class="row" id="hide_associate">
                                <div class="col-md-12">
                                    <h4 class=" text-dark ">Downgrade To </h4>
                                    <div class="form-group row">
...
@section('script')
@include('templates.branch.associate_management.partials.downgrage_js')
@stop