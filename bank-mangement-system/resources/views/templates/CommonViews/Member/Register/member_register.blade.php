@php
    ...
    $pathScript = 'templates/CommonViews/Member/Register/script';
@endphp
@extends($pathLayout)
@section('content')
<script>
...
<div class="content @if($admin != true) pl-5 pr-5 pt-2 pb-5 @endif" style="overflow: hidden;"> 
    ...
    <div class="row">
      <div class="col-lg-12 p-0">
        <div class="card bg-white" > 
          <div class="card-body">
            <h3 class="card-title mb-3 float-left">Member Registration</h3>
            <a href="javascript:void(0);" onclick="goBack()" style="float:right" class="btn btn-secondary">Back</a>
          </div>
        </div>
      </div>
    </div>
  @endif
    ...
    <div class="row">
      <div class="col-lg-12 p-0 mr-0">
          <div class="card p-3">
            <div clss="card-body">
              <div class="custom-control custom-checkbox mb-0 " style="padding-top: 8px;padding-bottom: 6px;" >
                <input type="checkbox" id="is_staff" name="is_employee" class="custom-control-input" value="1" >
                <label class="custom-control-label" for="is_staff">Is Employee</label>
              </div>
              <div class="row p-0 d-none" id="emp_code_block">
                <div class="col-md-3">
                  <label for="emp_code">Employee Code:</label>
                  <input type="text" name="emp_code" id="emp_code" data-panel="@if($admin == true) 1 @else 0 @endif" class="form-control" maxlength="6">
                </div>
                <div class="col-md-2 pt-3 @if($admin != true)  mt-3 @endif">
                  <button type="button" id="fetch_data" class="btn btn-primary">Apply</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <?php
    $stateid = (auth()->user()->role_id == 3) ? branchName()->state_id : 33;
    ?>
    <input type="hidden" name="g_at" id="g_at" value="{{checkMonthAvailability(date('d'), date('m'), date('Y'), $stateid)}}" />
    <div class="row main_form"> 
        ...
        @endif
        @if($admin == true)
        <form action="{!! route('admin.member-registration.save') !!}" method="post" enctype="multipart/form-data" id="member_register" name="member_register"  >
        @else
        <form action="{!! route('branch.member_registration.save') !!}" method="post" enctype="multipart/form-data" id="member_register" name="member_register">
        @endif
    @csrf
    <input type="hidden" id="created_at" name="created_at" class="created_at">
    <input type="hidden" name="emp_id" id="emp_id">
    <input type="hidden" name="employee_code" id="employee_code">
    <input type="hidden" name="isEmployee" id="isEmployee">
    ...
    <input type="hidden" name="getType" value="1">
      ...
      <div class="row">
        <div class="col-lg-8">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="col-lg-12 error-msg">
                        ...
                        <option data-val="{{ $val->state_id }}" value="{{ $val->id }}" >{{ $val->name }}</option> @endforeach
                      </select>
          ...
          <div class="card bg-white" id="personal_information">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9 error-msg">
                  <input type="text" name="email" id="email" class="form-control" value="" autocomplete="off">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9 error-msg">
                 <!-- <input type="text" name="f_h_name" id="f_h_name" class="form-control" pattern="[A-Za-z ]+" >-->
                ...
                <div class="col-lg-9 error-msg">
                  <div class="input-group">
                    <span class="input-group-prepend">
                     ...
                     <input type="text" class="form-control " name="anniversary_date" id="anniversary_date" >
                   </div>
                </div>
              </div>
              <div class="form-group row ">
          ...
          <div class="card bg-white" >
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9 error-msg">
                  <input type="text" name="bank_branch_name" id="bank_branch_name" class=" form-control bank_branch_name" >
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9 error-msg">
                  <input type="text" name="cbank_account_no" id="cbank_account_no" class=" form-control" >
                </div>
              </div>
              <div class="form-group row">
                <label class="col-form-label col-lg-3">IFSC Code</label>
                <div class="col-lg-9 error-msg">
                  <input type="text" name="bank_ifsc" id="bank_ifsc" class=" form-control" autocomplete="off"  >
                </div>
              </div>
              <div class="form-group row ">
          ...
          <div class="card bg-white" >
            <div class="card-body">
              <h3 class="card-title mb-3">Nominee Information <sup class="required">*</sup></h3>
              <div class="form-group row">
                ...
                <div class="col-lg-9 error-msg">
                  ...
                  <input type="hidden" name="nominee_id" id="nominee_id" class=" form-control"  value="0" pattern="[A-Za-z ]+" >
                </div>
              </div> 
              <div class="form-group row">
                  ...
                  <div class="row">
                    <div class="col-lg-9">
                      <div class="custom-control custom-checkbox mb-3 ">
                        <input type="checkbox" id="is_minor" name="is_minor" class="custom-control-input" value="1" checked onclick="return false;">
          ...
          <div class="card bg-white" >            
            <div class="card-body">
              ...
              <div class="form-group row ">
                ...
                <div class="col-lg-9 error-msg">
                  @if($admin == true)
                    <input type="text" name="associate_code" id="admin_associate_code" class="form-control"  >
                  @else
                    <input type="text" name="associate_code" id="branch_associate_code" class="form-control"  >
                  @endif
              ...
              <div class="form-group row " id="hide_carder">
                ...
                <div class="col-lg-9 error-msg">
                  <input type="text" name="associate_carder" id="associate_carder" class="form-control" readonly > 
                  <input type="hidden" name="carder_id" id="carder_id" class="form-control" readonly >
                </div>
              </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="custom-file error-msg">
                  ...
                  <input type="hidden" class="" id="hidden_photo" name="hidden_photo" >
          ...
          <div class="card" >            
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-12 error-msg">
                  @if($admin == true)
                    <select class="form-control " name="state_id" id="admin_state_id"
                    >  
                  ...
                  @else
                    <select class="form-control" name="state_id" id="branch_state_id"
                    >  
                      <option value="">Select State</option>
                      @foreach( $state as $val )
                      <option value="{{ $val->id }}"  >{{ $val->name }}</option> @endforeach
            ...
            <div class="card-body">
              ...
              <div class="form-group  ">
                ...
                <div class="col-lg-12 error-msg">
                  <select class="form-control select" name="first_id_type" id="first_id_type">
                    ...
                    @if( $val->id != 7)
                    <option value="{{ $val->id }}" {{$val->id == 5 ? 'selected' : ''}} >{{ $val->name }}</option> 
                    {{--{{$val->id == old('first_id_type',$val->id) ? 'selected' : ''}}--}}                    
                    @endif
                    @endforeach
                  </select>
                  <input type="hidden" name="emp_first_id_type" id="emp_first_id_type" value="">
              ...
              <div class="form-group  ">
                ...
                <div class="col-lg-12  error-msg">
                  <div class="row">                  
                  <div class="col-lg-10 ">
                    <input type="text" name="first_id_proof_no" id="first_id_proof_no" data-panel="@if($admin == true) 1 @else 0 @endif" class="form-control"  >
              ...
              <div class="form-group  ">
                ...
                <div class="col-lg-12 error-msg">
                  <select class="form-control select" name="second_id_type" id="second_id_type" >  
                    ...
                    @foreach( $idTypes as $val )
                      @if($val->id != 5 )
                      <option value="{{ $val->id }}" {{$val->id == 3 ? 'selected' : ''}} >{{ $val->name }}</option>
                      {{-- <option value="{{ $val->id }}" {{$val->id == old('second_id_type',$val->id) ? 'selected' : ''}} >{{ $val->name }}</option> --}} 
                      @endif
                    @endforeach
                  </select>
                  <input type="hidden" name="emp_second_id_type" id="emp_second_id_type" value="">
                </div>
              </div>
              ...
              <div class="form-group  ">
                ...
                <div class="col-lg-12  error-msg">
                  <div class="row">
                  <div class="col-lg-10 ">
                    <input type="text" name="second_id_proof_no" id="second_id_proof_no" data-panel="@if($admin == true) 1 @else 0 @endif" class="form-control"  >
                  </div>
                  <div class="col-lg-2 ">
        ...
        <div class="col-lg-12">
          <div class="card bg-white" >            
            <div class="card-body">
              ...
              <button  id="update" data-panel="@if($admin == true) 1 @else 0 @endif" class="btn btn-primary d-none">Update</button>
            </div>
            </div>
          </div>
        </div>
