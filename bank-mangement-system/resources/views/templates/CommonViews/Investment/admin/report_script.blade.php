<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        memberTable = $('#investment_report_isting').DataTable({
            ...
            ajax: {
                "url": "{!! route('common.investement.dailyReportListing') !!}",
                "type": "POST",
                "data": function(d) {
                    d.searchform = $('form#filter').serializeArray(), d.slug = $('#slug').val()
                },
                headers: {
        ...
        function doChunkedExport(start, limit, formData, chunkSize) {
            ...
            jQuery.ajax({
                type: "post",
                dataType: "json",
                url: "{!! route('common.investement_report.export') !!}",
                data: formData,
                success: function(response) {
