<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        data_table = $('#associate_bussiness_listing').DataTable({
            ...
            ajax: {
                "url": "{!! route('branch.common.associate_busniss_compare_list') !!}",
                "type": "POST",
                "data": function(d) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    name: 'SSBTCC',
                    "render": function(data, type, row) {
                        return row.SSBTCC + " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }
                },
                {
                    data: 'SSBRenewal',
                ...
                },
                {
                    ...
                    name: 'c_SSBTCC',
                    "render": function(data, type, row) {
                        return row.c_SSBTCC + " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }
                },
                {
                    data: 'c_SSBRenewal',
                ...
                },
                {
                    ...
                    name: 'diff_SSBTCC',
                    "render": function(data, type, row) {
                        return row.diff_SSBTCC + " <img src='{{url('/')}}/asset/images/rs.png' width='7'>";
                    }
                },
                {
        ...
        function doChunkedExport(start, limit, formData, chunkSize) {
            ...
            jQuery.ajax({
                type: "post",
                dataType: "json",
                url: "{!! route('branch.common.associate_busniss_report_exportcompare') !!}",
                data: formData,
