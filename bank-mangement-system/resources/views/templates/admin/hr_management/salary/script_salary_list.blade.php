...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        salaryTable = $('#salary_list').DataTable({
            ...
            ajax: {
                "url": "{!! route('admin.hr.salary_listing') !!}",
                "type": "POST",
                "data": function(d) {
            ...
            columns: [{
                ...
                {
                    data: 'total_payable_salary',
                    name: 'total_payable_salary'
                },
                {
                ...
                {
                    data: 'transferred_salary',
                    name: 'transferred_salary'
                },
                {
                    data: 'transferred_in',
                    name: 'transferred_in'
                ...
                {
                    data: 'employee_bank_ac',
                    name: 'employee_bank_ac'
                },
                {
                    data: 'employee_bank_ifsc',
                    name: 'employee_bank_ifsc'
                },
                {
                ...
                {
                    data: 'company_bank_ac',
                    name: 'company_bank_ac'
                },
                {
                    data: 'payment_mode',
                    name: 'payment_mode'
                ...
                {
                    data: 'company_cheque_id',
                    name: 'company_cheque_id'
                },
                {
                    data: 'online',
                    name: 'online'
        ...
        function doChunkedExport(start, limit, formData, chunkSize) {
            ...
            jQuery.ajax({
                type: "post",
                dataType: "json",
                url: "{!! route('admin.hr.salary_list_export') !!}",
                data: formData,
    ...
    function DeleteSalary(salary) {
        var sal_id = $(salary).data('sal');
        var created_at = $('.created_at').val();
        Swal.fire({
            title: "Are you sure to delete salary payment?",
            input: "textarea",
            inputAttributes: {
                id: "delete-reason",
            ...
            if (result.isConfirmed) {
                const reason = result.value; // Access reason from result.value
                $.ajax({
                    url: "{!! route('admin.hr.salary_delete') !!}",
                    type: 'POST',
                    data: {
                        id: sal_id,
                    ...
                    success: function(response) {
                        if (response.message == 'Employee salary deleted successfully') {
                            swal({
                                title: 'Success!',
    ...
    function DeleteSalarym(salary) {
        var emp = $(salary).data('emp');
        swal({
                title: "Are you sure?",
                text: "Do you want to delete salary payment of " + emp + "?",
                type: "warning",
                showCancelButton: true,
