    ...
    <div class="row">  
        ...
        <div class="col-md-12" >
                <div class="card">
                    ...
                    <form action="{!! route('admin.hr.salary_transfer_advance_save') !!}" method="post" enctype="multipart/form-data"  name="transfer_save" id="transfer_save" class="transfer_save" >
                        @csrf 
                        ...
                        <input type="hidden" name="company_id" class="company_id" value="{{$salary_list->company->id}}">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4 ">
                                ...
                                <div class="col-md-4 ">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 error-msg">
                                        <input type="text" name="transfer_amount" id="transfer_amount" class="form-control transfer_amount "   value="{{  number_format((float)$due, 2, '.', '') }}" readonly>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12" style="padding-top: 30px">
                           ...
                           <div class="col-md-12 cheque" >
                                  ...
                                  <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-2">Amount Mode <sup class="required">*</sup> </label>
                                            <div class="col-lg-7 error-msg">
                                ...
                                <div class="row branch"  style="display: none;">
                                  ...
                                  <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 error-msg">
                                                 <input class="form-control" id="branch_total_balance" name="branch_total_balance" readonly value=" "> 
                                            </div>
                                        </div>
                                  </div>
                                </div>
                                <div class="row bank"  style="display: none;">
                                  <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-2">Payment Mode <sup class="required">*</sup></label>
                                            <div class="col-lg-7 error-msg">
                              ...
                              <div class="row">
                                <div class="col-md-12" >
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" class="form-control total_transfer_amount" name="total_transfer_amount" id="total_transfer_amount" value="{{number_format((float)$due, 2, '.', '')}}" readonly> 
                                            </div>
                                        </div>
                                  </div>
                              </div>
...
@stop
@section('script')
@include('templates.admin.hr_management.salary.advance_script') 
@stop