    ...
    <div class="row">
        <div class="col-md-12" id='hide_div'>
            <div class="card">
                ...
                <form action="{!! route('admin.hr.salary_edit_save') !!}" method="post" enctype="multipart/form-data" name="salary_generate" id="salary_generate" class="salary_generate">
                    @csrf
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="salary[{{$index}}]" id="salary_{{$index}}" class="form-control salary " style="width: 100px" readonly value="{{ number_format((float)$EmployeeSalary->fix_salary, 2, '.', '') }}
">
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="leave[{{$index}}]" id="leave_{{$index}}" class="form-control leave " style="width: 100px" value="{{$EmployeeSalary->leave}}">
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="total_salary[{{$index}}]" id="total_salary_{{$index}}" class="form-control  total_salary" readonly style="width: 100px" value="{{ number_format((float)$EmployeeSalary->total_salary, 2, '.', '') }}
">
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="deduction[{{$index}}]" id="deduction_{{$index}}" class="form-control  deduction" style="width: 100px" value="{{$EmployeeSalary->deduction}}">
                                                    </div>
                                                </td>

                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="incentive_bonus[{{$index}}]" id="incentive_bonus_{{$index}}" class="form-control  incentive_bonus" style="width: 100px" value="{{$EmployeeSalary->incentive_bonus}}">
                                                    </div>
                                                </td>
                                                ...
                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="transfer_salary[{{$index}}]" id="transfer_salary_{{$index}}" class="form-control  transfer_salary" readonly style="width: 100px" value="{{ number_format((float)$EmployeeSalary->paybale_amount, 2, '.', '') }} ">
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="esi_amount[{{$index}}]" id="esi_amount_{{$index}}" class="form-control  esi_amount" style="width: 100px" value="{{$EmployeeSalary->incentive_bonus}}" @if($row->esi_account_no=='') readonly @endif>
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="pf_amount[{{$index}}]" id="pf_amount_{{$index}}" class="form-control  pf_amount" style="width: 100px" value="{{$EmployeeSalary->pf_amount}}" @if($row->pf_account_no =='') readonly @endif>
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="tds_amount[{{$index}}]" id="tds_amount_{{$index}}" class="form-control  tds_amount" style="width: 100px" value="{{$EmployeeSalary->tds_amount}}" @if($row->pen_card=='') readonly @endif>
                                                    </div>
                                                </td>
                                                <td style="border: 1px solid #ddd;">
                                                    <div class="col-lg-12 error-msg">
                                                        <input type="text" name="final_payable_amount[{{$index}}]" id="final_payable_amount_{{$index}}" class="form-control  final_payable_amount" style="width: 100px" value="{{ number_format((float)$EmployeeSalary->final_paybale_amount, 2, '.', '') }} " readonly>
                                                    </div>
                                                </td>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                @if(count($employee)>0)
                                <button type="submit" class=" btn bg-dark legitRipple" id="submit_transfer">Salary Update</button>
                                @endif
...
@stop
@section('script')
@include('templates.admin.hr_management.salary.edit_script')
@stop