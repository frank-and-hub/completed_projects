                  ...
                  <div class="row">
                    <div class="col-lg-12 text-center ">                  
                      <span class="text-center rounded-circle w-100">
                        ...
                        @else
                        <img alt="Image placeholder" id="photo-preview" src="{{url('/')}}/asset/employee/{{$employee->photo}}" width="150">
                        @endif
                        --}}
                        @if($employee->photo=='')
                          <?php 
                        ...
                        @else
                          <?php
                            $employee_folderName = 'employee/'.$employee->photo;
                            if (ImageUpload::fileExists($employee_folderName) && $employee->photo != '') {
                                $employee_photo_url = ImageUpload::generatePreSignedUrl($employee_folderName);
                            } else {
                                $employee_photo_url = url('/') . "/asset/images/user.png";
                            }
                          ?>
