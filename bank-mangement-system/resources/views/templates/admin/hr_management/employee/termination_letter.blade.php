...
<div class="content">   
      ...
      <div class="row">
         ...
         <div class="col-md-12" id="print_termiation">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h4 class="card-title font-weight-semibold  col-lg-12 text-center">Termiation Letter</h4>
                </div>
                <div class="card-body"> 
            ...
            <div class="col-lg-12">
              <div class="card bg-white" >            
                <div class="card-body">
                  ...
                  <button type="submit" class="btn btn-primary" onclick="printDiv('print_termiation');">Print </button></div>
                </div>
              </div>
            </div>
