...
$("#ssb_account_date").hover(function(){
      var date=$('#create_application_date').val(); 
      $('#ssb_account_date').datepicker({
          format:"dd/mm/yyyy",
            endHighlight: true, 
            autoclose:true, 
            endDate:date,
...
$.validator.addClassRules({ 
      ...
      examination:{ examinationRequired: function(element) {
...
$.validator.addClassRules({ 
      ...
      examination_passed:{ exaPassRequired: function(element) {
...
$.validator.addClassRules({ 
      ...
      work_start_old:{ workStartOLd:  true,dateDdMm: true,workdatevalidationOld:'work_start_old', },

        submitHandler: function (form) {    return false;   }  

});

$.validator.addMethod("workStartOLd", $.validator.methods.required,"Please enter work from date.");



$.validator.addClassRules({ 

      work_end:{ workEndOld:  true,dateDdMm: true,workdatevalidationOld:'work_start_old', },

        submitHandler: function (form) {    return false;   }  

});

$.validator.addMethod("workEndOld", $.validator.methods.required,"Please enter work to date.");
...
$.validator.addMethod("workdatevalidationOld", function(value, element,p) {

    id = $(element).attr('id');

    var res = id.substr(15); 
    ...
    {   
      ...
      var to = new Date(Date.parse($('#work_end_old_'+res).val()));



      moment.defaultFormat = "DD/MM/YYYY HH:mm";

     var f1 = moment($('#work_start_old_'+res).val()+' 00:00', moment.defaultFormat).toDate();

     var f2 = moment($('#work_end_old_'+res).val()+' 00:00', moment.defaultFormat).toDate();
    ...
    if(to>from)

      {
        ...
        $.validator.messages.workdatevalidationOld = "";

        result = true;

      }else{

        $.validator.messages.workdatevalidationOld = "To date must be greater than from date.";
      ...
      messages: {  
        select_date: {
         ...
         mobile_no:{
          ...
          language_known_1: "Please enter language known 1.",
...
var a=0;
   ...
   $("#add_qualification").click(function(){
    ...
    $("#qualification").on('click','.remCF_old',function(){
        ...
        swal({
                    ...
                    text: "You want to delete qualification",

                    type: "warning",

                    showCancelButton: true,

                    confirmButtonClass: "btn-primary quli_confirm_delete",

                    confirmButtonText: "Yes",

                    cancelButtonText: "No",

                    cancelButtonClass: "btn-danger quli_cancel_delete",
                  ...
                  function(isConfirm) {
...

                    {
                      ...
                      $('.quli_confirm_delete').attr('disabled',true);

                      $('.quli_cancel_delete').attr('disabled',true);
                      ...
                      $.ajax({
                        ...
                        url: "{!! route('admin.delete_qualification') !!}",
                        ...
                        success: function(response) { 
                         ...
                         // alert(response+' -- '+response.msg);
...

                          {
                              ...
                              swal("Success!", "Qualification Deleted Successfully.", "success");
...
var b=0;
   ...
   $("#add_diploma").click(function(){
    ...
    $("#diploma").on('click','.remDiploma_old',function(){
        ...
        swal({
                    ...
                    text: "You want to delete diploma",

                    type: "warning",

                    showCancelButton: true,

                    confirmButtonClass: "btn-primary diploma_confirm_delete",

                    confirmButtonText: "Yes",

                    cancelButtonText: "No",

                    cancelButtonClass: "btn-danger diploma_cancel_delete",
                  ...
                  function(isConfirm) {
...

                    {
                      ...
                      $('.diploma_confirm_delete').attr('disabled',true);

                      $('.diploma_cancel_delete').attr('disabled',true);

                      $.ajax({

                        type: "POST",  

                        url: "{!! route('admin.delete_diploma') !!}",
                        ...
                        success: function(response) { 
                         ...
                         // alert(response+' -- '+response.msg);
...

                          {
                              ...
                              $('#diploma_rem_'+id).remove();

                              swal("Success!", "Diploma Deleted Successfully.", "success");
  ...
  autoclose: true
    ...
    $("#experience").on('click','.remWork_old',function(){
        ...
        swal({
                    ...
                    text: "You want to delete work experience",
                  ...
                  function(isConfirm) {
...

                    {
                      ...
                      $('.experience_confirm_delete').attr('disabled',true);

                      $('.experience_cancel_delete').attr('disabled',true);

                      $.ajax({

                        type: "POST",  

                        url: "{!! route('admin.delete_experience') !!}",
                        ...
                        success: function(response) { 
                         ...
                         // alert(response+' -- '+response.msg);
...

                          {
                              ...
                              swal("Success!", "Work Experience Deleted Successfully.", "success");
              ...
              success: function(response) { 
                ...
                $('#designation').append('<option value="">Select Designation</option>');
                 ...
                 $.each(response.data, function (index, value) { 
                        ...
                        $('#salary').val('');
                        if($("#designation").val()){
                          $('#salary').val('{{  number_format((float)$employee->salary, 2, '.', '')}}');
                        }
      ...
      $.ajax({
          ...
          { 
...

            {
              ...
              if(ssb_account == response.account_no.account_no && $.trim(name) ==$.trim(response.name.toLowerCase())
              )
              {
