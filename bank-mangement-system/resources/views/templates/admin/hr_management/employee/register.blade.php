...
<div class="content"> 
    ...
    <div class="row"> 
        ...
        <form action="{!! route('admin.hr.employee_save') !!}" method="post" enctype="multipart/form-data" id="employee_register" name="employee_register"  >
              ...
              <div class="row">
                ...
                <div class="col-lg-12 error-msg">
                    <div class="input-group">                        
                        <input type="text" name="company_register_date" id="company_register_date"
...
@include('templates.admin.hr_management.employee.script_application_register')
