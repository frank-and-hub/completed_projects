                          ...
                          <div class="col-md-12">
                                ...
                                <div class="form-group row"> 
                                    ...
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchfilechrgForm()" >Submit</button>
                                        <button type="button" class="btn btn-gray legitRipple" id="reset_form" onClick="resetFileChrgForm()" >Reset </button>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="">
                        ...
                        <table id="file_chrg" class="table datatable-show-all">
...
@section('script')
@include('templates.admin.profit_loss.partials.file_charge_script')
