                                ...
                                <div class="form-group row"> 
                                    ...
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <input type="hidden" name="export" id="export" value="">
                                         ...
                                         <input type="hidden" name="head" id="head" value="{{$head_id}}">


                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchinterestDepositForm()" >Submit</button>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header header-elements-inline">
                        ...
                        <input type="hidden" name="date" id="date" value="{{$end_date}}">
                         <input type="hidden" name="branch_id" id="branch_id" value="{{$branch_id}}">
                    </div>
...
@section('script')
@include('templates.admin.profit_loss.partials.interest_on_deposit_script')
