        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{!! route('admin.profit&loss') !!}" method="post" enctype="multipart/form-data" id="profit-loss-filter" name="profit-loss-filter">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-lg-12 error-msg">
                                       ...
                                       <div class="input-group">
                                           <input type="text" class="form-control  " name="start_date" id="start_date"  value="{{$date}}"> 
