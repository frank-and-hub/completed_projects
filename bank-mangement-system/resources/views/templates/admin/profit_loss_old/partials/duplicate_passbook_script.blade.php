...
$('#filter').validate({
  ...
  $('form#filter').attr('action',"{!! route('admin.profit-loss.stationary_chrg.report.export') !!}");
  $('form#filter').submit();
});
 detailList = $('#duplicate_passbook').DataTable({
            ...
            "fnRowCallback" : function(nRow, aData, iDisplayIndex) {
                ...
                $('html, body').stop().animate({
                    ...
                    scrollTop: ($('#duplicate_passbook').offset().top)
            ...
            ajax: {
                ...
                "url": "{!! route('admin.profit-loss.duplicate_passbook_listing') !!}",
                    ...
                    if(oSettings.json != null)
                {
                    ...
                    var page = ($('#duplicate_passbook').DataTable().page.info());
...
$( document ).ajaxStart(function() {
 ...
 function searchduplicate_passbookForm()
    {
         $('#is_search').val("yes");
...
window.location.href = "{{url('/')}}/admin/profit-loss/duplicate_passbook?"+queryParams;

    }
function resetduplicate_passbookForm()
{
    location.reload();
    $('#is_search').val("no");
    $('#branch').val("");
