...
$('#filter').validate({
  ...
  $('#fuel').val(1);
  $('form#filter').attr('action',"{!! route('admin.profit-loss.fuel_charge.export') !!}");
  $('form#filter').submit();
  });
 detailList = $('#fuel_chrg').DataTable({
            ...
            "fnRowCallback" : function(nRow, aData, iDisplayIndex) {
                ...
                $('html, body').stop().animate({
                    ...
                    scrollTop: ($('#fuel_chrg').offset().top)
            ...
            ajax: {
                ...
                "url": "{!! route('admin.rofit-loss.fuel_charge_list') !!}",
                ...
                "data":function(d,oSettings) {
                    ...
                    if(oSettings.json != null)
                    {
                     ...
                     var page = ($('#fuel_chrg').DataTable().page.info());
...
function searchfuelchrgForm()
  ...
  // Set new or modify existing parameter value.
      ...
      window.location.href = "{{url('/')}}/admin/profit-loss/detailed/fuel_charge?"+queryParams;
    }

    function resetfuelchrgForm()
    {
     location.reload();
    $('#is_search').val("no");
    $('#branch').val("");
