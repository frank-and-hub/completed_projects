...
$('#filter').validate({
  ...
  $('form#filter').attr('action',"{!! route('admin.profit-loss.depreciation.export') !!}");
  $('form#filter').submit();
  });
 detailList = $('#depreciation_list').DataTable({
            ...
            ajax: {
                ...
                "url": "{!! route('admin.rofit-loss.depreciation_list') !!}",
...
$( document ).ajaxStart(function() {
 ...
 function searchdepreciationForm()
    {
    $('#is_search').val("yes");
...
// Set new or modify existing parameter value.
    ...
    window.location.href = "{{url('/')}}/admin/profit-loss/detailed/depreciation?"+queryParams;

    }

    function resetdepreciationForm ()
{
    location.reload();
    $('#is_search').val("no");
    $('#branch').val("");
