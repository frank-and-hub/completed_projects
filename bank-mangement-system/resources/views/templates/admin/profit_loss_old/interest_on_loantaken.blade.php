                          ...
                          <div class="col-md-12">
                                ...
                                <div class="form-group row"> 
                                    ...
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchloneTakenForm()" >Submit</button>
...
@section('script')
@include('templates.admin.profit_loss.partials.interest_on_loan_taken_script')
