     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="15" style="background:#fff; border:#000000 solid 2px;">
      ...
      <tr>
        <td width="70%" style="text-align:center;">
         ...
         <p >@if(isset($bill_status['companyName']->address)) {{$bill_status['companyName']->address}} @else N/A @endif Info.: Phone No.: +91 {{$bill_status['companyName']->mobile_no ?? N/A }} | Web: www.samraddhbestwin.com | Mail Us: {{$bill_status['companyName']->email ?? N/A}}</p>
