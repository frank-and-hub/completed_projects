...
<div class="content">
                        ...
                        <div class="container">
                            <div class=" form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="hidden" id="id" name="id" value="{{last(explode('/', url()->current()))}}" class="form-control">
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class=" form-group row">
                                <div class="col-lg-6">
                                    <label for="Pay">Re-Pay Amount</label>
                                    <input type="number" name="Pay" readonly value="{{$data['advancePayment']['repay'] ?? 0}}" class="form-control">
                                </div>
                                <div class="col-lg-6">
                                    <label for="Received">Received Amount</label>
                                    <input type="number" name="Received" readonly value="{{$data['advancePayment']['withdraw'] ?? 0}}" class="form-control">
                                </div>
                            </div>
                            <div class=" form-group row">
                                <div class="col-lg-6">
                                    <label for="Amount">Due Amount</label>
                                    <input type="number" name="approveAmount" readonly 
                                    @if($data['advancePayment']['settlement'] == 1 ) 
                                        value="0" 
                                    @else 
                                        value="{{$data['advancePayment']['amount'] - $data['advancePayment']['used_amount']}}" 
                                    @endif 
                                    class="form-control">
    ...
    <!-- Listings -->
    <div class="card bg-white col-lg-12 flisting">

        <div class="datatable-header header-elements-inline">
            <h6>TA Adjustment Listing</h6>
        </div>
...
@include('templates.admin.AdvancePayment.partials.adjestment_view_script')
