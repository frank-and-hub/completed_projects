                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="date" id="date" readonly value="" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-4">Advance Registration Date</label>
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" name="companyDate" readonly id="companyDate" value="{{$data['companyDate']}}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group d-flex">
                                            ...
                                            <div class="col-lg-6 error-msg">
                                                ...
                                                <input type="hidden" name="branch" value="{{$data['branch_id']}}">
                                            </div>
                                        </div>
                                    </div>
                                    {{-- @endif --}}
                    ...
                    <div class="col-lg-12 payment-type-box">
                        <div class="card taadvance bg-white" {{(isset($data['payment_type']) ? '' : 'style="display: none;"')}}>
                            <div class="card-body">
                                ...
                                <button type="button" id="tasubmit" class="btn bg-dark text-right float-right">Submit</button>
                            </div>
                        </div>
                    </div>
            </form>
...
@include('templates.admin.AdvancePayment.partials.script')
@stop