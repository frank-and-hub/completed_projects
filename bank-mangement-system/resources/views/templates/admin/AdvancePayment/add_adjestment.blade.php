                ...
                <form id="form">
                    ...
                    <div class="card-header header-elements-inline">
                        <div class="container-fluid">
                            ...
                            <div class="d-flex">
                                <input disabled type="checkbox" id="switch" /><label id="toggle" for="switch"></label>
                                <h5 class="ml-2"><b>To receive full payment from user</b></h5>
                                <input type="hidden" name="full_pay" id="full_pay">
                            </div>
                        ...
                        <table class="table table-flush" id="expense1">
                            ...
                            <tbody id="myTable">
                                <tr>
                                    <td>
                                        <div class="col-lg-12 error-msg">
                                            ...
                                            <select name="account_head" id="account_head" class="form-control valid frm">
                                                ...
                                                <option value="2" data-name="fixedasset">Assets</option>
                                            </select>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="col-lg-12 error-msg">
                                            <input type="file" name="img"  required class="form-control t_img frm" />
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="col-lg-12 error-msg">
                                            ...
                                            <input type="text" autocomplete="off" name="adjdate" readonly id="adjdate" value="" class="form-control t_date frm pDate" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-lg-12 error-msg">
                    ...
                    <div class="form-group row ml-2">
                        ...
                        <div class="col-lg-6 row  pl-4">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="remaining_amoutn" id="remaining_amount" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row ml-2 d-none" id="settle_amt">
                        ...
                        <div class="col-lg-6" id="ssb">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" name="ssbno" readonly value="{{$ssb}}" id="ssbno" class="form-control">
                                </div>
                            </div>
                        </div>
...
@include('templates.admin.AdvancePayment.partials.adjestment_script')
@stop