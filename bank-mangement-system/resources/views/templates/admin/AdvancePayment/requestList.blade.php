...
<div class="content">
        ...
        <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="card bg-white flisting" style="display:none;">
                    ...
                    <div class="card-header header-elements-inline">
                        <h6>Advance Request List</h6>
                        <div class="">
                            <button type="button" class="btn bg-dark legitRipple export-req ml-2" data-extension="0" style="float: right;">Export xslx</button>
    ...
    @include('templates.admin.AdvancePayment.partials.script_list')
