...
$(document).ready(function () {
    ...
    NonPerformingAssetsReport = $('#non_performing_assets_report').DataTable({
          ...
          columns: [
              ...
              {data: 'loan_plan_name', name: 'loan_plan_name'},
			  {data: 'lone_sanction_date', name: 'lone_sanction_date'},
			  {data: 'lone_sanction_amt', name: 'lone_sanction_amt'},
			  {data: 'emi', name: 'emi'},
			  {data: 'emi_amt', name: 'emi_amt'},
			  {data: 'emi_period', name: 'emi_period'},
			  {data: 'closing_date', name: 'closing_date'},
			  {data: 'last_recovery_date', name: 'last_recovery_date'},
			  {data: 'total_recovery_amt', name: 'total_recovery_amt'},
			  {data: 'over_due_day', name: 'over_due_day'},
          ]
      });
