    ...
    return result;
     ...
     employeeTable = $('#associate_bussiness_listing').DataTable({
        ...
        ajax: {
            ...
            "url": "{!! route('admin.report.associate_business_compare') !!}",
...
/*
     $('.export').on('click',function(){
        ...
        $('form#filter').attr('action',"{!! route('admin.report.associateBusinessCompareExport') !!}");
...
$('.export').on('click',function(e){
    ...
    function doChunkedExport(start,limit,formData,chunkSize){
        ...
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('admin.report.associateBusinessCompareExport') !!}",
            data : formData,
