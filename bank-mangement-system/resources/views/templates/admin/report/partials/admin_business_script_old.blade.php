  ...
  $('#end_date').datepicker({
    ...
    orientation:'bottom'
     ...
     adminBusinessTable = $('#admin_bussiness_listing').DataTable({
        ...
        ajax: {
            "url": "{!! route('admin.report.admin_business_listing') !!}",
            "type": "POST",
            "data":function(d) {
               d.branchid = branchid,
        ...
        columns: [
          ...
          //  {data: 'region_name', name: 'region_name'},
           // {data: 'zone_name', name: 'zone_name'},  
            ...
            {data: 'other_mi', name: 'other_mi'},
            {data: 'other_stn', name: 'other_stn'},
             
            {data:'new_mi_joining',name:'new_mi_joining'}, 
             {data:'new_associate_joining',name:'new_associate_joining'}, 
            ...
            {data: 'total_loan_sanction_ac', name: 'total_loan_sanction_ac'},
            {data: 'total_loan_sanction_amt', name: 'total_loan_sanction_amt'},
            {data: 'total_loan_recovery_ac', name: 'total_loan_recovery_ac'},
            {data: 'total_loan_recovery_amt', name: 'total_loan_recovery_amt'},

            {data: 'total_loan_against_deposit_sanction_ac', name: 'total_loan_against_deposit_sanction_ac'},
            {data: 'total_loan_against_deposit_sanction_amt', name: 'total_loan_against_deposit_sanction_amt'},
            {data: 'total_loan_against_deposit_recovery_ac', name: 'total_loan_against_deposit_recovery_ac'},
            {data: 'total_loan_against_deposit_recovery_amt', name: 'total_loan_against_deposit_recovery_amt'},
            
			// {data: 'micro_end_date', name: 'micro_end_date'},
			// {data: 'load_end_date', name: 'load_end_date'},
          {data: 'cash_closing_balance', name: 'cash_closing_balance'},
    ...
    $('.export').on('click',function(){
          ...
          $('form#filter').attr('action',"{!! route('admin.report.adminBusinessListExport') !!}");
  ...
  $('.export').on('click',function(e){
    ...
    function doChunkedExport(start,limit,formData,chunkSize){
        ...
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('admin.report.adminBusinessListExport') !!}",
            data : formData,
