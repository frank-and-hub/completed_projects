                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12 error-msg">
                                        ...
                                        <input type="text" class="form-control  " name="start_date" id="start_date" value='{{date("d-m-Y")}}' autocomplete="off">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12 error-msg">
                                        ...
                                        <input type="text" class="form-control  " name="end_date" id="end_date" autocomplete="off" value='{{date("d-m-Y")}}' >
