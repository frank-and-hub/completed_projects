                ...
                @include('templates.GlobalTempletes.both_company_filter_new',['all'=>true])
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12 error-msg">
                                <div class="input-group">
                                    <input type="text" class="form-control create_application_date" name="maturity_start_date" id="maturity_start_date" value="{{$startDatee}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12 error-msg">
                                <div class="input-group">
                                    <input type="text" class="form-control  create_application_date" name="maturity_end_date" id="maturity_end_date" value="{{$endDatee}}">
                                </div>
                            </div>
                        </div>
                    </div>
