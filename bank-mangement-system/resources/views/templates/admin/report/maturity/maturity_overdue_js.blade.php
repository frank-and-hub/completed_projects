<script type="text/javascript">
    $(document).ready(function () {
        ...
        maturityReport = $('#overdue_listing').DataTable({
            processing: true,
            serverSide: true,
            pageLength: 20,
            ...
            ajax: {
                "url": "{!! route('admin.report.maturityOverdduelist') !!}",
                "type": "POST",
            ...
            columns: [
                ...
                { data: 'overdue_period', name: 'overdue_period' },
        ...
        $('.export-overdue').on('click', function (e) {
            e.preventDefault();
        ...
        function doChunkedExport(start, limit, formData, chunkSize, page) {
            ...
            jQuery.ajax({
                type: "post",
                dataType: "json",
                url: "{!! route('admin.maturityoverdueExport.report.export') !!}",
                data: formData,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
