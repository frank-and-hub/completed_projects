                ...
                <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12 error-msg">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="maturity_start_date" id="maturity_start_date" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12 error-msg">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="maturity_end_date" id="maturity_end_date" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12 error-msg">
                                <select class="form-control" id="status" name="status">
                                    ...
                                    <option  value="proceed">Processed</option>
