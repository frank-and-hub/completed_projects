    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Cash In Hand Report</h6>
                        <div class="">
                    ...
                    <div class="">
                        <table id="cash_listing" class="table datatable-show-all">
                            <thead>
                                <tr>
                                    <th>S/N</th>
                                    <th>BR Name</th>
...
@include('templates.admin.report.partials.cash')
@stop