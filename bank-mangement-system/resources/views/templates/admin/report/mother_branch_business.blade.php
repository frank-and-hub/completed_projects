                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12 error-msg">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="end_date" id="end_date" readonly autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                <div class="col-lg-12 text-right">
                                    ...
                                    <input type="hidden" name="created_at" class="create_application_date" id="created_at">
...
@include('templates.admin.report.partials.mother_branch_business_script')
