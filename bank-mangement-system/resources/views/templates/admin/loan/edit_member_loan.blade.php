      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{route('admin.memberloan.update')}}" method="post" id="register-plan" name="register-plan" enctype="multipart/form-data">
            @csrf
                ...
                <input type="hidden" name="created_date" id="created_date" value="{{ $loanDetails->created_at }}">
                ...
                <div class="form-group row personal-loan-section">
                  ...
                  <div class="col-lg-4">
                    <select name="emoption" id="emoption" class="form-control" title="Please select something!" disabled="">
                      <option  @if($loanDetails->emi_option == 1 && $loanDetails->emi_period == 10) selected @endif value="10">10 Months</option>
                      <option @if($loanDetails->emi_option == 1 && $loanDetails->emi_period == 12) selected @endif value="12">12 Months</option>
                      <option @if($loanDetails->emi_option == 1 && $loanDetails->emi_period == 24) selected @endif value="24">24 Months</option>
                      <option @if($loanDetails->emi_option == 2 && $loanDetails->emi_period == 26) selected @endif value="26">26 Weeks</option>
                      <option @if($loanDetails->emi_option == 2 && $loanDetails->emi_period == 52) selected @endif value="52">52 Weeks</option>
                      <option @if($loanDetails->emi_option == 3 && $loanDetails->emi_period == 100) selected @endif value="100">100 Days</option>
                      <option @if($loanDetails->emi_option == 3 && $loanDetails->emi_period == 200) selected @endif value="200">200 Days</option>
                    </select>
                ...
                <div class="form-group row group-information" style="display: none;">
                  ...
                  <div class="col-lg-4">
                    <input type="text" name="group_leader_member_id" id="group_leader_member_id" class="form-control" readonly="" value="@if(count($loanDetails['GroupLoanMembers']) > 0) {{ getMemberData($loanDetails['GroupLoanMembers'][0]->groupleader_member_id)->member_id }} @endif" readonly="">
                    <input type="hidden" name="group_leader_m_id" id="group_leader_m_id" class="form-control"  value="@if(count($loanDetails['GroupLoanMembers']) > 0) {{ getMemberData($loanDetails['GroupLoanMembers'][0]->groupleader_member_id)->id }} @endif" readonly="">
                  </div>
                </div>
                ...
                <div class="form-group row group-information" style="display: none;">                 
                  <label class="col-form-label col-lg-2">Associate Code<sup>*</sup></label>
                  <div class="col-lg-4">
                    <input type="text" name="group_associate_id" id="group_associate_id" data-val="group-associate" value="{{ getMemberData($loanDetails->associate_member_id)->associate_no }}" class="form-control" readonly="">
                    <input type="hidden" name="group_associate_id" class="form-control group-associate-id" value="{{ $loanDetails->associate_member_id }}" >
                  </div>
                </div>
                  ...
                  <table class="table table-flush">
                      ...
                      <tbody class="m-input-number">
                        ...
                        <tr>
                          ...
                          <td>{{ getMemberInvestment($value->plan_id)->current_balance }}</td>
                ...
                <div class="applciant-deatils-box" style="display: none;">
                  @include('templates.admin.loan.applicant.edit-applicant-details')
                </div>
                <div class="coapplciant-deatils-box" style="display: none;">
                  @include('templates.admin.loan.coapplicant.edit-coapplicant-details')
                </div>
                <div class="guarantor-deatils-box" style="display: none;">
                  @include('templates.admin.loan.guarantor.edit-guarantor-details')
                </div>
...
@include('templates.admin.loan.partials.edit_loan_script')
@stop