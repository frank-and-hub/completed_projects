...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    @php
    $occupation = getOccupationName($loanDetail->occupation);
    @endphp
    <input type="text" name="applicant_occupation_name" id="applicant_occupation_name" class="form-control" value="{{ $occupation }}" readonly="">
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    <input type="text" name="applicant_designation" id="applicant_designation" class="form-control" value="{{ $loanDetail->designation }}">
  </div>
...
<div class="form-group row">
  ...
  <div class="col-lg-12">
    <select name="applicant_id_proof" id="applicant_id_proof" class="form-control" title="Please select something!">
      ...
      @endforeach
      {{--
      <option data-val="applicant" data-proof-val="" @if($loanDetail->id_proof_type == 1) selected @endif value="1">Voter ID</option>
      <option data-val="applicant" data-proof-val="" @if($loanDetail->id_proof_type == 2) selected @endif value="2">DL</option>
      <option data-val="applicant" data-proof-val="" @if($loanDetail->id_proof_type == 3) selected @endif value="3">Aadhar card</option>
      <option data-val="applicant" data-proof-val="" @if($loanDetail->id_proof_type == 4) selected @endif value="4">Passport</option>
      <option data-val="applicant" data-proof-val="" @if($loanDetail->id_proof_type == 5) selected @endif value="5">Pan Card</option>
      <option data-val="applicant" data-proof-val="" @if($loanDetail->id_proof_type == 6) selected @endif value="6">Other</option>
      <option data-val="applicant" data-proof-val="" @if($loanDetail->id_proof_type == 7) selected @endif value="7">Electricity Bill</option>
      --}}
    </select>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-lg-1 ">
    <button type="button" id="applicant_id_tooltip"  class="btn btn-sm btn-default 11" data-toggle="tooltip" data-placement="top" title="" data-original-title="Enter id proof number"><i class="fas fa-exclamation-circle text-secondary"></i>
    </button>
  </div>
  ...
  <div class="col-lg-3">
    ...
    @if(count($applicantFiles) > 0)
      ...
      @php
        ...
        @endphp
      <!-- <span><a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/applicant/id_proof/'.$applicantFile->file_name.'') }}" target="blank">{{ $applicantFile->file_name }}</a></span> -->
...
<div class="form-group row">
  ...
  <div class="col-lg-12">
    <select name="applicant_address_id_proof" id="applicant_address_id_proof" class="form-control" title="Please select something!">
      <option value="">Select ID</option>
      @foreach($address_proof_type as $key => $val)
        <option data-val="applicant_address" data-proof-val="" @if($loanDetail->address_proof_type == $key) selected @endif value="{{$key}}">{{ucwords($val)}}</option>
      @endforeach
      {{--
      <option data-val="applicant_address" data-proof-val="" @if($loanDetail->address_proof_type == 1) selected @endif value="1">Voter ID</option>
      <option data-val="applicant_address" data-proof-val="" @if($loanDetail->address_proof_type == 2) selected @endif value="2">DL</option>
      <option data-val="applicant_address" data-proof-val="" @if($loanDetail->address_proof_type == 3) selected @endif value="3">Aadhar card</option>
      <option data-val="applicant_address" data-proof-val="" @if($loanDetail->address_proof_type == 4) selected @endif value="4">Passport</option>
      <option data-val="applicant_address" data-proof-val="" @if($loanDetail->address_proof_type == 5) selected @endif value="5">Pan Card</option>
      <option data-val="applicant_address" data-proof-val="" @if($loanDetail->address_proof_type == 6) selected @endif value="6">Other</option>
      <option data-val="applicant_address" data-proof-val="" @if($loanDetail->address_proof_type == 7) selected @endif value="7">Electricity Bill</option>
      --}}
    </select>
  </div>
</div>
  ...
  <div class="col-lg-3">
    ...
    @if(count($applicantAddressFiles) > 0)
      ...
      @php
          ...
          $url = ImageUpload::generatePreSignedUrl($foldeName);
        @endphp
      <!-- <span><a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/applicant/address_proof/'.$applicantAddressFile->file_name.'') }}" target="blank">{{ $applicantAddressFile->file_name }}</a></span> -->
...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    <select name="applicant_income" id="applicant_income" class="form-control" title="Please select something!">
      ...
      <option data-val="applicant" @if($loanDetail->income_type == 0) selected @endif data-val="applicant" value="0">Salary Slip</option>
      <option data-val="applicant" @if($loanDetail->income_type == 1) selected @endif data-val="applicant" value="1">ITR</option>
      <option data-val="applicant" @if($loanDetail->income_type == 2) selected @endif data-val="applicant" value="2">Others</option>
    </select>
  </div>
  ...
  <div class="col-lg-4 applicant-salary-remark" @if($loanDetail->income_type != 2)  style="display: none;" @endif>
    <input type="text" name="applicant_remark" id="applicant_remark" class="form-control" value="{{ $loanDetail->income_remark }}">
  </div>
</div>
  ...
  <div class="col-lg-4">
    ...
    @if(count($applicantIncomeFiles) > 0)
      ...
      @php
          ...
          $url = ImageUpload::generatePreSignedUrl($foldeName);
        @endphp
      <!-- <span><a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/applicant/income_proof/'.$applicantIncomeFile->file_name.'') }}" target="blank">{{ $applicantIncomeFile->file_name }}</a></span> -->
