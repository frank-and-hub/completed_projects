...
<div class="row">
<div class="col-lg-12 ">
<h3 class="mb-0 text-dark bg-md-dark px-3 py-2 text-dark my-3">Co-applicant Details</h3>

	@php
        $caDetails = getMemberCompanyDataNew($LoanCoApplicant->member_id);
    @endphp
	...
	<div class="row">
		...
		<div class="col-lg-1">:</div> 
		<div class="col-lg-7  "> {{ $caDetails->member->memberCompany->member_id }}</div>
	</div>
    <div class="row">
