...
<input type="checkbox" id="co_applicant_checkbox" name="co_applicant_checkbox" class="custom-control-input" @if(count($loanDetails['LoanCoApplicants']) > 0) checked @endif>
...
@if(count($loanDetails['LoanCoApplicants']) > 0)
  ...
  <div class="form-group row co-applicant-form">
    ...
    <div class="col-lg-10">
      <input type="text" name="co-applicant_auto_member_id" id="co-applicant_auto_member_id" class="form-control" value="{{ getMemberData($loanDetail->member_id)->associate_no }}" readonly="">
  ...
  <div class="form-group row cheque-mode p-mode co-applicant-form">
    ...
    <div class="col-lg-4">
      <input type="text" name="co-applicant_organization" id="co-applicant_organization" class="form-control" value="{{ $loanDetail->organization }}">
    </div>
  </div>
  ...
  <div class="form-group row cheque-mode p-mode co-applicant-form">
    ...
    <div class="col-lg-4">
      <input type="text" name="co-applicant_designation" id="co-applicant_designation" class="form-control" value="{{ $loanDetail->designation }}">
    </div>
  ...
  <div class="form-group row co-applicant-form">
    ...
    <div class="col-lg-12">
      <select name="co-applicant_id_proof" id="co-applicant_id_proof" class="form-control" title="Please select something!">
          <option value="">Select ID</option>
          <option data-val="co-applicant" @if($loanDetail->id_proof_type == 1) selected @endif value="1">Voter ID</option>
          <option data-val="co-applicant" @if($loanDetail->id_proof_type == 2) selected @endif value="2">DL</option>
          <option data-val="co-applicant" @if($loanDetail->id_proof_type == 3) selected @endif value="3">Aadhar card</option>
          <option data-val="co-applicant" @if($loanDetail->id_proof_type == 4) selected @endif value="4">Passport</option>
          <option data-val="co-applicant" @if($loanDetail->id_proof_type == 5) selected @endif value="5">Pan Card</option>
          <option data-val="co-applicant" @if($loanDetail->id_proof_type == 6) selected @endif value="6">Other</option>
          <option data-val="co-applicant" @if($loanDetail->id_proof_type == 7) selected @endif value="7">Electricity Bill</option>
      </select>
    </div>
  </div>
    ...
    <div class="col-lg-4">
      ...
      @if(count($coapplicantAddressFiles) > 0)
        ...
        @endphp
          ...
          <!-- <span><a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/coapplicant/address_proof/'.$coapplicantAddressFile->file_name.'') }}" target="blank">{{ $coapplicantAddressFile->file_name }}</a></span> -->
    ...
    <div class="col-lg-4">
      ...
      @if(count($coapplicantUnderTakingFiles) > 0)
        ...
        @endphp
          ...
          <!-- <span><a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/coapplicant/undertakingdoc/'.$coapplicantUnderTakingFile->file_name.'') }}" target="blank">{{ $coapplicantUnderTakingFile->file_name }}</a></span> -->
    ...
    <div class="col-lg-4">
      ...
      @if(count($coapplicantIncomeFiles) > 0)
        ...
        @endphp
          ...
          <!-- <span><a href="{{ URL('core/storage/images/loan/document/'.$loanDetails->id.'/coapplicant/income_proof/'.$coapplicantIncomeFile->file_name.'') }}" target="blank">{{ $coapplicantIncomeFile->file_name }}</a></span> -->
