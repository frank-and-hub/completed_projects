<h6 class="card-title font-weight-semibold ">Loan Account Details</h6>
    <div class=" row">
	  ...
	  <div class="col-lg-6 ">
        <div class=" row">
          <label class=" col-lg-4">ECS Type</label><label class=" col-lg-1">:</label>
          <div class="col-lg-7 ">
           {{($loanData->ecs_type == 1) ? 'Bank' : (($loanData->ecs_type == 2) ? 'SSB' : 'N/A')}}
          </div>
        </div>
      </div>	  
	  <div class="col-lg-6 ">
        <div class=" row">
          <label class=" col-lg-4">ECS Reference Number</label><label class=" col-lg-1">:</label>
          <div class="col-lg-7 ">
              {{ $loanData->ecs_ref_no??'N/A' }}
          </div>
        </div>
      </div>
 </div>
