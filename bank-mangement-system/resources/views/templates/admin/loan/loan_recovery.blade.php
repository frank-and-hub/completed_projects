    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" id="loan_recovery_filter" name="loan_recovery_filter">
                    @csrf
                        <div class="row">
                            @php
                            $dropDown = $company;
                           ...
                           <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12 error-msg">
                                         <!-- <div class="input-group"> -->
                                            <select class="form-control loan_recovery_type loan_typee" id="loan_recovery_type" name="loan_recovery_type">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12 error-msg">
                                         <!-- <div class="input-group"> -->
                                            <select class="form-control loan_recovery_plan loan_plann" id="loan_recovery_plan" name="loan_recovery_plan">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="loanrecoverysearchForm()" >Submit</button>
                                        <button type="button" class="btn btn-gray legitRipple" id="reset_form" onClick="loanrecoveryresetForm()" >Reset </button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-12 table-section hideTableData">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h6 class="card-title font-weight-semibold">Loan Recovery</h6>
                    <div class="">
                        <button type="button" id="loan_recovery_export" class="btn bg-dark legitRipple export ml-2" data-extension="0" style="float: right;">Export Excel</button>
                        <!-- {{-- <button type="button" class="btn bg-dark legitRipple export" data-extension="1">Export PDF</button> --}} -->
                    </div>
                </div>
                <div class="">
                    <table id="loan_recovery_table" class="table datatable-show-all">
                        <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Company</th>
      ...
      <div class="modal-body p-0">
        <div class="card bg-white border-0 mb-0">
          ...
          <div class="card-body px-lg-5 py-lg-5">
            <form action="{{route('admin.loan.depositeloanemi')}}" method="post" id="loan_emi" name="loan_emi">
              @csrf
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4">
                  <input type="text" readonly name="application_date" id="date" class="form-control application_date" autocomplete="off">
                </div>
              ...
              <div class="  " id="cheque-detail-show" style="display: none;">
                  ...
                  <div class=" form-group row">
                    ...
                    <div class="col-lg-4">
                      <input type="text" readonly name="cheque-date" id="cheque-date" class="form-control" readonly>
                    </div>
                  </div>
                  <div class=" form-group row">
                  ...
                  <div class="col-lg-4">
                      <select name="company_bank" id="company_bank" class="form-control">
                          <option value="">----Please Select----</option>
                              ...
                              @endphp
                              @if($bank['bankAccount'])
                                  <option  value="{{ $bank->id }}" data-balance = "@if($balance){{$balance}}@else 0 @endif" data-account="{{ $bank['bankAccount']->account_no }}">{{ $bank->bank_name }}</option>
                              @endif
                          @endforeach
                      </select>
                  </div>
