    ...
    <div class=" row">
	  ...
	  <div class="col-lg-6 ">
        <div class=" row">
          ...
          <div class="col-lg-7 ">
              {{ date("d/m/Y", strtotime(convertDate($loanData->created_at))) }}
          </div>
        </div>
      </div>
      <div class="col-lg-6 ">
	  ...
	  <div class="col-lg-6 ">
        <div class=" row">
          <label class=" col-lg-4">Emi Due Date</label><label class=" col-lg-1">:</label>
          <div class="col-lg-7 ">
           {{ date("d/m/Y", strtotime($loanData->emi_due_date)) ?? 'N/A'}}
          </div>
        </div>
      </div>	  
	  <div class="col-lg-6 ">
        <div class=" row">
          <label class=" col-lg-4">Emi Amount</label><label class=" col-lg-1">:</label>
          <div class="col-lg-7 ">
              {{ $loanData->emi_amount??'N/A' }}
          </div>
        </div>
    </div>
    <div class="col-lg-6 ">
        <div class=" row">
          <label class=" col-lg-4">New Emi Amount</label><label class=" col-lg-1">:</label>
          <div class="col-lg-7 ">
              {{ $loanData->new_emi_amount??'N/A' }}
          </div>
        </div>
    </div>
