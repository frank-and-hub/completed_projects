      ...
      <div class="col-lg-3">
        <div class="form-group row">
          <div class="col-lg-12 ">                  
            ...
            @php
              $folderNAme = 'profile/member_avatar/'.$data['loan_member']['photo'];
              $url = ImageUpload::generatePreSignedUrl($folderNAme);
              @endphp
              <?php if(!empty($data['loan_member']['photo'])){?>
              <img  id="photo-preview" alt="applicant profile photo" width="200" height="200" src="{{$url}}">
              <?php }else{ ?>
   ...
   <div class="col-lg-3">
    <div class="form-group row">
          <div class="col-lg-12 ">                  
            <span class="text-center rounded-circle w-100">
            @php
              $folderNAme = 'profile/member_avatar/'.$caDetails['photo'];
              $url = ImageUpload::generatePreSignedUrl($folderNAme);
              @endphp
              <?php if(!empty($caDetails['photo'])){?>
        <img  alt="co applicant profile photo" id="co-photo-preview" width="200" height="200" src="{{$url}}">
              <?php }else{ ?>
     ...
     <div class="form-group">
        ...
        <input type="text" name="cname" id="cname" class=" form-control" value="@if($caDetails)<?php echo $caDetails['first_name'].'&nbsp;'.$caDetails['last_name']; ?> @endif" placeholder="co-applicant Name" redonly>
        </div>
        <div class="form-group">
            <input type="text" name="cfather_name" id="cfather_name" class=" form-control mt-3" placeholder="co-applicant_father_name" value="@if($caDetails)<?php echo $caDetails['father_husband']; ?>@endif" readonly="">
        </div>
        <div class="form-group">
            <input type="text" name="cincome_tax" id="cincome_tax" class=" form-control mt-3" placeholder="co-applicant_income_tax" value="@if($caDetails)<?php echo $caIncome_Tax_PAN_No; ?>@endif" readonly="">
        </div>
        <div class="form-group">
            <input type="text" name="cresidance" id="cresidance" class=" form-control mt-3"  placeholder="co-applicant_residance" value="@if($caDetails)<?php echo $caDetails['address']; ?>@endif" readonly="">
        </div> 
        <div class="form-group">
            <input type="text" name="coffice_address" id="coffice_address" class=" form-control mt-3" placeholder="co-applicant_office_address" value="@if($caDetails)<?php echo $caDetails['address']; ?>@endif"  >
        </div>
        <div class="form-group">
            <input type="text" name="ctelephone_number" id="ctelephone_number" class=" form-control mt-3" placeholder="co-applicant_telephone_number" value="@if($caDetails)<?php echo $caDetails['mobile_no']; ?>@endif" readonly="">
        </div>   
      ...
      <div class="d-flex " style="margin-top:50px;">
        <div class="custom-control custom-radio mb-3 mr-2">
          <input type="radio" name="co_applicant_marital_status" id="co_applicant_marital_status1" class="custom-control-input m-status"  <?php if($caDetails) {?> <?php  if($caDetails['marital_status']==1){?> checked <?php } ?><?php } ?> value="1">
          <label class="custom-control-label" for="co_applicant_marital_status1">Married</label>
        </div>
        <div class="custom-control custom-radio mb-3  ">
          <input type="radio"  name="co_applicant_marital_status" id="co_applicant_marital_status0" class="custom-control-input m-status"  <?php if($caDetails) {?>  <?php if($caDetails['marital_status']==0){?> checked <?php } ?> <?php } ?> value="0">
     ...
     <div class=" d-flex mt-4 col-lg-12 flex-wrap">
      ...
      <div class="d-flex " style="margin-top:50px;">
        <div class="custom-control custom-radio mb-3 mr-2">
          <input type="radio" name="co_applicant_Residence_ownership" id="co_applicant_Residence_ownership0" class="custom-control-input m-status" <?php if($data['loan_co_applicants']) {?> <?php if($data['loan_co_applicants'][0]['temporary_permanent']==0){?> checked <?php } ?><?php } ?>  value="0">
          <label class="custom-control-label" for="co_applicant_Residence_ownership0">Self</label>
        </div>
        <div class="custom-control custom-radio mb-3 mr-2 ">
          <input type="radio"  name="co_applicant_Residence_ownership" id="co_applicant_Residence_ownership1" class="custom-control-input m-status" <?php  if($data['loan_co_applicants']) { ?> <?php if($data['loan_co_applicants'][0]['temporary_permanent']==1){?> checked <?php } ?> <?php } ?> value="1">
          <label class="custom-control-label" for="co_applicant_Residence_ownership1">Perental</label>
        </div>
        <div class="custom-control custom-radio mb-3  ">
          <input type="radio"  name="co_applicant_Residence_ownership" id="co_applicant_Residence_ownership2" class="custom-control-input m-status" <?php if($data['loan_co_applicants']){?> <?php if($data['loan_co_applicants'][0]['temporary_permanent']==2){?> checked <?php } ?><?php } ?>f value="2">
          ...
          <div class="form-group row">
           ...
           <div class="col-lg-6">&nbsp;</div>
            <div class="col-lg-6">  <!--<label class="col-form-label col-lg-12 mt-4"></label>-->
              <label class="col-form-label col-lg-12 mt-2"><input type="text" name="designation" value="@if($data['loan_co_applicants']) <?php echo $data['loan_co_applicants'][0]['designation'];?> @endif" class="form-control designation"></label>
          </div>
          </div>
          <div class="form-group row">
            <div class="col-lg-6">&nbsp;</div>
           ...
           <div class="form-group row">
            ...
            <div class="col-lg-6">  <!--<label class="col-form-label col-lg-12 "></label>-->
              <label class="col-form-label col-lg-12 "><input type="text" name="ctotal_annual_income" value="@if($data['loan_co_applicants'])<?php echo $data['loan_co_applicants'][0]['monthly_income']*12;?>@endif" class="form-control  total_annual_income"></label>
          </div>
          </div>
        </div>
...
<div class="col-lg-3">
    <div class="form-group row">
      <div class="col-lg-12 ">                  
        <span class="text-center rounded-circle w-100">
        @php
              $folderNAme = 'profile/member_avatar/'.$gDetails['photo'];
              $url = ImageUpload::generatePreSignedUrl($folderNAme);
              @endphp
           <?php if(!empty($gDetails['photo'])){?>
              <img alt="guarantor profile photo" width="200" height="200" id="g-photo-preview" src="{{ $url}}">
              <?php }else{ ?>
    ...
    <div class="form-group">
      <input type="text" name="name" id="gname" class=" form-control" value="@if($data['loan_guarantor'])<?php echo $data['loan_guarantor'][0]['name']; ?>@endif" placeholder="gurantor Name" redonly>
    </div>
    <div class="form-group">
        <input type="text" name="gfather_name" id="gfather_name" class=" form-control mt-3" placeholder="gurantor_father_name" value="@if($data['loan_guarantor'])<?php echo $data['loan_guarantor'][0]['father_name']; ?>@endif" >
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <input type="text" name="gresidance" id="gresidance" class=" form-control mt-3"  placeholder="gurantor_residance" value="@if($data['loan_guarantor'])<?php echo $data['loan_guarantor'][0]['local_address']; ?>@endif" readonly="">
    </div> 
    <div class="form-group">
        <input type="text" name="goffice_address" id="goffice_address" class=" form-control mt-3" value="@if($data['loan_guarantor'])<?php echo $data['loan_guarantor'][0]['local_address']; ?>@endif" placeholder="gurantor_office_address"  >
    </div>
    <div class="form-group">
        <input type="text" name="gtelephone_number" id="gtelephone_number" class=" form-control mt-3" placeholder="gurantor_telephone_number" value="@if($data['loan_guarantor'])<?php echo $data['loan_guarantor'][0]['mobile_number']; ?>@endif" readonly="">
    </div>  
    ...
    <div class="d-flex" style="margin-top:50px;">
      <div class="custom-control custom-radio mb-3 mr-2">
        <input type="radio" name="marital_status" id="marital_status1" class="custom-control-input m-status" <?php if($data['loan_guarantor']) {?> <?php if($data['loan_guarantor'][0]['marital_status']==1){?> checked <?php } ?> <?php } ?> value="1">
        <label class="custom-control-label" for="marital_status1">Married</label>
      </div>
      <div class="custom-control custom-radio mb-3  ">
        
        <input type="radio" name="marital_status" id="marital_status0" class="custom-control-input m-status" <?php if($data['loan_guarantor']){?> <?php  if($data['loan_guarantor'][0]['marital_status']==0){?> checked <?php } ?> <?php } ?> value="0">
    ...
    <div class="d-flex" style="margin-top:50px;">
        <div class="custom-control custom-radio mb-3 mr-2">
          <input type="radio" name="guarantor_Residence_ownership" id="guarantor_Residence_ownership0" class="custom-control-input m-status"<?php if($data['loan_guarantor']) { ?> <?php if($data['loan_guarantor'][0]['temporary_permanent']==0){?> checked <?php } ?> <?php } ?> value="0">
          <label class="custom-control-label" for="guarantor_Residence_ownership0">Self</label>
        </div>
        <div class="custom-control custom-radio mb-3 mr-2 ">
          <input type="radio"  name="guarantor_Residence_ownership" id="guarantor_Residence_ownership1" class="custom-control-input m-status" <?php if($data['loan_guarantor']) { ?> <?php if($data['loan_guarantor'][0]['temporary_permanent']==1){?> checked <?php } ?> <?php } ?> value="1">
          <label class="custom-control-label" for="guarantor_Residence_ownership1">Perental</label>
        </div>
        <div class="custom-control custom-radio mb-3  ">
          <input type="radio"  name="guarantor_Residence_ownership" id="guarantor_Residence_ownership2" class="custom-control-input m-status"<?php if($data['loan_guarantor']) { ?> <?php if($data['loan_guarantor'][0]['temporary_permanent']==2){?> checked <?php } ?> <?php } ?> value="2">
          ...
          <div class="col-lg-12">
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
              <div class="col-lg-6">&nbsp;</div>
              <div class="col-lg-6">  <!--<label class="col-form-label col-lg-12 mt-4"></label>-->
                <label class="col-form-label col-lg-12 mt-2"><input type="text" name="designation" class="form-control designation" value="@if($data['loan_co_applicants']) <?php echo $data['loan_co_applicants'][0]['designation'];?>@endif" readonly=""></label>
              </div>
            </div>
         <div class="form-group row">
            <div class="col-lg-6">&nbsp;</div>
          ...
          <div class="form-group row">
           <div class="col-lg-6">&nbsp;</div>
            <div class="col-lg-6">  <!--<label class="col-form-label col-lg-12 "></label>-->
              <label class="col-form-label col-lg-12 "><input type="text" name="gtotal_annual_income" value="@if($data['loan_co_applicants']) <?php echo $data['loan_co_applicants'][0]['monthly_income']*12;?> @endif" class="form-control total_annual_income"></label>
            </div>
          </div>
        </div>
              ...
              <div class="d-flex flex-column">
                <div class="form-group row">
                  <div class="d-flex">
                    ...
                    <label class="col-form-label col-lg-12"><input readonly type="text" name="line_of_activity" class="form-control" value="" readonly></label>
                  </div>
                </div>
                <div class="form-group row">
                   <div class="d-flex">
  ...
  <div class="card bg-white" >
    <div class="card-body">
     ...
     <p>We request for sanction of the loan of Rs <b><?php echo $data['amount'].' <i class="fas fa-rupee-sign"></i>'; ?></b>(rupees) <b><?php echo amountINWord($data['amount']) ?></b> Against the security of as describe above and such other securities as may be required by {{$companyName}} for personal use on the basis of information given above. I/We declare that all the particulars and information given in the  application  form  are  true,  correct  and  complete  and  that  they  shall  form  the  basis  of  any  loan  {{$companyName}} may decide to grant me/us. I/We further confirm that I/We have read the agreement/brochure and understood the contents. I/we agree that  {{$companyName}} may take up such references and make such enquiries  in  respectof  this  application  as  it  may  deemnecessary.    I/We  further  agree  that  my/our  loan  shall  be  governedby  rules  {{$companyName}} which may be in force from time to time.</p>
     ...
     <div class="d-flex  mt-4 justify-content-around " style="margin-top: 52px;">
      <div class="d-flex flex-column">
        ...
        <div class="d-flex flex-column">
        <span><b>@if($caDetails) <?php echo $caDetails['first_name'].'&nbsp;'.$caDetails['last_name']; ?> @endif</b></span>
        </div>
        <div class="d-flex flex-column">
        <span><b>@if($data['loan_guarantor'])  <?php echo $data['loan_guarantor'][0]['name']; ?>@endif</b></span>
        </div>
     </div>
       <!-- Office Use Only -->
  ...
  <div class="card bg-white" >
      <div class="card-body">
       ...
       <p>This Loan Agreement (“agreement") is executed at Jaipuron  the  Date  mentioned    in    Clause    30    of    this    Agreement    Between  {{$companyName}} incorporated  under  sub-section(8)  of  section  act,  2013  (hereinafter referred as “ {{$companyName}}”) and having its registered office at 114-115,  Pushp  Enclave,  Sector -5 ,  Pratap  Nagar  ,  Tonk Road, Jaipur ,(Rajasthan)(which expression shall unless repugnant  to  the  context  of  the  meaning  thereof  shall  mean  to include its legal representatives, successors in business and assigns) of the ONEPART.<br/>AND <br/>The ..........................................address(es)...................................... and  other  details are set  out in  clause 30,  (Who Is/  are hereinafter referred   to  collectively  as "Borrower" (which  expression unless  repugnant to  the    context   or   the   meaning    thereof   shall   mean    to    include  its' their legal representatives, heirs and permitted assigns) of the OTHERPARTY.</p>
       ...
       <p>WHEREAS,the Borrower has approached the {{$companyName}} fora loan for his requirements.WHEREAS, on the basis of the Borrower's application and representations the {{$companyName}} has agreed to  lend  to  and advance to the Borrower a loan on the terms and conditions, set out here it,below.Now THEREFORE THIS AGREEMENT WITTNESSETH AND IT IS HEREBY MUTUALLY AGREED BY AND BETWEEN THE PARTIESHERE TO ASFOLLOWS</p>
       <div class="line" style="line-height: 200%;" >
         <ol>
          <li>Definitions <br/>
            ...
            <ol>
              ...
              <li><strong>Borrower </strong>means and includes any person(s) to whom the {{$companyName}} hasagreed to grant the Loan and who has received the Loan pursuant this Agreement as mentioned herein.</li>
              ...
              <li><strong>Effective Date </strong>means unless specified otherwise. the date on which the cheque for the loan amount issue by  the {{$companyName}} to the Borrower, as mentioned in Clauses 30 of this Agreement.</li>
              <li>Equated  Monthly installments (EMI’s)" means and includes the amount of monthly  payment  required  to  repay  the  principal  amount  of Loan, interest and any other monies due and payable by the Borrower to the {{$companyName}} inaccordance with Clause30 to this Agreement.</li>
              ...
              <li><strong>Free Look Period</strong>means the interest free period of seven days from the date of issue of cheque by the {{$companyName}} towards the Loan where in the Borrower may withhold the cheque from being deposited into the Borrower’s bank account.</li>
              ...
              <li><strong>Interest</strong> means and includes  rate of interest  chargeable by the {{$companyName}}  fromthe Borrower on the  Loan  in accordance with Clause 30 to this Agreement.</li>
              ...
              <li><strong>Prepayment</strong>means premature repayment as per the terms and conditions laid down by the {{$companyName}} in that behalf and in force at the time of repayment.</li>
              <li><strong>Post  Dated  Cheques (PDCs</strong>means  the  cheques drawn by  the  Borrower  in favorof  the {{$companyName}},for  making  payments as described in Clause 30.</li>
          ...
          <li>The {{$companyName}} shall  lend to  the Borrower the  sum specified    Clause   30   hereto   for   the   Borrower's  personal  needs the  {{$companyName}} agrees to grant to  the Borrower a  Loan for  the   amount as set out in  Clause 30  on the  Terms    and conditions contained  in  this  Agreement.  The {{$companyName}}  shallbe  liberty  to  decide  the  actual aggregate amount of the Loan to be granted under this Agreementandhence. for all  purpose the amount actually disbursed shall be the amount of the Loan and the Borrower shall not raise and objections therefore or be discharged from any of  his obligations there  undermerelybecausetheamountappliedfor.Obligationsthereundermerelybecausetheamountdisbursed.</li>
          <li>The Loan shall carry interest at the rate as determined in Clause 30of thisAgreement, which can be varied from time to time  at the solediscretion of  the {{$companyName}}.   For purpose of this Agreement theinterest shall be charged by the {{$companyName}} on monthly basis, starting from the I of every month (including the month of disbursal of loan by the Agreement or date of issue of cheque by The {{$companyName}}.), irrespective of the Effective date of this of agreementor date of issue of cheque by the {{$companyName}}.</li>
          <li>A demand promissory  note  has  been executed by the Borrower  in favor  ofthe {{$companyName}} for  themaximum amountof Loan, provided  that  the  promissory  note  shall  cover the actual Loan amount  disbursed  as  also  all  interest and other  coststhereon.</li>
          ...
          <li>The EMI shall comprise of principal and interest  calculated   on   the    basis   of   monthlyrests   at   the   rate    applicable and rounded off to the next  whole rupee-Interest   and   any    other    charges   due   and   payable   by   the   Borrower  shall be computed  on  the  basis  of  Calendar  year.  Since  the  interest  for  each  EMI would  be  calculated  on  a  reducing balance,the interest component for each EMI may vary,although,EMI will be identical foreach installment.
            <ol>
              <li>(a) The  Borrower(s) will repay the  Loan  as  stated in  Clause  30,  subject however that the  due  date  of  paymentof first EMI shall  in all cases  be  the.................day of  followingmonth  unless  otherwise  decided by the  {{$companyName}} . The payment of EMI will be through  PDCs, favoring " {{$companyName}}  "  Electronic Clearance Scheme    and/ or Standing Instructions.Where    applicable the Borrower shall also    pay    to the  {{$companyName}} PEMIas perClause 30.  The Borrower is required to payalltaxes and charges  that nm,-be  levied in  connection with the  Loan.EMI shall be computed oil the basis of reducing balance of the principal outstanding amount.</li>
              <li>(b)  The Borrower  also  agreed to  pay such amount as non-refundable processing fee   as   may be   determined   by   the  {{$companyName}} from  time to time and the  same shall be  due   from    the Borrower   once   requestfor    Loan  is received by the  {{$companyName}} .  It  is  clarified  that  in  the  event the Borrower  chooses  not  to  avail  the  Loan  then  the Borrowers shall remain liable to pay to the  {{$companyName}} theprocessingfee.</li>
            </ol>
          </li>
          <li>The  {{$companyName}} on its part is not obligated to provide any statement (s)  of  die  Loan  account  to  the  Borrower during the course of this Agreement unless specifically  requested b}   the   Borrower. The Borrower agrees  topay  such charges for this service as may be determined by the  {{$companyName}} from wile to time.
            
          </li>
          <li>The delay in the payment of EMI or PEMI shall  render the Borrower liable to delayed  payment charges as Mentioned in Clause 30 of this Agreement without prejudice to the other    rights of the  {{$companyName}}. The aforementioned charges would not affectthe Borrower’s obligation ofstrict  compliance  withtherepaymentas mentioned in Clause 30 of this Agreement, which the  Borrower here by acknowledges and agrees to be an essential condition for the grant of the Loan.</li>
          <li>
           (a) In case of dishonor of any cheque/ SI/ ECS or any   other   instrument    issued   by   the   Borrower,   the   Borrower    agrees and undertakes to pay the  same to the  {{$companyName}} on demand along with any additional  charges as mentioned in Clause 30  in respect of each of such cheque/ SI/ ECS or any  other instrument dishonored. This amount is in addition to the delayed  payment  charges  specified in Clause  10.   No notice  reminder or intimation     will be given regarding the presentation of these  cheques/ SI/ECS or other instrument. This  would be withoutprejudice to  the right  of  the  {{$companyName}}under  the NegotiableInstruments Act. 1881. Andit’sother rights under thisAgreement. The Borrower shall not be entitled to and agrees not to set off, with or deduct any amount from the payment due to the  {{$companyName}} underthisAgreement.
           <ol>
             <li>(b)  "The  Borrower  shall not   give any instructions to   the  {{$companyName}} not to   deposit the PDCs given by him and  in   case he does so it shall presumed that the same has been done to avoid prosecution under section 138 of the Negotiable Instruments Act, 1881. The Borrower further undertakesthat his consent to participate in  the  ECS/ SI, mode for payment of the EMIs shall not be revoked during the tenure of this Agreement  except with the approval of   the   {{$companyName}} . In case the  Borrower  revokes  his  consent to   participate in  the  ECS/SI mode,  it maybe presumed that the same has been done to cheat the  {{$companyName}} and shall  make  the  Borrower  liable  for  criminal action under the Indian Penal Code and any other law for the time being, inforce.</li> 
           </ol>
         </li>
            <li>Presentment for payment,  noting: and protest is also hereby unconditionally and irrevocably  waived by <strong> the Borrower.  Such PDCs shall </strong> be drawn from a scheduled bank situated in a town or city where office of the  {{$companyName}} <strong>is located-</strong></li>
            <li>Out <strong>of the upfront EMN  to be paid by </strong> the Borrower to  the  {{$companyName}}, one EMI shall be adjusted in  the first month <strong>and  the  remaining  EMI  shall  be  adjusted  towards  the  last  EMI's </strong> in  reverse  order  payable  by  the  Borrower  to  the  {{$companyName}}.<strong>No interest shall be payable </strong>  by  the <strong>
             {{$companyName}} to</strong> the Borrower on amount received towards installments  in advance as specified in clause30-</li>
            <li>The Borrower will be required to pay through deduction against  salary  (DAS)in those cases where his employer is registered with the<strong>  {{$companyName}} for  DAS.</strong> If  at  any <strong>time</strong> during the tenor of the Loan,  the Borrower  terminates hiscurrent employment, he will be required to provide PDCs for the Outstanding Balance.</li>
            <li>The Borrower shall pay to the  {{$companyName}} the sum set out in Clause 30 as non-refundable transactioncharge.Such charges upfront transaction charge will not be refundable under any circumstances.</li>
            ...
            <li>The  Borrower  may  after  the  payment  of  minimum  of  Six  EMIs  (excluding  the  advance  EMIs  if  any)  prepay  the loan bygiving the {{$companyName}} at least 7 days prior notice in writing. The  {{$companyName}} shallbe entitled to levy  aprepaymentcharge at the rate stipulated in Clause 30 on the amount so prepaid. Prepayment amount will bethe principal amount along with all outstanding amounts (s) due and payable at the end of the month in which the prepayment is made, in addition to theprepayment charges. The prepayment shall take effect when cash has been paid      by the Borrower or cheques/ SI/ ECS issued by the Borrower have been cleared. The interest and any other charges, etc. would be livable till the end of the month in which tilt prepayment noticeexpires.
              <ol>
                <li>(a) The Borrower  further  agrees that  in  the  event of foreclosure/  enhancement of Loan or upon expiry of-the   Agreement  the {{$companyName}} may  destroy  or  cancel  the  PDC's  provided  as  security  by  the  Borrower.  Unless  specifically  requested  by  the Borrower in writing, the  {{$companyName}} willnot be under an obligation to return the said PDC's to the Borrower.</li>
              </ol>
            </li>
            <li>The  {{$companyName}} mayin it sole discretion and  upon  serving  seven days notice to the Borrower terminate this Agreement  executed  hereto.  Upon termination the  principal  amount  of  the  Loan,  allaccrued interest  thereonand  anyother  charges outstanding will become payable forth with by the Borrower to the  {{$companyName}}.
             
            </li>
            <li>If one or more of theevents specified in this Clause shall have occurred, the  {{$companyName}}. may,  by  a seven days  notice  in writing to the Borrower,  declare that  the principal amount of the loan and  all accrued  interest thereon  has   I    become  payable forthwith by the Borrower to the  {{$companyName}} and the  {{$companyName}} may at its  sole discretion terminate this Agreement.
              <ol>
                ...
                <li>The  Borrower  committing  a  breach,  if  any,  of  the  terms    and  conditions    and    covenants    herein    contained  or    has  made  any misrepresentation to the  {{$companyName}} ;or</li>
                <li>The  Borrower  suffers  an  adverse  material  changes in the financial condition  from  the  date  hereof    and    as    a   result thereof  the  {{$companyName}} deems itself to be insecure;or</li>
                <li>The Borrower has been declared as insolvent;orProceedings for misconduct are taken against the Borrower;or</li>
                <li>The Borrower fails to furnishany information or documents that maybe required by the {{$companyName}} ;or</li>
                ...
                <li>Borrower defaults on any of the terms and conditions of anyother loan or facility provided by the  {{$companyName}}or  any  other  lender  to the Borrower; or</li>
                <li>There exists any other circumstance,which,.in the sole opinion of the {{$companyName}} ,jeopardizes the  {{$companyName}}</li>
                <li> {{$companyName}} interest.</li>
                <li>The Borrower expressly accepts that if tile Borrower fails to pay any monies when due  or  which  may  be declared due prior to the  date  when  it  would  otherwise  have  become  due  or  commits,  any  other  default  under  any Agreement  (including this Agreement) with the {{$companyName}} under  which the Borrower(s) is/ are enjoying  any financial/ credit/  other  facility;  then  in  such event  the    {{$companyName}} shall,    without    prejudice    to   any   of   its   specific    rights under each of the Agreements, be absolutely entitled to exercise all or any of its rights  under any of the Agreements entered by the Borrower with the  {{$companyName}}and/  or  withhold  applicable  amount/  documents  of  the Borrower(s)  and or terminate  without  any  notice  and/ or    all    the  Agreements  (including  this  Agreement)  with  the  {{$companyName}} at the sole discretion 6f the  {{$companyName}} . Further  it  is  clarified  that  in the  eventofa  defaultinrepaymentof Loan by the Borrower the  {{$companyName}}  shallbe entitled to create a charge over any other security. Provided by the Borrow in relation to any other loanavailed from the  {{$companyName}}.</li>
              </ol>
            </li>
            <li>Notwithstanding anythingstated elsewhere in  this Agreement, the Borrower'soutstanding   balance    shall   be payable by the Borrower to the  {{$companyName}} on  demand-The   {{$companyName}} may at any time, at its  sole discretion, and without  assigning  any  reason,  recall the said-Loan  or upon the Borrower to pay the outstanding  Balance  and thereupon the Borrower shall, within seven days of being so called upon, pay to the  {{$companyName}} the outstanding balance without any delay, demur orprotest.</li>
            <li>The  {{$companyName}}  shallbe  entitled  to  transfer or assign  any  of  its  obligations herein. The  {{$companyName}}  mayat any  time  transfers  or  assigns  any  of  its  rights, benefits  orobligations  hereinto  any  party  without the  consentof  theBorrower.    The Borrower shall fulfill and perform all this obligations to such transferee/assignee.</li>
            <li>Any  delay  in  exercising or omission  to  exercise  any  right,  power  or  remedy  accruing  to  the  {{$companyName}}  underthis Agreement  or  any  other  Agreement  or  document  shall  not  impair  any  such  right,  power  or  remedy  and  shall  not  be  construed  to  be    a waiver thereof or any acquiescence by it in any default and shall not effect or impair any right power     or remedy or the  {{$companyName}} in respect of any otherdefault.</li>
            <li>The Borrower expressly recognizes and accepts that the  {{$companyName}} shall  without  prejudice  to  its rights to perform  such activities itself or through its officials or servants, be absolutely entitled and have full powers and authority to appoint one or more third parties  or  the {{$companyName}} choice  and  to  transfer  and  delegate  to  such  third  parties  the  right and  authority  to  collect  on behalf of the  {{$companyName}} the installments, charges unpaid amount(s) and other sums due to  the  {{$companyName}} under thisAgreement.</li>
            <li>The Borrower represents that he has understood the terms and conditions of this Agreement. In the event of a default  and/ or breach of the terms and conditions of this Agreement, the  {{$companyName}} shall have a right of redresses from any Court of Law or any other appropriate forum.
              <ol>
            ...
            <li>The Borrower and the  {{$companyName}} agreeto comply, jointly and severally, with all applicable laws and regulationsfrom time to time in force including any amendments, modification or change there of which may be made to any such laws andregulations.
          ...
          <li>The  {{$companyName}} shallbe entitled to send  any notice to  the Borrower by prepaid post at  theaddresses last  known to it. Any notice sent will be deemed to have  been  received  three(3) days after the date of posting.The Borrower  shalli mmediately  intimate the  {{$companyName}} ofany change in his add ress. Any notice to  be sent to the  {{$companyName}} bythe Borrower shall be sent by prepaid post at the addresses mentioned above.</li> 
         <li>This Agreement shall be construed in accordance with the laws in force in India. If any controversy or dispute should arise between the parties in  performance,    interpretation  orapplication   of  the  Loan  Agreement involving any matter, the same shall be submitted to arbitration of a single arbitrator,  nominated by the {{$companyName}} whose decision  shall be final under the provisions of the   Indian   Arbitration and  Conciliation Act,  1996. The arbitration proceedings shall  beheld atJaipur. Any or all disputes  arising out of thisAgreement shall be subjected to the exclusive jurisdiction of the courts atJaipur(Rajasthan).</li>
         ...
         <li>Free  Look Period: The  {{$companyName}} shalloffer to  the Borrower a "Free  Look Period” ofseven(7)days  withinwhichperiod the Borrower  shall have the option not to avail of the Loan. In such ail event, the Borrower  shall forthwith return to the  {{$companyName}}, the un-banked Cheque in original as issued by the  {{$companyName}} towards the loan. For the sake of clarity, in the event the Cheque issued by  the   {{$companyName}} towards the    Loan is deposited   bythe Borrower in  its bank  account  within the "Free  Look Period", or   the  Borrower   fails   to  collect   the   Cheque  issued by the  {{$companyName}} towards the  loan within the "Free Look Period", the same would amount to theunequivocal  acceptance by the Borrower of   the    Loan along  with the   associated terms  and conditions as   detailed       in this Agreement." However, this Free Look Period shall not be available to the existing customer who has been providedTop Up or additional Loanfacilities.
          <ol>
            <li>(a) itis further clarified that in addition to the provisions of Clause 30 herein above, the Borrower shall be entitled to pay toThe {{$companyName}}towards each loan anon-refundable. Processing Fee as may bedetermined by the {{$companyName}} fromtime totime-Provide further that in tire event the Borrower Chooses not to avail the Loan, during the Free Look Period, and returns to the  {{$companyName}} (tie Loan,  during  the  Free  Look  Period,  and  returns  to  the  {{$companyName}}  theLoan  even  the  Borrower  shall  remain  liable  nay  to  the  {{$companyName}} the Processing,fee</li>
          </ol></li>
          <li>Collections: "The Borrower expressly recognizes and  accepts that the  {{$companyName}} shall, without prejudice to  its right to perform such activities itself or through its officers or employees, be entitled,  and has full  power and authority so  to do, to appoint one or more third parties asthe {{$companyName}}. may select and  to  delegate to  such  third party all or any or  its functions, rights and powers under this  Agreement  relating to  the administration ofthe  Loan including the right and authority to collect and receive   on  behalf   ofthe   {{$companyName}}. from   the Borrower all due and unpaid PEMIs and other amounts due  by  the  Borrower  under  this  Agreement  and  to  perform and execute all lawful acts, deeds, matters and things connected therewithand    incidental    thereto    including  sending  notices, contacting the Borrower, receiving   case)   cheques/drafts/   Mandates    front   the Borrower and giving  valid and   effectual  receipts and   discharge to   the  Borrower. For  the  purposes  aforesaid orfor any other purpose at the discretion of the  {{$companyName}} , shall be  entitled   to  shall   be  discuss   such   third  parties all nec essa ry• or relevant in formation  pe rtaining to the Borrower and    the   Loan    and   the   Borrower    hereby consent to such disclosure by the {{$companyName}} Notwithstandingthe    above,   the   Borrower    expressly    accepts and authorizes the  {{$companyName}} (and' or any such third party as  the  {{$companyName}}may  select)  to  contact third parties (Including the family members of the Borrower)  and  disclosure ail   necessary   or   re levant  in formation  pe rtaining to the Borrower and the   Loan  arid   the  Borrower    hereby  consents   to   such   disclosure  by the  {{$companyName}} (and/ or any such third party as the  {{$companyName}} mayselect).</li>
          <li>Disclosure of information to CIBIL : Notwithstanding any of the foregoing, the Borrower understands that as a pre-condition relating to grant of the Loan  to  the  Borrower  the   {{$companyName}} requires theBorrower's  consent for the disclosure by the  {{$companyName}} of information and  data relating to the Borrower,   of   the   credit    facility  availed of to be availed by the Borrower, obligations, assured/to    be  assured  by  the  Borrower  in  relation thereto and default, if any, committed by theBorrower in discharge thereof.
            <span>Accordingly, the Borrower hereby agrees and gives consent for the disclosure by the  {{$companyName}} of all or any such-y.1</span>
            <ol>
              ...
              <li>Default, if any, committed by the Borrower in discharge of such  obligations as the {{$companyName}} may  deem appropriate and necessary to disclose and furnish to Credit  information Bureau  (India) Limited   and    any other agency authorized  in  this  behalf  by  the Reserve Bank ofIndia.</li>
            </ol>
           
          </li>
          <li><span>The Borrower further declares that the information and data furnished by the Borrower to the  {{$companyName}} are true and correct.</span>
            <ol>
              <span>The Borrower also understands that:</span>
              <li>The Credit  information Bureau (India)  Limited and any other    agency   so   authorized   may   use,    process   the said information and data disclosed by the  {{$companyName}} in the manner as deemed fit bythem: and</li>
          ...
          <li>
            <span>Additionally, the Borrower hereby also agrees and gives his unequivocal consent for the disclosure by the  {{$companyName}} ofall any information/ documents or data as above for protecting its interests to:</span>
            <ol>
              ...
              <li>To any court or judicial, statutory or regulatory authority/ tribunal/arbitrator pursuant to any order/ direction to this effect, as and when required.Further, the  {{$companyName}} shall also be entitled to share all or any information/ documents or data as above with any of its sister concerns, its associates group companies, agents and with third parties as may be deemed appropriate by the.</li>
            </ol>
          </li>
         </ol>
         <p>{{$companyName}}. The  Borrower  further acknowledges that  no  prior  approval  will  be  required  by  the {{$companyName}} \from  the Borrower  in  the  event  Borrower  desires  to  avail  or  the {{$companyName}} offers  any  additional  financial facility  (its) including new products infuture.</p>
         <p>The  {{$companyName}} shallbe entitled to exercise the above right of disclosure without being required to issue any further notice in this respect to the Borrower. The Borrower and the Guarantor specifically waive the privilege ofprivacy, privacy and defamation.</p>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="" readonly class="form-control  col-md-4"></td>
                      </tr>
                       <tr>
