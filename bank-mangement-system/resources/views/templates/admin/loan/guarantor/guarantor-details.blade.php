...
<div class="form-group row">
  <label class="col-form-label col-lg-2">Member ID</label>
  <div class="col-lg-4">
...
<div class="form-group row guarantor-member-detail-box">
  ...
  <div class="col-lg-4">
    <input type="text" name="guarantor_father_name" id="guarantor_father_name" class="form-control">
  </div>

  <label class="col-form-label col-lg-2">Date of Birth<sup>*</sup></label>
  <div class="col-lg-4">
    <input type="text" readonly name="guarantor_dob" id="guarantor_dob" class="form-control date_of_birth">
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-lg-4 guarantor-member-detail-box">
    <input type="text" name="guarantor_mobile_number" id="guarantor_mobile_number" class="form-control" title="Please enter minimum 10 or maximum 12 digit.">
  </div>
...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    <input type="text" name="guarantor_dependents_number" id="guarantor_dependents_number" class="form-control">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4" style="display: none;">
    <input type="text" name="ocupation_remark" id="ocupation_remark" class="form-control">
  </div>

  <label class="col-form-label col-lg-2 occupation-fields">Organization</label>
  <div class="col-lg-4">
    <input type="text" name="guarantor_organization" id="guarantor_organization" class="form-control">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode  occupation-fields">
  ...
  <div class="col-lg-4">
    <input type="text" name="guarantor_designation" id="guarantor_designation" class="form-control">
  </div>
  <label class="col-form-label col-lg-2">Monthly Income<sup>*</sup></label>
  <div class="col-lg-4">
    <input type="text" name="guarantor_monthly_income" id="guarantor_monthly_income" class="form-control">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode occupation-fields">
  ...
  <div class="col-lg-4">
    <input type="text" name="guarantor_year_from" id="guarantor_year_from" class="form-control">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    <input type="text" name="guarantor_bank_account_number" id="guarantor_bank_account_number" class="form-control">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    <input type="text" name="guarantor_ifsc_code" id="guarantor_ifsc_code" class="form-control">
  </div>
  <label class="col-form-label col-lg-2">Cheque Number 1</label>
  <div class="col-lg-4">
    <input type="text" name="guarantor_cheque_number_1" id="guarantor_cheque_number_1" class="form-control">
  </div>
</div>
...
<div class="form-group row cheque-mode p-mode">
  ...
  <div class="col-lg-4">
    <input type="text" name="guarantor_cheque_number_2" id="guarantor_cheque_number_2" class="form-control">
  </div>
</div>
...
<div class="form-group row">
  ...
  <label class="col-form-label col-lg-2">Enter Id number<sup>*</sup></label>
  <div class="col-lg-3 ">
    <input type="text" name="guarantor_address_id_number" id="guarantor_address_id_number" class="form-control">
  </div>
  <div class="col-lg-1 ">
...
<div class="form-group row">
  ...
  <div class="col-lg-4 guarantor-salary-remark" style="display: none;">
    <input type="text" name="guarantor_income_remark" id="guarantor_income_remark" class="form-control">
  </div>
</div>
...
<div class="form-group row more-doc" style="display: none;">
  <div class="form-group row">
