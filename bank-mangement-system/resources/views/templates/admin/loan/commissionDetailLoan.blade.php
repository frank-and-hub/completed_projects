                            ...
                            <div class="col-lg-12 text-right">
                                <div class="form-group text-right">
                                    <div class="col-lg-12 page">
                                        ...
                                        <button type="button" class=" btn btn-dark legitRipple" onClick="searchCommissionDetailForm()">Submit</button>
        ...
        <div class="col-lg-12 table-section datatable">
            <div class="card bg-white shadow">
                <div class="card-header bg-transparent header-elements-inline">
                    ...
                    ?>
                 <h5 class="mb-0 text-dark">Loans - @if(isset($loan->account_number) && isset($plan_name)){{$loan->account_number}} ({{$plan_name}})@endif</h5>
                    <div class="">
                ...
                <div class="table-responsive">
                    <table id="loan-commission-detail" class="table table-flush">
                        <thead class="">
                            <tr>
                                <th>S/N</th>
                                <th>Month</th>
...
@section('script')
@include('templates.admin.loan.partials.listing_loan_script')
@stop