...
$(document).ready(function() {
    ...
    $('#register-plan').validate({ // initialize the plugin
        ...
        rules: {
            ...
            'co-applicant_ifsc_code' : {required: true,checkIfsc:true},
    ...
    $(document).on('keyup','#applicant_id,#co-applicant_auto_member_id,#guarantor_auto_member_id,#group_auto_member_id',function(){
