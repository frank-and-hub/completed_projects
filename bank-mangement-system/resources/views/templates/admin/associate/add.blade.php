                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9 error-msg">
                        <input type="text" name="first_g_first_name" id="first_g_first_name" class="form-control"  >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-form-label col-lg-3">Mobile No<sup class="required">*</sup></label>
                      <div class="col-lg-9 error-msg">
                        <input type="text" name="first_g_Mobile_no" id="first_g_Mobile_no" class="form-control"  >
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9 error-msg">
                        <textarea id="first_g_address" name="first_g_address" class="form-control" ></textarea> 
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div id="payment_mode_cheque" style="display: none">
                    ...
                    <div class=" row">
                      <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3">Cheque Number<sup class="required">*</sup></label>
                            <div class="col-lg-8 error-msg"> 
                    ...
                    <div class=" row" style="display: none;" id="cheque_detail">
                      <div class="col-lg-6" >
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3">Cheque Amount<sup class="required">*</sup></label>
                            <div class="col-lg-8 error-msg"> 
                               <input type="text" name="cheque-amt" id="cheque-amt" class="form-control"  readonly>
                            </div>
                        </div>
						 <div class="form-group row">
                            <label class="col-form-label col-lg-3">Deposit Bank Name<sup class="required">*</sup></label>
                            <div class="col-lg-8 error-msg"> 
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3">Cheque Date<sup class="required">*</sup></label>
                            <div class="col-lg-8 error-msg">
                              <div class="input-group">
                                <span class="input-group-prepend">
                                  <span class="input-group-text"><i class="ni ni-calendar-grid-58"></i></span>
...
<!---- RD Investment Form End -------------------------------------->
                <div class="form-group row text-center">
                  <div class="col-lg-12">
                    <button type="button" class="btn btn-default" id="previous_form">Previous </button> 
...
@include('templates.admin.associate.partials.script')
@stop