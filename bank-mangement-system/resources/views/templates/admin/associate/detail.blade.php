                ...
                <div class="card-body">  
                    <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7  "> <a href="{!! route('admin.member.detail',['id'=>$memberDetail->id]) !!}?type=1"> {{ $memberDetail->member_id }} </a> </div>  
                      </div>
                      <div class="row">
                    ...
                    <div class="card-img-actions d-inline-block mb-3">
                        <div class="profile_image_div">
                            ...
                            @if($memberDetail->photo=='')
                                <img class="img-fluid rounded-circle " src="{{url('/')}}/asset/images/user.png">

                            @else
                                <img class="img-fluid rounded-circle " src="{{ImageUpload::generatePreSignedUrl('profile/member_avatar/'.$memberDetail->photo)}}">
                            @endif
                        </div>
                    ...
                    <div class="card-img-actions d-inline-block mb-3">
                        <div class="signature_image_div">
                            ...
                            @if($memberDetail->signature=='')
                                <img class="Image placeholder w-100" src="{{url('/')}}/asset/images/signature-logo-design.png">

                            @else
                                <img class="Image placeholder w-100" src="{{ImageUpload::generatePreSignedUrl('profile/member_signature/'.$memberDetail->signature)}}">
                            @endif
