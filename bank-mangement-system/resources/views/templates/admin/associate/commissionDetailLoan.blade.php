        ...
        <div class="col-lg-12">                
            <div class="card bg-white shadow">
                <div class="card-header bg-transparent header-elements-inline">
                    <h5 class="mb-0 text-dark">Associate Loan Commission - {{ $member->associate_no}}({{$member->first_name}} {{$member->last_name}}) - {{ getCarderName($member->current_carder_id) }}</h3>
                    <div class="">
...
@section('script')
@include('templates.admin.associate.partials.listing_loan_script')
@stop
