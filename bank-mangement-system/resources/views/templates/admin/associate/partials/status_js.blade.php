...
$(document).on('keyup','#associate_code',function(){
    ...
    $.ajax({
              type: "POST",  
              url: "{!! route('admin.associate_dataGetAll') !!}",
              dataType: 'JSON',
...
memberTable = $('#member_listing').DataTable({
        ...
        ajax: {
            "url": "{!! route('admin.inactive_associate_listing') !!}",
            "type": "POST",
            "data":function(d) {
...
$('.export').on('click',function(){
        ...
        $('form#filter').attr('action',"{!! route('admin.inactive_associate.export') !!}");
        $('form#filter').submit();
        return true;
    });
	*/
    ...
    function doChunkedExport(start,limit,formData,chunkSize){
        ...
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('admin.inactive_associate.export') !!}",
            data : formData,
            success: function(response) {
