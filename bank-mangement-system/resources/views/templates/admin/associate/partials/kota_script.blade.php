...
$(document).ready(function () {
    ...
    kotaBusinessTable = $('#kota-business-report').DataTable({
        ...
        ajax: {
            "url": "{!! route('admin.associate.kotabusinesslist') !!}",
            "type": "POST",
            "data":function(d) {d.searchform=$('form#kotabusinessFilter').serializeArray()}, 
            headers: {
        ...
        columns: [
            ...
            {class: 'self', data: 'quota_business_target_self_amt', name: 'quota_business_target_self_amt'},
            {class: 'self', data: 'achieved_target_self_amt', name: 'achieved_target_self_amt'},
            {class: 'self', data: 'quota_business_target_self_percentage', name: 'quota_business_target_self_percentage'},
            {class: 'self', data: 'achieved_target_self_percentage', name: 'achieved_target_self_percentage'},  
            {data: 'senior_code', name: 'senior_code'},
            {data: 'senior_name', name: 'senior_name'},
            {data: 'senior_carder', name: 'senior_carder'},  
            {class: 'team', data: 'quota_business_target_team_amt', name: 'quota_business_target_team_amt'},
            {class: 'team', data: 'achieved_target_team_amt', name: 'achieved_target_team_amt'},
            {class: 'team', data: 'quota_business_target_team_percentage', name: 'quota_business_target_team_percentage'},
            {class: 'team', data: 'achieved_target_team_percentage', name: 'achieved_target_team_percentage'},                   
...
$('.exportkotabusiness').on('click',function(e){
    ...
    function doChunkedExport(start,limit,formData,chunkSize){
        ...
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('admin.associate.exportkotabusiness') !!}",
            data : formData,
