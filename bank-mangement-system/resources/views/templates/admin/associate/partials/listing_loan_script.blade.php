<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    associateCommissionDetailTable = $('#associate-commission-detail').DataTable({
      ...
      ajax: {
        "url": "{!! route('admin.associate.commissionDetaillistLoan') !!}",
        "type": "POST",
        "data": function(d) {
    ...
    /*
         $('.exportcommissionDetail').on('click',function(){
            ...
            $('form#commissionFilterDetail').attr('action',"{!! route('admin.associate.exportcommissionDetailLoan') !!}");
    ...
    */
    ...
    function doChunkedExport(start, limit, formData, chunkSize) {
      ...
      jQuery.ajax({
        type: "post",
        dataType: "json",
        url: "{!! route('admin.associate.exportcommissionDetailLoan') !!}",
        data: formData,
