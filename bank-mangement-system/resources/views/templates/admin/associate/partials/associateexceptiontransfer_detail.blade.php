...
<!-- <h6 class="card-title font-weight-semibold">Month Transfer</h6> -->
<div class="row">   
    <div class="col-md-6">
        <div class="form-group row">
            <label class="col-form-label col-lg-12">Type<sup style="color: red;"> *</sup></label>
    ...
    <div class="col-md-6">
        <div class="form-group row">
            <label class="col-form-label col-lg-12">Reason<sup style="color: red;"> *</sup></label>
            <div class="col-lg-12 error-msg">
