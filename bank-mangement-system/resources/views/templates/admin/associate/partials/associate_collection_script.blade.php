...
var associate_collectionreport_listing;
$(document).ready(function() {
    ...
    associate_collectionreport_listing = $('#associate-collection-report-listing').DataTable({
        processing: true,
        serverSide: true,
        bFilter: false,
        ordering: false,
        ...
        ajax: {
            url: "{!! route('admin.associate.associatecollectionreportlist') !!}",
            type: "POST",
            "data":function(d) {
	...
	$('.associate_collection_export').on('click',function(e){
		...
		$("#cover").fadeIn(100);
			...
			$('form#associate_collection_filter').attr('action',"{!! route('admin.associate.associatecollectionreportexport') !!}");
    ...
    function doChunkedExport(start,limit,formData,chunkSize){
        ...
        jQuery.ajax({
            type : "post",
            dataType : "json",
            url :  "{!! route('admin.associate.associatecollectionreportexport') !!}",
            data : formData,
