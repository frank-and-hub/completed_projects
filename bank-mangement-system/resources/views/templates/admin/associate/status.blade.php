    ...
    <div class="content">
        ...
        @endif
            <div class="col-md-12"> 
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold"> Associate Active/Inactive</h6>
                    </div> 
                    <div class="card-body">
                        <form action="{!! route('admin.associate.status_save') !!}" method="post" enctype="multipart/form-data" id="filter" name="filter">
                        @csrf
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Inactive Associate List</h6>
                        <div class=""> 
...
@include('templates.admin.associate.partials.status_js')
@stop