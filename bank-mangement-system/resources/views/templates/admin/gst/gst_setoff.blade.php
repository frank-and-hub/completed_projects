...
@section('content')
    <div class="content">
       <style>
        ...
        <div class="row">
            @include('templates.admin.gst.gst_setoff_filter')
            <div class="col-md-12">
                ...
                <div class="col-md-12 table-section hideTableData">
                    <div class="card">
                        <div class="card-header header-elements-inline">
                            ...
                            <div class="col-md-8">
                                <button type="button" class="btn bg-dark legitRipple export_gst_setoff ml-2" data-extension="0" style="float: right;">Export xslx</button>
                            </div>
                        </div>
                        <div class="">
                            <table id="gst_setoff_list" class="table datatable-show-all ">
                                <thead>
                                    <tr>
                                        <th >S/No</th>
                                        <th >Transfer Date</th>
