    ...
    <div class="card my-4">
        <div class="card-header header-elements-inline">
            ...
            <div class="card-body" id="bank-to-bank">
                ...
                @endif
                {{Form::open(['url'=>'#','method'=>'POST','id'=>'gst_transfer_filter','name'=>'gst_transfer_filter','enctype'=>'multipart/form-data'])}}
                       <div class="row ">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-3">Paid <sup>*</sup></label>
                                <div class="col-lg-12 error-msg">
                                        <div class="">
                    ...
                    <div class="text-right">
                        ...
                        <button type="submit" class=" btn bg-dark legitRipple" id="filtersubmit">Submit</button>
