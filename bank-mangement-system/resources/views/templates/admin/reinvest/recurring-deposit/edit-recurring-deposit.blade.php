<div class="form-group row">
  ...
  <div class="col-lg-4">
    ...
    <input type="text" name="amount" id="amount" class="form-control rupee-txt rd-amount" value="{{ $investments->deposite_amount }}" @if($action != 'edit') readonly="" @endif>
...
<div class="form-group row">
  <label class="col-form-label col-lg-2">Tenure11<sup>*</sup></label>
  <div class="col-lg-4">
    <select name="tenure" id="tenure" class="form-control rd-tenure" title="Please select something!" @if($action != 'edit') disabled="" @endif>
      <option value="">Select Tenure</option>
      <option value="36" @if($investments->tenure == 36) selected @endif >36  Months</option>
      <option value="60" @if($investments->tenure == 60) selected @endif >60  Months</option>
      <option value="84" @if($investments->tenure == 84) selected @endif >84  Months</option>
    </select>
  </div>
