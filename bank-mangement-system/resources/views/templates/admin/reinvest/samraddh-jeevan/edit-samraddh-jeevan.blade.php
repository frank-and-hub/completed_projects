...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    ...
    <input type="text" name="amount" id="amount" class="form-control rupee-txt sj-amount" value="{{ $investments->deposite_amount }}" @if($action != 'edit') disabled="" @endif>
...
<input type="hidden" name="maturity-amount" class="form-control rupee-txt sj-maturity-amount-val" value="{{ $investments->maturity_amount }}" readonly>
<h4 class="sj-maturity-amount">Maturity Amount :{{ $investments->maturity_amount }}</h4> 
