<div class="form-group row">
  ...
  <div class="col-lg-10">
    <input type="text" name="ssbacount" id="ssbacount" class="form-control" value="{{ $investments->ssbacount }}" @if($action != 'edit') readonly="" @endif>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    ...
    <input type="text" name="amount" id="amount" class="form-control rupee-txt ssmb-amount" value="{{ $investments->deposite_amount }}" @if($action != 'edit') readonly="" @endif>
...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    <input type="text" class="form-control ssmb-tenure" name="tenure" value="{{ $investments->tenure }}" readonly>
    <input type="hidden" class="ssmb-maturity-amount-val" name="maturity-amount" value="{{ $investments->maturity_amount }}">
    <input type="hidden" class="ssmb-interest-rate" name="interest-rate" value="{{ $investments->interest_rate }}">
  </div>
</div>
