            ...
            <div class="col-md-12"> 
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Investment Associate Change</h6>
                    </div> 
                    <div class="card-body">
                        <form action="{!! route('admin.investment.associate_save') !!}" method="post" enctype="multipart/form-data" id="filter" name="filter">
                        @csrf
                            <div class="row">
...
@include('templates.admin.investment_management.partials.associate_js')
@stop