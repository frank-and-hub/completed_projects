            ...
            <div class="col-md-12"> 
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Investment Branch Transfer</h6>
                    </div> 
                    <div class="card-body">
                        <form action="{!! route('admin.investment.branch_save') !!}" method="post" enctype="multipart/form-data" id="filter" name="filter">
                        @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-5 error-msg">
                                            <input type="text" autocomplete="off" name="account_no" id="account_no" class="form-control">
                          ...
                          <input type="hidden" class="form-control create_application_date " name="create_application_date" id="create_application_date"  >
                               ...
                               <!--
                                <div class="col-md-12 associate_changes" style="display: none;">
                                    <h6 class="card-title font-weight-semibold ">Associate Change To </h6>
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3">New Associate Code </label>
...
@include('templates.admin.investment_management.partials.branchtransfer_js')
@stop