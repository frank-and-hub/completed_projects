                ...
                <div class="modal-content">
                  <div class="modal-body p-0">
                    <div class="card bg-white border-0 mb-0">
                      ...
                      <div class="card-body px-lg-5 py-lg-5">
                        <form action="{{route('admin.investment.opensavingaccount')}}" method="post" id="saving-account-form" name="register-plan">
                          @csrf
                          <input type="hidden" name="created_at" class="created_at">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                              ...
                              <input type="text" name="ssbamount" id="ssbamount" class="form-control rupee-txt" value="500" readonly="">
                            </div>
