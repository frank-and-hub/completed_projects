          ...
          <div class="card bg-white" >
            ...
            <div class="card-body">
              ...
              <div class="  row">
                ...
                <label class=" col-lg-4  ">Money Back Amount : </label>

                <div class="col-lg-8   ">

                  {{ $investmentDetails[0]->maturity_amount }} <img src="{{url('/')}}/asset/images/rs.png" width="9">
              ...
              <div class="  row">
                ...
                <label class=" col-lg-4  ">Money Back Tenure : </label>
