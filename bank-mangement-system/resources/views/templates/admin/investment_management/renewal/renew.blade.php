        ...
        <div class="card">
          ...
          <div class="card-body">
           ...
           @endif
            ...
            <form action="{{route('admin.renew.store')}}" method="post" id="renewal-form" name="renewal-form">
            @csrf
                ...
                <div class="form-group row daily-renew-section" style="display: none;">
                  ...
                  <div class="col-lg-4">
                    <input type="text" data-val="daily-renewal-collector-name" name="collector_code" id="collector_code" class="form-control associate-code" placeholder="Collector Code" value="" autocomplete="off">
                  </div>
                ...
                <div class="form-group row comman-section" style="display: none;">
                  ...
                  <div class="col-lg-4">
                    <input type="text" name="renewal_date" id="renewal_date" class="form-control" readonly="">
                  </div>
                ...
                <div class="text-right">
                 <input type="submit" id="submitform" name="submitform" value="Submit" class="btn btn-primary submit-renew-form">
                </div>
            </form>
          </div>
        </div>
...
@stop
@section('script')
@include('templates.admin.investment_management.renewal.partials.script')
@stop
