          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                ...
                ?>
                @if($renewFields['scheme_name'] == 'Saving Account' || $renewFields['scheme_name'] == 'Daily Deposite' || $renewFields['scheme_name'] == 'Daily Deposite Money Back ' || $renewFields['scheme_name'] == 'Recurring Deposit')
                @php
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                ...
                <?php $plan_id = getMemberInvestmentDetails($accountDetail,$renewFields['company'])->plan_id; ?>
                {{  getPlanDetailCheck($plan_id,$renewFields['company'])->name  }}
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                ...
                {{ $amount[$key] }} <img src="{{url('/')}}/asset/images/rs.png" width="9">
                @else
...
-->
 ...
 -->
            ...
            <div class="row">
              <label class="col-lg-4">Total Amount : </label>
              <div class="col-lg-8">
                {{ $totalAmount }} <img src="{{url('/')}}/asset/images/rs.png" width="9">
              </div>
            </div>
            <!--  @endif -->
          </div>
