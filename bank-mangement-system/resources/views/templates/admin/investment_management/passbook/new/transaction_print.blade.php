        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h6 class="card-title font-weight-semibold">New Transaction For : 
                            ...
                            <table   class="table table-flush" style="width: 100%;text-align: center;" >
                              <thead class=""> 
                                    <tr>
                                        ...
                                        <th  style="width: 15%">Amt.Deposited</th>
                                        <th  style="width: 15%">Balance</th>
                                         <th  style="width: 5%">Sign</th>
                                    </tr>
                                </thead>
                            </table>
                            <table   class="table table-flush tran_print_tableNew" style="width: 100%; text-align: center;" id="transaction_print">
                                        ...
                                        @foreach($accountTranscation as $val)
                                            ...
                                            @else
                                                <tr>  
                                                    ...
                                                    <td style="width: 15%">@if($val->withdrawal>0){{ number_format($val->withdrawal,2) }}  @endif</td>
                                                    <td style="width: 15%">@if($val->deposit>0){{ number_format($val->deposit,2) }}  @endif</td>
                                                    <td style="width: 15%"> {{ number_format($val->opening_balance - $eliOpeningAmount,2) }}
                                                    </td>
                                                    <td style="width: 5%"> &nbsp;&nbsp;</td>
                                                </tr>
                                            @endif
