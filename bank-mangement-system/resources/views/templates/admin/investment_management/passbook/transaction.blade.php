            ...
            <div class="col-lg-12">   
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Old Transaction For :@if($code=='S'){{ $accountDetail->account_no  }} @else {{ $accountDetail->account_number }} - {{ $accountDetail->plan->name}} @endif</h6>
                    </div>
                </div>             
...
@section('script')
@include('templates.admin.investment_management.passbook.partials.tran_listing_script')
@stop