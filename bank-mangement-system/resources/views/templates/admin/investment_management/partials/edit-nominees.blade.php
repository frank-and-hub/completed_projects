...
<div class="form-group row">
  ...
  <div class="col-lg-4">
    <input type="text" name="fn_first_name" id="fn_first_name" class="form-control" value="{{ $investments['investmentNomiees'][0]->name }}" @if($action != 'edit') readonly="" @endif>
  </div>
  ...
  <div class="col-lg-4">
    <div class="input-group nominee-dob">
      <span class="input-group-prepend">
       ...
       <input type="text" name="fn_dob" class="form-control" value="{{ date('d/m/Y',strtotime($investments['investmentNomiees'][0]->dob) ) }}"
              data-val="fn_age" @if($action != 'edit') readonly="" @else id="fn_dob" @endif>
    </div>
  </div>
...
<div class="form-group row">
    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="custom-control custom-radio mb-3 CustomAddGender">
          <input type="radio" id="fn_gender_male" name="fn_gender" class="custom-control-input" @if($investments['investmentNomiees'][0]->gender == 1) checked @else disabled @endif value="1"  @if($action != 'edit') readonly="" @endif>
          <label class="custom-control-label" for="fn_gender_male">Male</label>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="custom-control custom-radio mb-3 CustomAddGender">
          <input type="radio" id="fn_gender_female" name="fn_gender" class="custom-control-input" @if($investments['investmentNomiees'][0]->gender == 0) checked @else disabled @endif value="0"  @if($action != 'edit') readonly="" @endif>
  ...
  <div class="col-lg-4">
    <input type="text" name="fn_percentage" id="fn_percentage" data-id="sn_percentage" class="form-control nominee-percentage" value="{{ $investments['investmentNomiees'][0]->percentage }}" @if($action != 'edit') readonly="" @endif>
  ...
  <div class="form-group row second-nominee" style="display: none;">    
    ...
    <div class="col-lg-4 error-msg">
      <div class="row">
        <div class="col-lg-4">
          <div class="custom-control custom-radio mb-3 CustomAddGender">        
            <input type="radio" id="sn_gender_male" name="sn_gender" class="custom-control-input" value="1" @if($action != 'edit') readonly="" @endif>
...
@endif	
  ...
  <div class="form-group row second-nominee">
    <label class="col-form-label col-lg-2">Full Name<sup>*</sup></label>
    <div class="col-lg-4">
      <input type="text" name="sn_first_name" id="sn_first_name" class="form-control" class="form-control" @if($investments['investmentNomiees'][1]) value="{{ $investments['investmentNomiees'][1]->name }}" @endif  @if($action != 'edit') readonly="" @endif>
    </div>
    <label class="col-form-label col-lg-2">Relationship<sup>*</sup></label>
    <div class="col-lg-4">
      <select name="sn_relationship" id="sn_relationship" class="form-control" title="Please select something!"  @if($action != 'edit') disabled="" @endif>
      ...
      <div class="input-group nominee-dob">
        <span class="input-group-prepend">
         ...
         <input type="text" name="sn_dob" id="sn_dob" class="form-control" @if($investments['investmentNomiees'][1]) value="{{ date('d/m/Y',strtotime($investments['investmentNomiees'][1]->dob))
          }}" @endif data-val="sn_age" @if($action != 'edit') readonly="" @endif>
      </div>
    </div>
    <label class="col-form-label col-lg-2">Age<sup>*</sup></label>
    <div class="col-lg-4">
  ...
  <div class="form-group row second-nominee">
    ...
    <label class="col-form-label col-lg-2">Percentage<sup>*</sup></label>
    <div class="col-lg-4">
      <input type="text" name="sn_percentage" id="sn_percentage" data-id="fn_percentage" class="form-control nominee-percentage" @if($investments['investmentNomiees'][1]) value="{{ $investments['investmentNomiees'][1]->percentage }}" @endif @if($action != 'edit') readonly="" @endif>
    </div>
  </div>
@endif
