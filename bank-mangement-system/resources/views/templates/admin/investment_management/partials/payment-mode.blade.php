...
<div class=" form-group row cheque-mode p-mode" style="display: none;">
...
<div style="display: none;" id='cheque_detail' class="row form-group col-12">
    ...
    <div class="form-group row  col-lg-12">
        <label class="col-form-label col-lg-2">Deposit Bank Name</label>
        <div class="col-lg-4">
...
<div class="form-group row online-transaction-mode p-mode" style="display: none;">
