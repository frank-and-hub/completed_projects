                        ...
                        <select   name="branch_id" id="branch_id" class="form-control" >  
                          <option value="">Select Branch</option>
                              @foreach ($branch as $val)
                                  <option data-val="{{ $val->state_id }}" value="{{ $val->id }}" @if($cheque->branch_id==$val->id ) selected @endif >{{ $val->name }}</option>
                               @endforeach
                        </select>
                      </div>
                    </div>
                ...
                <div class="row">  
                  ...
                  <div class="col-lg-6"> 
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9 error-msg">
                        <input type="text" name="bank_branch_name" id="bank_branch_name" class="form-control"  value="{{ $cheque->branch_name}}"  >
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6"> 
                  ...
                  <div class="col-lg-6"> 
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9 error-msg">
                        <input type="text" name="amount" id="amount" class="form-control"   value="{{  number_format((float)$cheque->amount, 2, '.', '') }}" >
                      </div>
                    </div> 
                  </div>
                  <div class="col-lg-6"> 
...
@include('templates.admin.cheque_management.partials.edit_received')
@stop