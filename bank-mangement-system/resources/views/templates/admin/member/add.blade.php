            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9 error-msg">
                  ...
                  <input type="hidden" name="bank_id" id="bank_id" class=" form-control removeSpaceInput"  value="0"  >
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9 error-msg">
                  <input type="password" name="bank_account_no" id="bank_account_no" class="form-control removeSpaceInput"  >
                </div>
              </div>
              <div class="form-group row">
                <label class="col-form-label col-lg-3">Confirm Bank A/C No</label>
                <div class="col-lg-9 error-msg">
                  <input type="text" name="cbank_account_no" id="cbank_account_no" class="form-control removeSpaceInput"  >
                </div>
              </div>
              <div class="form-group row">
                <label class="col-form-label col-lg-3">IFSC Code</label>
                <div class="col-lg-9 error-msg">
                  <input type="text" name="bank_ifsc" id="bank_ifsc" class="form-control removeSpaceInput"  >
                </div>
              </div>
              <div class="form-group row ">
          ...
          <div class="card bg-white" >
            <div class="card-body">
                ...
                <div class="col-lg-6 error-msg">
                  <div class="input-group">
                    <span class="input-group-prepend">
                     ...
                     <input type="text" readonly class="form-control  " name="nominee_dob" id="nominee_dob" readonly>
                   </div>
                </div>
                <div class="col-lg-3">
              ...
              <div class="form-group row">
                <label class="col-form-label col-lg-3">Mobile No<sup class="required">*</sup> </label>
                <div class="col-lg-9 error-msg">
                  <input type="text" name="nominee_mobile_no" id="nominee_mobile_no" class="form-control removeSpaceInput"  >
                </div>
              </div>
              ...
              <div id="nominee_parent_detail" style="display: none">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-9 error-msg">
                    <input type="text" name="parent_nominee_mobile_no" id="parent_nominee_mobile_no" class="removeSpaceInput form-control"  >
                  </div>
                </div>
          ...
          <div class="card" >            
            <div class="card-body">
              ...
              <div class="form-group  ">
                ...
                <div class="col-lg-12 error-msg">
                  <input type="text" name="pincode" id="pincode" class="form-control removeSpaceInput">
                </div>
              </div>
            </div>
          </div>
