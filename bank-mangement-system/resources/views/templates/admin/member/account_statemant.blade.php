    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">{{ $memberDetail->first_name }} {{ $memberDetail->last_name }}({{ $memberDetail->member_id}}) - Account Statement</h6>
                    </div>
                </div>
            </div> 
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="">
                        ...
                        <form   method="post" enctype="multipart/form-data" action="{!! route('admin.statementfilter',['id'=>$accountDetail->id,'member'=>$memberDetail->id]) !!}" id="fillter" name="fillter">
                        @csrf
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Members Account Statement</h6>
                    </div> 
                    <div class="">
                        <div class="card-body">
                        <div class="row">
...
<?php if(isset($is_fillter))  {?>
                        <table id="member_account_statement" class="table datatable-show-all">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                    @if(count($accountTranscation)>0)
                                        ...
                                        <tr>                                            
                                            <td>{{ date("d/m/Y", strtotime($val->opening_date)) }}</td>
...
@include('templates.admin.member.partials.statement_js')
@stop