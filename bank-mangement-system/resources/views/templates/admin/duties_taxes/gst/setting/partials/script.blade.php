<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $.validator.addMethod('checkStateGstCode', function(value, element) {
            ...
            var firstTwoletter = value.substr(0, 2);
            console.log(state_code , "state_code", firstTwoletter,"firstTwoletter");
        ...
        $('#head_setting').validate({
            ...
            messages: {
                gst_percentage: {
                    ...
                    min: "GST Percentage must be at least 1.",
                    max: "GST Percentage must be at most 100.",
                    number: "Please enter GST Percentage in valid format."
                },
                head_id: {
        ...
        headListing = $('#head_listing').DataTable({
            ...
            ajax: {
                "url": "{!! route('admin.duties_taxes.gst.setting.head_settings_listing') !!}",
                "type": "POST",
                "data": function(d) {
        ...
        gstListing = $('#gst_listing').DataTable({
            ...
            ajax: {
                "url": "{!! route('admin.duties_taxes.gst.setting.company_settings_listing') !!}",
                "type": "POST",
                "data": function(d) {
                    d.searchform = $('form#filter').serializeArray()
                },
