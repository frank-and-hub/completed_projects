...
<div class="content">
  <div class="">
    ...
    @endif
    <form action="@if(isset($record->gst_no)) {!! route('admin.duties_taxes.gst.setting.update_company_settings') !!} @else  {!! route('admin.duties_taxes.gst.setting.save_company_settings') !!} @endif" method="post" enctype="multipart/form-data" id="gst_setting" name="gst_setting">
      @csrf
      <div class="">
        ...
        <div class="col-lg-12">
          <div class="card bg-white">
            <div class="card-body">
              <h3 class="card-title mb-3">Update GST Setting</h3>
              <div class="row">
                @include('templates.GlobalTempletes.new_role_type',[
                  ...
                  'selectedCompany' => $record->company_id ?? '',
                ])
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                  <div class="form-group row">
                    <label class="col-form-label col-lg-12">GST No. <sup class="required">*</sup></label>
                    <div class="col-lg-12 error-msg">
                ...
                <div class="col-lg-4">
                  <div class="form-group row">
                    <label class="col-form-label col-lg-12">Applicability Date<sup class="required">*</sup></label>
                    <div class="col-lg-12 error-msg">
                ...
                <div class="col-lg-4">
                  <div class="form-group row">
                    ...
                    <div class="col-lg-12 error-msg">
                      <input type="text" name="end_date" id="end_date" class="form-control input" autocomplete="off" value="">
                    </div>
                  </div>
                </div>
                --}}
