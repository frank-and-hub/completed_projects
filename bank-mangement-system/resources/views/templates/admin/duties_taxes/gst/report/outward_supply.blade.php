...
<div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
					<form action="{{route('admin.duties_taxes.gst.report.export_outward_supply')}}" method="post" enctype="multipart/form-data" id="filter" name="filter">
                        @csrf
	...
	@include('templates.admin.duties_taxes.gst.report.partials.outward_report_script')
