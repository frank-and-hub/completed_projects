...
<div class="content">
    <div class="row">
      ...
      @endif
      <form action="{!! route('admin.demand.update') !!}" method="post" enctype="multipart/form-data" id="add_demand_advice" name="add_demand_advice">
        @csrf
...
<div class="form-group row">
  ...
  <select name="paymentType" id="paymentType" class="form-control">
                    ...
                    @include('templates.GlobalTempletes.new_role_type',['dropDown'=>$company,'filedTitle'=>"Company",'name'=>'company_id','value'=>'','multiselect'=>'false','design_type'=>4,'branchShow'=>true,'branchName'=>'branch_id','apply_col_md'=>true,'multiselect'=>false,'placeHolder1'=>'Please Select Company','placeHolder2'=>'Please Select Branch','selectedCompany'=>$demandAdvice->company_id,'selectedBranch'=>$demandAdvice->branch_id])
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        ...
                        <div class="col-lg-8 error-msg">
                          <input type="text" name="date" id="date" class="form-control" value="{{ date("d/m/Y", strtotime(convertDate($demandAdvice->date))) }}">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-lg-8 error-msg">
                          <select name="advanced_rent_party_name" id="advanced_rent_party_name" class="form-control input" data-val="advanced_rent">
                            ...
                            @foreach($rentOwners as $value)
                              <option @if($demandAdvice->owner_id == $value->id) selected @endif value="{{ $value->id }}">{{ $value->owner_name }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        ...
                        <div class="col-lg-8 error-msg">
                          <input type="text" name="maturity_prematurity_date" id="maturity_prematurity_date" class="form-control" value="{{ date("d/m/Y", strtotime(convertDate($demandAdvice->date))) }}">
                        </div>
                      </div>
                    </div>
						  ...
						  <div class="form-group row">
							...
							<div class="col-lg-8 error-msg">
								<select name="payment_mode" id="payment_mode" class="form-control input-type">
								  <option value="">Please Select</option>
								  <<!-- option value="Cash" @if($demandAdvice->maturity_payment_mode == "Cash") selected @endif>Cash</option> -->
                   ...
                   <!--
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8 error-msg">
                                <select name="maturity_category" id="maturity_category" class="form-control input">
                                    ...
                                    <option @if( $demandAdvice->maturity_prematurity_category == 1) selected @else style="display:none;" @endif value="1" class="m_category maturity_defaulter_category">Default</option>
                                </select>
                            </div>
                        </div>
                    </div>-->
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        ...
                        <div class="col-lg-8 error-msg">
                          <input type="password" name="maturity_bank_account_number" id="maturity_bank_account_number" class="form-control input" value="{{ $demandAdvice->bank_account_number }}" readonly="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        ...
                        <div class="col-lg-8 error-msg">
                          <input type="text" name="maturity_bank_account_number_confirm" id="maturity_bank_account_number_confirm" class="form-control input" value="{{ $demandAdvice->bank_account_number }}" readonly="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        ...
                        <div class="col-lg-8 error-msg">
                          <input type="text" name="maturity_ifsc_code" id="maturity_ifsc_code" class="form-control input" value="{{ $demandAdvice->bank_ifsc }}" readonly="">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        <label class="col-form-label col-lg-4">Bank A/C No.   <sup class="required required__bank_account_number">*</sup></label>
                        <div class="col-lg-8 error-msg">
                          <input type="password" name="prematurity_bank_account_number" id="prematurity_bank_account_number" class="form-control input" value="{{ $demandAdvice->bank_account_number }}" readonly="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group row">
                        <label class="col-form-label col-lg-4">Confirm Bank A/C No.   <sup class="required required__bank_account_number">*</sup></label>
                        <div class="col-lg-8 error-msg">
                          <input type="password" name="prematurity_bank_account_number_confirm" id="prematurity_bank_account_number_confirm" class="form-control input" value="{{ $demandAdvice->bank_account_number }}" readonly="">
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group row">
                        <label class="col-form-label col-lg-4">IFSC Code   <sup class="required required__ifsc_code">*</sup></label>
                        <div class="col-lg-8 error-msg">
                          <input type="text" name="prematurity_ifsc_code" id="prematurity_ifsc_code" class="form-control input" value="{{ $demandAdvice->bank_ifsc }}" readonly="">
                        </div>
                      </div>
                    </div>
