...
<?php 
$amount_mode='';
$total_transfer = number_format((float)$rent_list->actual_transfer_amount-$rent_list->transferred_amount, 2, '.', '');
?>
        ...
        <div class="col-md-12" >
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Rent Part Payment </h6>
                    </div>
                    <form action="{!! route('admin.rent.part_payment_save') !!}" method="post" enctype="multipart/form-data"  name="transfer_save" id="transfer_save" class="transfer_save" >
                        @csrf 
                        <input type="hidden" name="created_at" class="created_at" id="created_at" value="date("d/m/Y")">
                        ...
                        <input type="hidden" name="company_id" class="company_id" value=" {{ $rent_list['rentCompany']['id'] }}">
                    <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 error-msg">
                                                @if($rent_list->rentSSB)
                                                    ...
                                                    <input type="text" name="ssb_account" id="ssb_account" class="form-control ssb_account "   value="{{$rent_list->rentSSB->account_no}}" readonly>
                                                @else
                                                    <input type="text" name="ssb_account" id="ssb_account" class="form-control ssb_account "   value=""  readonly>
                                                @endif
                                            </div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-4 ">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 error-msg"> 
                                            <input type="text" name="tds_amount" id="tds_amount" class="form-control tds_amount "    value="{{  number_format((float)$rent_list->tds_amount, 2, '.', '') }}" readonly>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-4 ">
                                        <div class="form-group row">
                                            <label class=" col-md-5">Paybale Amount</label>
                                            <div class="col-lg-7 error-msg">
                                                <input type="text" name="paybale_amount" id="paybale_amount" class="form-control paybale_amount "   value="{{  number_format((float)$rent_list->actual_transfer_amount-$rent_list->transferred_amount, 2, '.', '') }}" readonly>
                                            </div>
                                        </div>
                                </div>
                                <div class="col-md-4 ">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 error-msg">
                                                <input type="text" name="transfer_amount" id="transfer_amount" class="form-control transfer_amount "   value="{{  number_format((float)$rent_list->actual_transfer_amount-$rent_list->transferred_amount, 2, '.', '') }}"  >
                                            </div>
                                        </div>
                                </div>
                                <div class="col-md-4 ">
                                ...
                                <div class="row bank"  style="display: none;">
                                  ...
                                  <div class="col-md-6 online" style="display: none;">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" class="form-control" name="online_tran_amount" id="online_tran_amount" value="{{number_format((float)$rent_list->actual_transfer_amount-$rent_list->transferred_amount, 2, '.', '')}}" readonly>
                                            </div>
                                        </div>
                                  </div>
                                  <div class="col-md-6 online" style="display: none;">
                                  ...
                                  <div class="col-md-6 online" style="display: none;">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" class="form-control" name="online_total_amount" id="online_total_amount" value="{{number_format((float)$rent_list->actual_transfer_amount-$rent_list->transferred_amount, 2, '.', '')}}" readonly> 
                                            </div>
                                        </div>
                                  </div>
                              </div>
                              <div class="row">
                                <div class="col-md-12" >
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8 error-msg">
                                                <input type="text" class="form-control" name="total_transfer_amount" id="total_transfer_amount" value="{{number_format((float)$rent_list->actual_transfer_amount-$rent_list->transferred_amount, 2, '.', '')}}" readonly> 
                                            </div>
                                        </div>
                                  </div>
                              </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                @if($rent_list && $rent_list->status!=1)
...
@stop
@section('script')
@include('templates.admin.rent-management.partials.partpayment_script') 
@stop