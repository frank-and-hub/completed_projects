                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="agreement_from" id="agreement_from" class="form-control cal-date">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="agreement_to" id="agreement_to" class="form-control cal-date">
                                    </div>
                                </div>
