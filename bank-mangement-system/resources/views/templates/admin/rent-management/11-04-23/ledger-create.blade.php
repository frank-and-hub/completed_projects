    ...
    <div class="content">
        ...
        @endif
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{!! route('admin.rent.ledger-create') !!}" method="post" enctype="multipart/form-data" id="filter" name="filter">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row"> 
                                        <div class="col-lg-12 text-right" > 
                                            ...
                                            <button type="reset" class="btn btn-gray legitRipple" id="reset_form"  onclick="resetForm()">Reset </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-md-12" id='hide_div'>
                <div class="card">
                    ...
                    <form action="{!! route('admin.rent.ledger-save') !!}" method="post" enctype="multipart/form-data"  name="rent_generate" id="rent_generate" class="rent_generate" >
                    @csrf 
								...
								<div class="form-group row">									
									<div class="col-lg-12 error-msg">
										<div class="input-group d-flex flex-row-reverse">
											<button type="button" class="btn bg-dark legitRipple ledger_create_export ml-2" data-extension="0" style="float: right;">Export xslx</button>
									    </div>
									</div>
								</div>
							</div>
                                        ...
                                        // print_r($row);die;
                                         ...
                                         <tr>
                                            <td style="border: 1px solid #ddd;">{{ $index+1 }}</td>
                                             ...
                                             <td style="border: 1px solid #ddd;">{{  $row['liabilityBranch']->name }}</td>
                                            <!-- <td style="border: 1px solid #ddd;">{{  $row['liabilityBranch']->branch_code }}</td>
                                             ...
                                             <td style="border: 1px solid #ddd;">{{$row['AcountHeadCustom']->sub_head }}</td>
                                            <!-- <td style="border: 1px solid #ddd;">{{ date("d/m/Y", strtotime(convertDate($row->agreement_from))) }}</td>
                                             ...
                                             <td style="border: 1px solid #ddd;">{{  $row->owner_name }}</td>
                                             ...
                                             <td style="border: 1px solid #ddd;">@if($row->owner_ssb_id) {{  $row['SsbAccountNumberCustom']->account_no }} @endif</td>
                                             ...
                                             <td style="border: 1px solid #ddd;">
                                                ...
                                                <div class="col-lg-12 error-msg">
            <input type="text" name="rent_amount[]" id="rent_amount_{{$index}}" class="form-control rent_amount "  style="width: 100px"  readonly  value="{{  number_format((float)$row->rent, 2, '.', '') }}">

        </div> 
        </td>
        <td style="border: 1px solid #ddd;">
                                                <div class="col-lg-12 error-msg">
                                                <input type="text" name="amount[]" id="amount_{{$index}}" class="form-control amount "  style="width: 100px" data-index="{{$index}}"    value="{{  number_format((float)$row->rent, 2, '.', '') }}">
                                                </div> 
                                            </td>
                                            <td style="border: 1px solid #ddd;">
                                            @php 
                                            ...
                                            @endphp
                                                <!-- Tds Present on Uat !-->
                                                <input type="hidden" name="tdsPercentage " value="0" id="tdsPercentage_{{$index}}">
                                                <input type="hidden" name="tdsdAmount " value="0" id="tdsAmount_{{$index}}">
                                                <input type="hidden" name="tdsApplicatble" value="0" id="tdsApplicable_{{$index}}">
                                                <input type="hidden" name="currInterest" value="{{$currInterest}}" id="currInterest_{{$index}}">
                                                <input type="hidden" name="data" value="{{json_encode($row)}}" id="data_{{$index}}"> 
                                                <div class="col-lg-12 error-msg">
                                            
                                                <input type="hidden" name="tds_amount_actual[]" id="tds_amount_actual_{{$index}}" class="form-control tds_amount_actual"  style="width: 100px"  readonly  value="{{  number_format((float)0, 2, '.', '') }}">
                                              
                                                <input type="text" name="tds_amount[]" id="tds_amount_{{$index}}" class="form-control tds_amount"  style="width: 100px" data-index="{{$index}}"    value="{{  number_format((float)0, 2, '.', '') }}">
                                                </div> 
                                            </td>
        <td style="border: 1px solid #ddd;">
        ...
        <div class="col-lg-12 error-msg">
            <input type="text" name="transfer_amount[]" id="transfer_amount_{{$index}}" class="form-control transfer_amount "  style="width: 100px"  value="{{  number_format((float)$row->rent, 2, '.', '') }}">

        </div> 
                                             </td>
                                             <!--<td style="border: 1px solid #ddd;">{{  $row['employee_rent']->employee_code}}</td>-->
                                             <td style="border: 1px solid #ddd;">{{  $row['employee_rent']->employee_name}}</td>
                                             <td style="border: 1px solid #ddd;">{{ $row['employee_rent']['designation']->designation_name }}</td>
                                             <td style="border: 1px solid #ddd;">{{ $row['employee_rent']->mobile_no }}</td> 

                                             <input type="hidden" class="form-control  " name="rent_lib_id[]"  value="{{$row->id}}" >

                                         </tr>                                      
                                         @endforeach
                                         <input type="hidden" class="form-control  " name="ledger_month"  value="{{$re_month1}}" >
                                         <input type="hidden" class="form-control  " name="ledger_year"  value="{{$re_year1}}" >
                          ...
                          <input type="hidden" class="form-control create_application_date " name="create_application_date" id="create_application_date"  >
                                        ...
                                        <tfoot>
                                        <tr>
                                        <td colspan="2" align="right" style="border: 1px solid #ddd;"><strong>Total Rent</strong> </td>
                                        <td colspan="2" align="left" style="border: 1px solid #ddd;"><span id='rentAmount'><strong>{{number_format((float)$totalRent, 2, '.', '')}}</strong> </span> </td>
                                        <td colspan="2" align="right" style="border: 1px solid #ddd;"><strong>Total Tds</strong> </td>
                                        <!-- <td colspan="2" align="left" style="border: 1px solid #ddd;"><span id='totalTds'><strong>{{number_format((float)$totalTds, 2, '.', '')}}</strong> </span> </td> -->
                                        <td colspan="2" align="left" style="border: 1px solid #ddd;"><span id='totalTds'><strong>{{number_format((float)0, 2, '.', '')}}</strong> </span> </td>
                                        <td colspan="2" align="right" style="border: 1px solid #ddd;"><strong>Total Amount</strong> </td>
                                        <td colspan="2" align="left" style="border: 1px solid #ddd;"><span id='sum'><strong>{{number_format((float)$total, 2, '.', '')}}</strong> </span> </td>
                                    </tr>
                                    </tfoot>                                         
                                    @else
                                    <tfoot>
                                        <tr>
                                            <td colspan="11" align="center" style="border: 1px solid #ddd;">No Record Found!</td>
                                        </tr>
                                    </tfoot>
                                    @endif
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                @if(count($rent)>0)
                                <button type="submit" class=" btn bg-dark legitRipple"  id="submit_transfer">Create Ledger</button>
                                @endif
