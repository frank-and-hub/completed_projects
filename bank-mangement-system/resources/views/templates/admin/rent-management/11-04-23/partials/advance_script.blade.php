...
$.validator.addMethod("chkadvancr", function(value, element,p) {     
   ...
   // alert(res);
...

    {
      ...
      $.validator.messages.chkadvancr = "Advance payment amount must be greater than settle amount";
...
$.validator.addMethod("chk_tra", function(value, element,p) {     
...

    {
      ...
      $.validator.messages.chk_tra = "Actual transferred amount  must be greater than transfer amount";
...
$.validator.addMethod("secChk", function(value, element,p) {     
   ...
   // alert(res);
    ...
    if(parseFloat(security_amount) <parseFloat(value))
