                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12 text-right">
                                        ...
                                        <input type="hidden" name="loan_recovery_export" id="loan_recovery_export"
                                            value="">
        ...
        <div class="col-md-12 table-section hideTableData">
            ...
            <div class="card">
                ...
                <div class="card-header header-elements-inline">
                    ...
                    <div class="">
                        <button type="button" class=" btn bg-dark legitRipple export ml-2" style="float: right;">Export
                            xslx</button>
