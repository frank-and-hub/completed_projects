    ...
    <div class="content">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="#" method="post" enctype="multipart/form-data" id="filter" name="filter">
                           ...
                           @include('templates.GlobalTempletes.new_role_type',['dropDown'=>$dropDown,'filedTitle'=>$filedTitle,'name'=>$name,'value'=>'','multiselect'=>'false','design_type'=>4,'branchShow'=>true,'branchName'=>'branch_id','apply_col_md'=>true,'multiselect'=>false,'placeHolder1'=>'Please Select Company','placeHolder2'=>'Please Select Branch','selectedCompany'=> $company_id])
                                {{-- <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" id="branch_id" name="branch_id">
                                                    ...
                                                    @foreach ($branch as $val)
                                                        <option value="{{ $val->id }}">
                                                            {{ $val->name }}-{{ $val->branch_code }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-lg-12 error-msg">
                                            <div class="input-group">
                                                <select class="form-control" id="status" name="status">
                                                    ...
                                                    <option value="2">Partial Transferred</option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <div class="col-lg-12 text-right">
                                            ...
                                            <button type="button" class=" btn bg-dark legitRipple filter-report"
                                                onClick="searchFormReport()">Submit</button>
                                            <button type="button" class="btn btn-gray legitRipple filter-report"
                                                id="reset_form" onClick="resetFormReport()">Reset </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12" id="table_container" style="display: none;">
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Rent Ledger ({{ $leaserData->month_name }}
                            {{ $leaserData->year }}) - Report For {{$company_name}}</h6>
                        <div class="">

                            <button type="button" class="btn bg-dark legitRipple export_report ml-2" data-extension="0"
                    ...
                    <table class="table datatable-show-all" id="rent-ledger-table-report">
                        <thead>
                            <tr>
                                ...
                                <th>Tds Amount</th>
                                <th>Payable Amount After TDS</th>
...
@section('script')
    ...
    <script>
        $('#company_id').parents('.col-md-4').hide();
    </script>
