        ...
        <div class="col-md-12" >
                ...
                <div class="card">
                    ...
                    <div class="card-header header-elements-inline">
                        ...
                        <h6 class="card-title font-weight-semibold">Rent Advance Adjustment</h6>
                                ...
                                <div class="col-md-4 ">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 error-msg"> 
                                                ...
                                                <input type="text" name="advance_payment" id="advance_payment" class="form-control advance_payment "   value="{{  number_format((float)$advanceAmount, 2, '.', '') }}" readonly>
                                ...
                                <div class="col-md-4 ">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 error-msg">
                                                ...
                                                <input type="text" name="security_settel" id="security_settel" class="form-control security_settel "   value="0.00" readonly >
                ...
                <input type="text" name="transfer_amount" id="transfer_amount" class="form-control transfer_amount "   value="{{  number_format((float)$rent_list->actual_transfer_amount-$rent_list->transferred_amount, 2, '.', '') }}" readonly>
                                  ...
                                  <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 error-msg">
                                                ...
                                                <input type="text" name="select_date" id="select_date" class="form-control  " value="{{date("d/m/Y")}}" readonly>
