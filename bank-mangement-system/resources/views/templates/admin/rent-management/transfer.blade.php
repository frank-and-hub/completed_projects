...
<div class="content">
        ...
        <div class="col-md-12" >
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Rent  Payble List - {{$leaserData->month_name}} {{$leaserData->year}} For {{$company_name}}</h6>
                    </div>
                                ...
                                <table  class="table table-flush">
                                    ...
                                    ?>
                                         ...
                                         <tr>
                                             ...
                                             @php
                                             $adv = (count($row['rentLib']['advance']) > 0) ? 'yes' : 'no';
                                             if($adv == 'yes'){
                                             $sum_adv = 0;
                                             foreach($row['rentLib']['advance'] as $item){
                                             ...
                                             @endphp
                                                ...
                                                <div class="col-lg-12 error-msg">
                                                  @if($row['rentLib']->advance_payment>0  && $adv == 'yes')
                                                  ...
                                                  @else
                                                  <div class="custom-control custom-checkbox mb-3 ">
    <input type="checkbox" id="rent_transfer_{{$row->id}}" name="rent_transfer[{{$index}}]" class="custom-control-input rent_transfer rent_transferSum" value="{{ $row->actual_transfer_amount-$row->transferred_amount }}" >
    ...
    <input type="hidden" name="actual_transfer_amount[]" id='actual_transfer_amount_{{$row->id}}' value="{{$row->actual_transfer_amount}}" class="actual_transfer_amount">
                                              ...
                                              <td style="border: 1px solid #ddd;">
                                                <a href='{{URL::to("admin/rent/part-payment/".$row->id."/".$leaser_id)}}'>
                                                    Part Payment                                                     
                                                  </a>                                            
                                            </td>
