...
<script type="text/javascript">
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        if (row.amount > 0) {
                            ...
                            return "0.00  <img src='{{ url('/') }}/asset/images/rs.png' width='7'>";
                        }
                    }
                },
                {
    ...
    function DeleteRent(salary) {
        var sal_id = $(salary).data('sal');
        var created_at = $('.created_at').val();
        Swal.fire({
            title: "Are you sure to delete rent payment?",
            input: "textarea",
            inputAttributes: {
                id: "delete-reason",
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{!! route('admin.rent.payment_delete') !!}",
                    type: 'POST',
                    data: {
                        id: sal_id,
    ...
    function DeleteRentm(salary) {
        var emp = $(salary).data('emp');
        swal({
                title: "Are you sure?",
                text: "Do you want to delete rent payment of " + emp + "?",
                type: "warning",
                showCancelButton: true,
