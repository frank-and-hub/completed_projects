        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">Credit Card</h6>
                        <div class="">
                            <button type="button" class="btn bg-dark legitRipple exportCreditcard ml-2" data-extension="1" style="float: right;">Export pdf</button>
                            <button type="button" class="btn bg-dark legitRipple exportCreditcard ml-2" data-extension="0" style="float: right;">Export xslx</button>
                        </div>
                    </div>
                    ...
                    <div class="">
                        ...
                        <table id="credit_cardList" class="table datatable-show-all">
                            <thead>
                                <tr>
                                    <th>S/N</th>
                                    <th>Date</th>
...
@stop
@section('script')
    @include('templates.admin.balance_sheet.partials.credit_card_script')
@stop
