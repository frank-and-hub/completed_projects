                          ...
                          <div class="col-md-12">
                                <div class="form-group row"> 
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchAdvacnePaymentCreditorsForm()" >Submit</button>
                                        <button type="button" class="btn btn-gray legitRipple" id="reset_form" onClick="resetAdvacnePaymentForm()" >Reset </button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold"></h6>
                        <div class="">
                            <button type="button" class="btn bg-dark legitRipple exportAdvancePayment ml-2" data-extension="1" style="float: right;">Export pdf</button>
                            <button type="button" class="btn bg-dark legitRipple exportAdvancePayment ml-2" data-extension="0" style="float: right;">Export xslx</button>
                        </div>
                    </div>
                    
                    <div class="">
                        <table id="advancePaymentCreditorsList" class="table datatable-show-all">
...
@section('script')
    ...
    @include('templates.admin.balance_sheet.partials.advance_payment_script')
