        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @csrf
                        <input type="hidden" name="default_start_date" id="default_start_date" value="{{$startDatee}}">
                        <input type="hidden" name="default_end_date" id="default_end_date" value="{{$endDatee}}">
                      <div class="row">
                          <div class="col-md-4">
                          ...
                          <div class="col-md-12">
                                <div class="form-group row"> 
                                    <div class="col-lg-12 text-right" >
										...
										<input type="hidden" name="total_balance" id="total_balance" value="0"/>
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchbanktransaction()" >Submit</button>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">{{$head_name}}</h6>
                        <div class="">
                    ...
                    <div class="">
                        <table id="bank_wise_detail" class="table datatable-show-all">
...
@section('script')
    ...
    @include('templates.admin.balance_sheet.partials.bank_wise_list_script')
