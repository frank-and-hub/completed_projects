                          ...
                          <div class="col-md-12">
                                <div class="form-group row"> 
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchmember_shipForm()" >Submit</button>
                                        <button type="button" class="btn btn-gray legitRipple" id="reset_form" onClick="resetmember_shipForm()" >Reset </button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
					...
					<div class="card-header header-elements-inline">
						...
						<div class="">
							<button type="button" class="btn bg-dark legitRipple exportMembership ml-2" data-extension="1" style="float: right;">Export pdf</button>
							<button type="button" class="btn bg-dark legitRipple exportMembership ml-2" data-extension="0" style="float: right;">Export xslx</button>
						</div>
					</div>
					
                    <div class="">
                        <table id="member_ship" class="table datatable-show-all">
...
@section('script')
    @include('templates.admin.balance_sheet.partials.member_ship_script')
