        ...
        <div class="row">
            ...
            <div class="card">
                          ...
                          <div class="col-md-12">
                                <div class="form-group row"> 
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <input type="hidden" name="head_no" id="head_no" value="<?php echo $info; ?>"/>
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchfixed_depositForm()" >Submit</button>
                                        <button type="button" class="btn btn-gray legitRipple" id="reset_form" onClick="resetfixed_depositForm()" >Reset </button>
                                    </div>
                                </div>
                            </div>
                        </div>
             ...
             <div class="data container-fluid">
              ...
              <div class="container">
                <button type="button" class="btn bg-dark legitRipple export_deposite ml-2" data-extension="0" style="float: right;">Export xslx</button>

                <button type="button" class="btn bg-dark legitRipple export_deposite" data-extension="1"  style="float: right;">Export PDF</button>
              </div>
            </div> <br/><br/>
