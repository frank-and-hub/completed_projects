        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title font-weight-semibold">@if($branch){{$branch->name}}@else{{$headDetail->sub_head}}@endif</h6>
                        <div class="">
                            <button type="button" class="btn bg-dark legitRipple exportTds ml-2" data-extension="1" style="float: right;">Export pdf</button>
                            <button type="button" class="btn bg-dark legitRipple exportTds ml-2" data-extension="0" style="float: right;">Export xslx</button>
                        </div>
                    </div>

                    
                    <div class="">
                        <table id="tds_report" class="table datatable-show-all">
...
@section('script')
    ...
    @include('templates.admin.balance_sheet.partials.tds_list_script')
