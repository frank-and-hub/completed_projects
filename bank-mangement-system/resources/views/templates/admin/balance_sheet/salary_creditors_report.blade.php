                          ...
                          <div class="col-md-12">
                                ...
                                <div class="form-group row"> 
                                    ...
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchsalartCreditorsForm()" >Submit</button>

                                        <button type="button" class="btn btn-gray legitRipple" id="reset_form" onClick="resetSalaryCreditorsForm()" >Reset </button>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="">
                        ...
                        <table id="salaryCreditorsList" class="table datatable-show-all">
