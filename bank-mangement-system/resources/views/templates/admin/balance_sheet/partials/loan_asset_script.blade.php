...
$( document ).ajaxStart(function() {
 ...
 detailList = $('#loan_asset_report').DataTable({
            ...
            ajax: {
                ...
                "url": "{!! route('admin.balance-sheet.loan_asset_listing') !!}",
...
$('.export_report').on('click',function(){
	...
	$('form#filter').attr('action',"{!! route('admin.balance_sheet.branch_wise.loan_asset.export') !!}");
	$('form#filter').submit();
	return true;
});
...
window.location.href = "{{url('/')}}/admin/balance-sheet/current_liability/branch_wise/loan_asset/?"+queryParams;
