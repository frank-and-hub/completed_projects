...
window.location.href = "{{url('/')}}/admin/balance-sheet/current_liability/{{$head}}?"+queryParams;
...
$('.export').on('click',function(){
  ...
  $('form#filter').attr('action',"{!! route('admin.balance_sheet.report_details.export') !!}");
  $('form#filter').submit();
  return true;
});
