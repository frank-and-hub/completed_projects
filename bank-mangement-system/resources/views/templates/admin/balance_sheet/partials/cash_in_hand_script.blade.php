                            ...
                            ajax: {
                                ...
                                "data":function(d,oSettings) {
                                   if(oSettings.json != null)
                                   {
                                    ...
                                    var page = ($('#caseinhandCreditorsList').DataTable().page.info());
...
{  
    ...
    window.location.href = "{{url('/')}}/admin/balance-sheet/current_liability/branch_wise/case_in_hand?"+queryParams;
    }
