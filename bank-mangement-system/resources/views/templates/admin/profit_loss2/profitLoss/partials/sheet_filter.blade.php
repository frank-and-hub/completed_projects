                    ...
                    <tbody>
                        ...
                        @endphp
                            <tr>
                                ...
                                <th class="text-dark text-center">&#x20B9;{{($lib->head_id == 6) ? $expenseAmount :  $mainHead }}</th>
                            </tr>
...
@include('templates.admin.balance_sheet2.footer',['libalityMainAmount'=>$libalityMainAmount,'AssetMainAmount'=>$AssetMainAmount])