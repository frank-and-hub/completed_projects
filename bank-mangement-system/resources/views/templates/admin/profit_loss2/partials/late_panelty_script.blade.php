...
$('#filter').validate({
 ...
 $('.export').on('click',function(){
  ...
  $('#type').val(2);
  $('form#filter').attr('action',"{!! route('admin.profit-loss.late_panelty.report.export') !!}");
  $('form#filter').submit();
});
  

  
 detailList = $('#late_panelty').DataTable({
            ...
            "fnRowCallback" : function(nRow, aData, iDisplayIndex) {
                ...
                $('html, body').stop().animate({
                    ...
                    scrollTop: ($('#late_panelty').offset().top)
            ...
            ajax: {
                ...
                "url": "{!! route('admin.rofit-loss.late_penalty_list') !!}",
                ...
                "data":function(d,oSettings) {
                   if(oSettings.json != null)
                   {
                    ...
                    var page = ($('#late_panelty').DataTable().page.info());
...
$( document ).ajaxStart(function() {
 ...
 function searchlatePenaltyForm()
    {  
...
// Replace current querystring with the new one.
            window.location.href = "{{url('/')}}/admin/profit-loss/detailed/panelty/?"+queryParams;
}
