...
$('#filter').validate({
   ...
   $('.export').on('click',function(){
	  ...
	  $('form#filter').attr('action',"{!! route('admin.profit-loss.file_chrg.report.export') !!}");
	  $('form#filter').submit();
	});
 detailList = $('#file_chrg').DataTable({
            ...
            "fnRowCallback" : function(nRow, aData, iDisplayIndex) {
                ...
                $('html, body').stop().animate({
                    ...
                    scrollTop: ($('#file_chrg').offset().top)
            ...
            ajax: {
                ...
                "url": "{!! route('admin.profit-loss.file_charge_list') !!}",
                ...
                "data":function(d,oSettings) {
                   if(oSettings.json != null)
                   {
                    ...
                    var page = ($('#file_chrg').DataTable().page.info());
...
{  
    ...
    var queryParams = new URLSearchParams(window.location.search);
        ...
        window.location.href = "{{url('/')}}/admin/profit-loss/detailed/file_charge?"+queryParams;

}
function resetFileChrgForm ()
{
    location.reload();
    $('#is_search').val("no");  
    $('#branch').val(""); 
