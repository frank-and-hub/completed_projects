                    ...
                    <table id="direct_income" class="table  datatable-show-all">
                          ...
                          <thead >
                            ...
                            <tr >
                              ...
                              <th><a href="{{ URL::to('admin/profit-loss/detail/'.$val->head_id.'/'.$val->labels.'/?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{$val->sub_head}} </a> </th>
                              @else
                                 <th><a href="{{ URL::to('admin/profit-loss/head_detail_report/'.$val->head_id.'/'.$val->labels.'?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{strtoupper(($val->sub_head))}}</a></th> 
                                 @endif
                              <th></th>
                              @php 
                          ...
                          @if(count($incomeHeadThree)>0)
                              ...
                              <tbody>
                                ...
                                <tr style="background-color: #dff9fb;">
                                  @if(count($countExpense)>0 )
                                   <th><a href="{{ URL::to('admin/profit-loss/detail/'.$valincome->head_id.'/'.$valincome->labels.'/?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{strtoupper($valincome->sub_head)}} </a> </th>
                                  @else
                                   
                                    <th><a href="{{ URL::to('admin/profit-loss/detail/branch_wise/'.$valincome->head_id.'/'.$valincome->labels.'?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{$valincome->sub_head}}</a></th>
                                   
                                 @endif
                                   <td style="padding-right:150px"></td>
                                   @php 
                                      $headAmount = getHeadClosingNew($valincome->head_id,$date);
                                    @endphp
                         ...
                         <table id="current_asset" class="table  datatable-show-all">
                            ...
                            <thead >
                              ...
                              <tr >
                                  ...
                                  <th><a href="{{ URL::to('admin/profit-loss/detail/'.$val->head_id.'/3/?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{$val->sub_head}} </a> </th>
                              ...
                              @foreach ($expenseHeadThree as  $index => $valexpense)  
                                ...
                                <tbody>
                                  ...
                                  @if(count($CountexpenseHeadThree) > 0 )
                                    <th><a href="{{ URL::to('admin/profit-loss/detail/'.$valexpense->head_id.'/'.$valexpense->labels.'/?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{strtoupper(($valexpense->sub_head))}} </a> </th>
                                  @elseif(in_array(86,$expenseIds) && in_array(40,$expenseIds) == false  && in_array(53,$expenseIds) == false  && in_array(87,$expenseIds) == false  && in_array(88,$expenseIds) == false)
                                      <th><a href="{{ URL::to('admin/profit-loss/head_detail_report/'.$valexpense->head_id.'/'.$valexpense->labels.'?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{strtoupper(($valexpense->sub_head))}}</a></th> 
                                  @elseif($valexpense->head_id ==87)
                                      <th><a href="{{ URL::to('admin/profit-loss/detailed/commission/'.'?head='.$valexpense->head_id.'&date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{$valexpense->sub_head}}</a></th>    
                                  @elseif($valexpense->head_id ==40)
                                      <th><a href="{{ URL::to('admin/profit-loss/detailed/depreciation/'.'?head='.$valexpense->head_id.'&date='.$date.'&to_date='.$to_date.'&financial_year='.$financialYear)}}" target="_blank">{{strtoupper($valexpense->sub_head)}}</a></th> 
                                   
                                  
                                    @elseif($valexpense->head_id ==46)
                                      <th><a href="{{ URL::to('admin/profit-loss/detail/'.$valexpense->head_id.'/'.$valexpense->labels.'/?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{strtoupper(($valexpense->sub_head))}} </a> </th>  
                                    @elseif($valexpense->head_id ==97)
                                      <th><a href="{{ URL::to('admin/profit-loss/detailed/interest_on_loan_taken/'.$valexpense->head_id.'/'.$valexpense->labels.'?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{strtoupper($valexpense->sub_head)}}</a></th> 
                                    @elseif($valexpense->head_id ==88)
                                      <th><a href="{{ URL::to('admin/profit-loss/detailed/fuel_charge/'.'?head='.$valexpense->head_id.'&date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{strtoupper($valexpense->sub_head)}}</a></th>  
                                  @else
                                  <td><a href="{{ URL::to('admin/profit-loss/detail/branch_wise/'.$valexpense->head_id.'/'.$valexpense->labels.'?date='.$date.'&to_date='.$to_date.'&branch_id='.$branch_id.'&financial_year='.$financialYear)}}" target="_blank">{{strtoupper(($valexpense->sub_head))}}</a></td>
                                  @endif
