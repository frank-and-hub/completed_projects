    ...
    <div class="content">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="#" method="post" enctype="multipart/form-data" id="profit-loss-filter"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12 error-msg">
                                        <div class="input-group">
                                            <input type="text" class="form-control create_application_date"
                                                name="create_application_date" id="create_application_date"
                                                value="{{ $endDatee }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="data container-fluid" style="display: none;" id="export_container">
            <style type="text/css">
                #expense {
                    height: 44.5rem;
                    overflow-x: hidden;
            ...
            <div class="container-fluid " >
                <button type="button" class="btn bg-dark legitRipple settlebalancesheet d-none" style="float:left;">Close
                ...
                {{-- <button type="button" class="btn bg-dark legitRipple export" data-extension="1" style="float:right;">Export
                    PDF</button> --}}
            </div>
        </div><br><br>
        <div id="filter_data">
