...
$('#filter').validate({
  ...
  $('form#filter').attr('action',"{!! route('admin.profit-loss.commission.export') !!}");
  $('form#filter').submit();
  });
 detailList = $('#detailList').DataTable({
            ...
            ajax: {
                ...
                "url": "{!! route('admin.rofit-loss.commission_list') !!}",
                ...
                var page = ($('#detailList').DataTable().page.info());
...
function searchcommissionForm()
  ...
  // Set new or modify existing parameter value. 
      ...
      window.location.href = "{{url('/')}}/admin/profit-loss/detailed/commission?"+queryParams;
    }
