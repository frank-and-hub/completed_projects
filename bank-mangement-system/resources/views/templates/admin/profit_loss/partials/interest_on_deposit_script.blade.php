...
$('#filter').validate({
  ...
  $('form#filter').attr('action',"{!! route('admin.profit-loss.interest_on_deposite.report.export') !!}");
  $('form#filter').submit();
  });
 detailList = $('#interest_on_deposit').DataTable({
            ...
            "fnRowCallback" : function(nRow, aData, iDisplayIndex) {
                ...
                $('html, body').stop().animate({
                    ...
                    scrollTop: ($('#interest_on_deposit').offset().top)
            ...
            ajax: {
                ...
                "url": "{!! route('admin.profit-loss.interest_on_deposit_list') !!}",
                ...
                "data":function(d,oSettings) {
                    ...
                    var page = ($('#interest_on_deposit').DataTable().page.info());
...
$( document ).ajaxStart(function() {
 ...
 function searchinterestDepositForm()
    {  
      $('#is_search').val("yes");
...
// Set new or modify existing parameter value. 
      ...
      window.location.href = "{{url('/')}}/admin/profit-loss/detailed/interest_on_deposit/?"+queryParams;
