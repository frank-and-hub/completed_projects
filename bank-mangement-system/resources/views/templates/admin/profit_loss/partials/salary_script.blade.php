...
$('#filter').validate({
  ...
  $('form#filter').attr('action',"{!! route('admin.profit-loss.salary.report.export') !!}");
  $('form#filter').submit();
  });
 detailList = $('#salary').DataTable({
            ...
            ajax: {
                ...
                "url": "{!! route('admin.profit-loss.salary_list') !!}",
                ...
                "data":function(d,oSettings) {
                    ...
                    var page = ($('#salary').DataTable().page.info());
...
$( document ).ajaxStart(function() {
 ...
 function searchsalaryForm()
    ...
    window.location.href = "{{url('/')}}/admin/profit-loss/detailed/salary?"+queryParams;
