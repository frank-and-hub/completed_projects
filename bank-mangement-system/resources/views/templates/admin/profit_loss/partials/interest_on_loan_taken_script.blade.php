...
$('#filter').validate({
  ...
  $('form#filter').attr('action',"{!! route('admin.profit-loss.loan_taken.report.export') !!}");
  $('form#filter').submit();
  });
 detailList = $('#interest_on_loan_taken').DataTable({
            ...
            "fnRowCallback" : function(nRow, aData, iDisplayIndex) {
                ...
                $('html, body').stop().animate({
                    ...
                    scrollTop: ($('#interest_on_loan_taken').offset().top)
            ...
            ajax: {
                ...
                "url": "{!! route('admin.profit-loss.interest_on_loan_taken_list') !!}",
                    ...
                    if(oSettings.json != null)
                {
                   var totalAmount = oSettings.json.total;
                    ...
                    var page = ($('#interest_on_loan_taken').DataTable().page.info());
            ...
            columns: [
                ...
                {data: 'loan_account_name', name: 'loan_account_name'},
...
// Set new or modify existing parameter value. 
      ...
      window.location.href = "{{url('/')}}/admin/profit-loss/detailed/interest_on_loan_taken/{{$head_id}}/{{$label}}?"+queryParams;
    }
function resetForm()
{
    location.reload();
