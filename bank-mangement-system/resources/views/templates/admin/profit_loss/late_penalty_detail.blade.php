                          ...
                          <div class="col-md-12">
                                ...
                                <div class="form-group row"> 
                                    ...
                                    <input type="hidden" name="head_id" id="head_id" value="{{$head}}">
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchlatePenaltyForm()" >Submit</button>
                ...
                <div class="card">
                    ...
                    <div class="">
                        <input type="hidden" name="date" id="date" value="{{$end_date}}">
                         <input type="hidden" name="branch_id" id="branch_id" value="{{$branch_id}}">
                        <table id="late_panelty" class="table datatable-show-all">
...
@include('templates.admin.profit_loss.partials.late_panelty_script')
