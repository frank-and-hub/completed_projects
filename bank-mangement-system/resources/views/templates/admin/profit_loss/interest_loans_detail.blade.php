                          ...
                          <div class="col-md-12">
                                ...
                                <div class="form-group row"> 
                                    ...
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchinterestloanForm()" >Submit</button>
            ...
            <div class="col-md-12 mt-2">
                ...
                <div class="card">
                    ...
                    <div class="">
                        ...
                        <table id="interestloan" class="table datatable-show-all">
...
@section('script')
@include('templates.admin.profit_loss.partials.interest_loan_script')
