                          ...
                          <div class="col-md-12">
                                ...
                                <div class="form-group row"> 
                                    ...
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchduplicate_passbookForm()" >Submit</button>
                                        <button type="button" class=" btn btn-gray legitRipple" onClick="resetduplicate_passbookForm()" >Reset</button>
            ...
            <div class="col-md-12 mt-2">
                ...
                <div class="card">
                    ...
                    <div class="">
                        ...
                        <table id="duplicate_passbook" class="table datatable-show-all">
...
@section('script')
@include('templates.admin.profit_loss.partials.duplicate_passbook_script')
