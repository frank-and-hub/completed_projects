                          ...
                          <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12 text-right" >
                                        ...
                                        <button type="button" class=" btn bg-dark legitRipple" onClick="searchfuelchrgForm()" >Submit</button>

                                         <button type="button" class="btn btn-gray legitRipple" id="reset_form" onClick="resetfuelchrgForm()" >Reset </button>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="">
                        ...
                        <table id="fuel_chrg" class="table datatable-show-all">
...
@include('templates.admin.profit_loss.partials.fuel_chrg_script')
