<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var itemsoptions = $('#item_id0 option').remove();
        $('#company_id').on('change', function() {
            let company_id = $('#company_id option:selected').val();
            $('#vendor_id option').hide();
            $('#vendor_id option[data-companyid="' + company_id + '"]').show();
            $('#vendor_id').val('');
        ...
        @if ($vid > 0 && $vid != '')
            ...
            $('#company_id').on('mouseenter change click', function() {
            ...
            $('#bill_date').hover(function() {
                ...
                $('#bill_date').datepicker('setStartDate', venderDate);
        ...
        $('.item_id').select2({
            ...
            language: {
                noResults: function() {
                    ...
                    return '<button id="no7-results-btn" data-toggle="modal" data-target="#modal-form" class="btn btn-primary additme" >Add Item</a>';
                },
            },
        ...
        $('#vendor_id').on('change select', function() {
            let vendor_id = $(this).val();
            $.ajax({
                type: "GET",
                url: "{{ route('admin.vendor.vendor_create_date') }}",
                dataType: 'JSON',
                data: {
                    'vendor_id': vendor_id,
                },
                success: function(e) {
                    ...
                    $('#bill_date').datepicker('setStartDate', e);
                    $('#bill_date').datepicker('setDate', e);
                }
        ...
        $(document).on('change', '.account_head_item', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#account_subhead1_item_'+ index1).append('<option value="" selected>Select sub head1</option>');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#account_subhead2_item_' + index1).append(
                        '<option value="" selected>Select sub head 2</option>');
                    $.each(response.account_heads, function(index, value) {
                        $('#account_subhead2_item_' + index1).append(
                            "<option value='" + value.head_id + "'>" + value
                            .sub_head + "</option>");
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#account_subhead3_item_' + index1).append(
                        '<option value="" selected>Select sub head 3</option>');
                    $.each(response.account_heads, function(index, value) {
                        $('#account_subhead3_item_' + index1).append(
                            "<option value='" + value.head_id + "'>" + value
                            .sub_head + "</option>");
        ...
        $(document).on('keyup', '#total_discount_val', function() {
            totalDiscountGet();
        });
        ...
        $("#account_head").change(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#account_subhead1').append('<option value="">Select sub head1</option>');
                    $.each(response.account_heads, function(index, value) {
                        $('#account_subhead1').append("<option value='" + value.head_id + "'>" + value.sub_head + "</option>");
                    });
