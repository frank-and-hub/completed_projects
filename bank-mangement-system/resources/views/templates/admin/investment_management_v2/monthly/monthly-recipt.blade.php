        ...
        <div class="card-body">
          ...
          <div class="  row">
            ...
            <div class="col-lg-8   ">
              ...
              {{ $investmentDetails[0]['memberCompany']->member_id }}
          ...
          <div class="  row">
            ...
            <div class="col-lg-8   ">
              ...
              {{ $investmentDetails[0]->tenure*12 }} Months
          ...
          @if($investmentDetails[0]->mi_charge > 0 && $investmentDetails[0]->stn_charge )
          ...
          <div class="  row">
            ...
            {{$investmentDetails[0]->stn_charge}} <img src="{{url('/')}}/asset/images/rs.png" width="9">
          ...
          <div class="  row">
            ...
            <div class="col-lg-8   ">
              ...
              {{$investmentDetails[0]->mi_charge}} <img src="{{url('/')}}/asset/images/rs.png" width="9">
          ...
          <div class="  row">
            ...
            <div class="col-lg-8   ">
              ...
              {{ $investmentDetails[0]['getBankDetails']->cheque_no}}
          ...
          <div class="  row">
            ...
            <div class="col-lg-8   ">
              ...
              {{ $investmentDetails[0]['getBankDetails']->transction_bank_to_name}}
          ...
          <div class="  row">
            ...
            <div class="col-lg-8   ">
              ...
              {{ $investmentDetails[0]['getBankDetails']->getCheque->branch_name}}
          ...
          <div class="  row">
            ...
            <div class="col-lg-8   ">
              ...
              {{ date("d/m/Y", strtotime($investmentDetails[0]['getBankDetails']->getCheque->clearing_date))}}
