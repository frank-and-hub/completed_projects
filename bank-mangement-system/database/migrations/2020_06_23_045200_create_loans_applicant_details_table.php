...
class CreateLoansApplicantDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('loans_applicant_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('loans_applicant_details');
    }
}
