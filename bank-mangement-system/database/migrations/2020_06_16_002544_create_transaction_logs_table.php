...
class CreateTransactionLogsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transaction_logs', function (Blueprint $table) {
            ...
            $table->tinyInteger('transaction_type')->default(1)->comment('1:Saving Account;2:Investment Plans;3:Loan');
            $table->bigInteger('transaction_type_id')->default(0)->comment('0:ssb account,table id(plan_id,loan_id)>0');
