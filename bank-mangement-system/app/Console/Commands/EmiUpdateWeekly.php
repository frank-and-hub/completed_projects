...
class EmiUpdateWeekly extends Command
{
    use EmiDatesTraits;
     ...
     * @var string
     */
    protected $signature = 'emiUpdateWeekly:generate';
    ...
    public function handle()
    {
        ...
        $getLoans = Memberloans::where('loan_type','!=',3)->where('emi_option',2)->whereIn('status',[4])->whereNotNull('approve_date')->get();
