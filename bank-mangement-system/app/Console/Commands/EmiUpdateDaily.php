...
class EmiUpdateDaily extends Command
{
    use EmiDatesTraits;
     ...
     * @var string
     */
    protected $signature = 'emiUpdateDaily:generate';
    ...
    public function handle()
    {
        ...
        $getLoans = Memberloans::where('loan_type','!=',3)->where('emi_option',3)->whereIn('status',[4])->whereNotNull('approve_date')->get();
