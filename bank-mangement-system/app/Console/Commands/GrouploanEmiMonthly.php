...
class GrouploanEmiMonthly extends Command
{
    use EmiDatesTraits;
     ...
     * @var string
     */
    protected $signature = 'groupemiUpdate:generate';
    ...
    public function handle()
    {
        ...
        $getLoans = Grouploans::where('loan_type','=',3)->where('emi_option',1)->whereIn('status',[4])->whereNotNull('approve_date')->get();
