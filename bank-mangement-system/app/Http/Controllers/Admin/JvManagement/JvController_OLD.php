...

{
    ...
    */
            ...
            foreach ($request['account_head'] as $key => $value) {
                ...
                if($request['account_head'][$key]){
                    ...
                    if($head == 56){
                        ...
                        // Bank Heads
                        $bankAccountData = getSamraddhBankAccountId($request['contact'][$key]);
                    ...
                    if($head == 32 || $head == 61 || $head == 72 || $head == 143 || $head == 73 || $head == 76){
                     ...
                     elseif($head == 140){
                        // Vendor Transaction
                        $vendorTrans = $this->VendorTransaction(4,NULL,$type_id,NULL,$vendorData->id,$branch_id,NULL,NULL,$amount,$description,$payment_type,6,'INR',$entry_date,$entry_time,$created_by,$created_by_id,$jv_unique_id);    
                        $type_transaction_id = $vendorTrans;
                    }
                    elseif($head == 142){
                        // Customer Transaction
                        $customerTrans = $this->CustomerTransaction(3,NULL,$type_id,NULL,$customerData->id,$branch_id,NULL,NULL,$amount,$description,$payment_type,6,'INR',$entry_date,$entry_time,$created_by,$created_by_id,$jv_unique_id);    
                        $type_transaction_id = $customerTrans;
                    }
                    elseif($head == 141){
                        // Associate Transaction
                        $associateTrans = $this->AssociateTransaction(5,NULL,$type_id,NULL,$AssociateData->id,$branch_id,NULL,NULL,$amount,$description,$payment_type,6,'INR',$entry_date,$entry_time,$created_by,$created_by_id,$jv_unique_id,2);    
                        $type_transaction_id = $associateTrans;
                    }

                    elseif($parentId->parent_id == 167){
                        // Credit Card Transaction
                        $associateTrans = $this->creditCard(2,NULL,$type_id,NULL,$creditCard->id,$branch_id,NULL,NULL,$amount,$description,$payment_type,6,'INR',$entry_date,$entry_time,$created_by,$created_by_id,$jv_unique_id);    
                        $type_transaction_id = $associateTrans;
                    }

                     elseif($head == 234  ){
                        // Credit Card Transaction
                        $associateTrans = $this->companyBond($dayBookRef,$bound,$entry_date,$amount,0,Null,NULL,NULL,NULL,$payment_type,$type_id,6,$description,$head);    
                    ...
                    elseif($parentId->parent_id == 236 ){
                        // Credit Card Transaction
                        $associateTrans = $this->companyBond($dayBookRef,$bound,$entry_date,0,0,$amount,NULL,NULL,$head,$payment_type,$type_id,6,$description,$head);    
                    ...
                    if($head == 68 || $head == 69 || $head == 70 || $head == 91 || $head == 27 || $parentId->parent_id == 27){
                        // Head Transacion
                        $allTranRDcheque=CommanController::createAllHeadTransaction($dayBookRef,$branch_id,$bank_id=NULL,$bank_ac_id=NULL,$head,$type,$sub_type,$type_id,$type_transaction_id,$associate_id,$member_id,$branch_id_to,$branch_id_from,$amount,$amount,$amount,$description,$payment_type,$payment_mode,$currency_code,$amount_to_id,$amount_to_name,$amount_from_id,$amount_from_name,$jv_unique_id,$v_no=NULL,$v_date=NULL,$ssb_account_id_from=NULL,$ssb_account_id_to=NULL,$ssb_account_tran_id_to=NULL,$ssb_account_tran_id_from=NULL,$cheque_type=NULL,$cheque_id=NULL,$cheque_no=NULL,$cheque_date=NULL,$cheque_bank_from=NULL,$cheque_bank_ac_from=NULL,$cheque_bank_ifsc_from=NULL,$cheque_bank_branch_from=NULL,$cheque_bank_from_id=NULL,$cheque_bank_ac_from_id=NULL,$cheque_bank_to=NULL,$cheque_bank_ac_to=NULL,$cheque_bank_to_name=NULL,$cheque_bank_to_branch=NULL,$cheque_bank_to_ac_no=NULL,$cheque_bank_to_ifsc=NULL,$transction_no=NULL,$transction_bank_from=NULL,$transction_bank_ac_from=NULL,$transction_bank_ifsc_from=NULL,$transction_bank_branch_from=NULL,$transction_bank_from_id=NULL,$transction_bank_from_ac_id=NULL,$bankData->id,$bankAccountData->account_no,$bankData->bank_name,$bankAccountData->account_no,$transction_bank_to_branch=NULL,$bankAccountData->ifsc_code,$transaction_date,$created_by,$created_by_id);
                    }else{
                        // Head Transacion
                        $allTranRDcheque=CommanController::createAllHeadTransaction($dayBookRef,$branch_id,$bank_id=NULL,$bank_ac_id=NULL,$head,$type,$sub_type,$type_id,$type_transaction_id,$associate_id,$member_id,$branch_id_to,$branch_id_from,$amount,$amount,$amount,$description,$payment_type,$payment_mode,$currency_code,$amount_to_id,$amount_to_name,$amount_from_id,$amount_from_name,$jv_unique_id,$v_no=NULL,$v_date=NULL,$ssb_account_id_from=NULL,$ssb_account_id_to=NULL,$ssb_account_tran_id_to=NULL,$ssb_account_tran_id_from=NULL,$cheque_type=NULL,$cheque_id=NULL,$cheque_no=NULL,$cheque_date=NULL,$cheque_bank_from=NULL,$cheque_bank_ac_from=NULL,$cheque_bank_ifsc_from=NULL,$cheque_bank_branch_from=NULL,$cheque_bank_from_id=NULL,$cheque_bank_ac_from_id=NULL,$cheque_bank_to=NULL,$cheque_bank_ac_to=NULL,$cheque_bank_to_name=NULL,$cheque_bank_to_branch=NULL,$cheque_bank_to_ac_no=NULL,$cheque_bank_to_ifsc=NULL,$transction_no=NULL,$transction_bank_from=NULL,$transction_bank_ac_from=NULL,$transction_bank_ifsc_from=NULL,$transction_bank_branch_from=NULL,$transction_bank_from_id=NULL,$transction_bank_from_ac_id=NULL,$transction_bank_to=NULL,$transction_bank_ac_to=NULL,$transction_bank_to_name=NULL,$transction_bank_to_ac_no=NULL,$transction_bank_to_branch=NULL,$transction_bank_to_ifsc=NULL,$transaction_date,$created_by,$created_by_id);
                    }
                    ...
                    $branchDayBook = CommanController::branchDayBookNew($dayBookRef,$branch_id,$type,$sub_type,$type_id,$type_transaction_id,$associate_id,$member_id,$branch_id_to,$branch_id_from,$amount,$amount,$amount,$description,$description_dr,$description_cr,$payment_type,$payment_mode,$currency_code,$amount_to_id,$amount_to_name,$amount_from_id,$amount_from_name,$v_no=NULL,$v_date=NULL,$ssb_account_id_from=NULL,$cheque_no=NULL,$cheque_date=NULL,$cheque_bank_from=NULL,$cheque_bank_ac_from=NULL,$cheque_bank_ifsc_from=NULL,$cheque_bank_branch_from=NULL,$cheque_bank_to=NULL,$cheque_bank_ac_to=NULL,$transction_no=NULL,$transction_bank_from=NULL,$transction_bank_ac_from=NULL,$transction_bank_ifsc_from=NULL,$transction_bank_branch_from=NULL,$transction_bank_to=NULL,$transction_bank_ac_to=NULL,$transaction_date,$entry_date,$entry_time,$created_by,$created_by_id,$is_contra=NULL,$contra_id=NULL,$created_at,$ssb_account_tran_id_to=NULL,$ssb_account_tran_id_from=NULL,$jv_unique_id,$cheque_type=NULL,$cheque_id=NULL);

                    if($head != 60 && $head != 61  && $head != 140  && $head != 141){
                        // Member Transaction
                        $memberTransaction = CommanController::memberTransactionNew($dayBookRef,$type,$sub_type,$type_id,$type_transaction_id,$associate_id,$member_id,$branch_id,$bank_id,$account_id,$amount,$description,$payment_type,$payment_mode,$currency_code,$amount_to_id,$amount_to_name,$amount_from_id,$amount_from_name,$v_no=NULL,$v_date=NULL,$ssb_account_id_from=NULL,$cheque_no=NULL,$cheque_date=NULL,$cheque_bank_from=NULL,$cheque_bank_ac_from=NULL,$cheque_bank_ifsc_from=NULL,$cheque_bank_branch_from=NULL,$cheque_bank_to=NULL,$cheque_bank_ac_to=NULL,$transction_no=NULL,$transction_bank_from=NULL,$transction_bank_ac_from=NULL,$transction_bank_ifsc_from=NULL,$transction_bank_branch_from=NULL,$transction_bank_to=NULL,$transction_bank_ac_to=NULL,$transaction_date,$entry_date,$entry_time,$created_by,$created_by_id,$created_at,$ssb_account_tran_id_to=NULL,$ssb_account_tran_id_from=NULL,$jv_unique_id,$cheque_type=NULL,$cheque_id=NULL);
                    }
    ...
    public static function createTransaction($satRefId,$transaction_type,$account_id,$memberId,$branch_id,$branchCode,$amountArray,$payment_mode,$deposit_by_name,$deposit_by_id,$account_no,$cheque_dd_no,$bank_name,$branch_name,$payment_date,$online_payment_id,$online_payment_by,$saving_account_id,$payment_type,$jv_type_id)
    { 
        $globaldate = Session::get('created_at');    
        foreach ($amountArray as $key=>$option) 
        {
    ...
    { 
        ...
        if ($request->ajax()) {
            ...
            /******* fillter query start ****/       
            $data  = JvJournals::select('id','jv_auto_id','reference','status','notes','created_at','branch_id')
                                ->with(['Branch' => function($q){ $q->select('id','name'); }])                               
                                ->with(['jvJournalHeads' => function($query){ $query->select('id', 'credits_amount','debits_amount','jv_journal_id'); }])
                                ->where('status',1);
            ...
            $data = $data->orderby('id','DESC')
                                ...
                                ->limit($_POST['length'])
                                ->get();
            //$total = JvJournals::with('Branch')->where('status',1)->orderby('id','DESC')->get();
            $totalCount = $count;
    ...
    //         $jvData = JvJournals::where('id',$request['id'])->first();
    ...
    //         // Delete Associate Transaction
    //         $associateTrans = AssociateTransaction::where('type',6)->where('type_id',$request['id'])->delete();
    ...
    //         $memberTransaction = MemberTransaction::whereIN('sub_type',[13,15,22,23,38,39,311,312,313,412,413,414,511,512,513,514,515,516,517,518,519,520,62,63,64,91,105,106,137,138,173,174,193,153,163,222,232,241,251,252,314])->where('type_id',$request['id'])->delete();
    ...
    //                     // Investment Heads
    //                     $investmentData = getInvestmentDetails($request['contact'][$key]);
    //                     if($investmentData->plan_id == 3){
    //                         $sAccount = getSavingAccountMemberId($request['contact'][$key+1]);
    //                         $contectId = $sAccount->id;
    //                         $jvtype = 2;
    //                         $jv_sub_type = NULL;
    //                         $contacttype = 2;
    ...
    //                     $samraddhBankDaybook = CommanController::samraddhBankDaybookNew($dayBookRef,$bank_id,$account_id,$type,$sub_type,$type_id,$type_transaction_id,$associate_id,$member_id,$branch_id,$amount,$amount,$amount,$description,$description_dr,$description_cr,$payment_type,$payment_mode,$currency_code,$amount_to_id,$amount_to_name,$amount_from_id,$amount_from_name,$v_no=NULL,$v_date=NULL,$ssb_account_id_from=NULL,$cheque_no=NULL,$cheque_date=NULL,$cheque_bank_from=NULL,$cheque_bank_ac_from=NULL,$cheque_bank_ifsc_from=NULL,$cheque_bank_branch_from=NULL,$cheque_bank_to=NULL,$cheque_bank_ac_to=NULL,$transction_no=NULL,$transction_bank_from=NULL,$transction_bank_ac_from=NULL,$transction_bank_ifsc_from=NULL,$transction_bank_branch_from=NULL,$transction_bank_to=NULL,$transction_bank_ac_to=NULL,$transction_bank_to_name=NULL,$transction_bank_to_ac_no=NULL,$transction_bank_to_branch=NULL,$transction_bank_to_ifsc=NULL,$transaction_date=NULL,$entry_date,$entry_time,$created_by,$created_by_id,$created_at,$jv_unique_id,$cheque_type=NULL,$cheque_id=NULL,$ssb_account_tran_id_to=NULL,$ssb_account_tran_id_from=NULL);
    //                 }
    //             }
    //         }
...

    {
        ...
        try {
            ...
            $jvHeadData = JvJournalHeads::where('jv_journal_id',$request['id'])->where('is_deleted',0)->get();
                ...
                if($request['account_head'][$key]){
                   ...
                   if($head == 56){
                    ...
                    elseif($parentId->parent_id == 167){
                     ...
                     elseif($head == 234 ){
                        // Credit Card Transaction
                        $associateTrans = $this->companyBond($dayBookRef,$bound,$entry_date,$amount,0,Null,NULL,NULL,NULL,$payment_type,$type_id,6,$description);    
                           

                    }
                    elseif($parentId->parent_id == 236 ){
                        // Credit Card Transaction
                        $associateTrans = $this->companyBond($dayBookRef,$bound,$entry_date,0,0,$amount,NULL,NULL,$head,$payment_type,$type_id,6,$description);  
                        }  
...

    {
        ...
        try {
            ...
            // transaction delete
            $ranscation = Transcation::whereIN('transaction_type',[19,20,21])->where('jv_journal_id',$id)->delete();

            // transaction log delete
            $ranscationLog = TranscationLog::whereIN('transaction_type',[19,20,21])->where('jv_journal_id',$id)->delete();
            ...
            // Delete Associate Transaction
            $associateTrans = AssociateTransaction::where('type',6)->where('type_id',$id)->delete();
            // Credit card Transaction Delete
...

    {
         ...
         $accountHead=AccountHeads::where('labels',1)->get();
...

    {
        ...
        $result=SavingAccount::select('id','account_no')->where('account_no', 'LIKE', '%'.$input['query'].'%')->get();
    ...
    public function getSavingAccountsdetails(Request $request)
    {
        ...
        $result=SavingAccount::with('ssbMember')->where('id', $resValue)->first();
...

    {
        ...
        $input = $request->all();
        $branchId = $request->branchId;
        $result=Member::select('id','member_id')->where('member_id', 'LIKE', '%'.$input['query'].'%')
...

    {
        $input = $request->all();
        $branchId = $request->branchId;
        $result=Member::select('id','associate_no','first_name','last_name')->where('associate_no', 'LIKE', '%'.$input['query'].'%')/*->where('branch_id',$branchId)*/->limit(10)->get();
...

    {
        ...
        if($headid == 64 || $headid == 65 || $headid == 67 ){
            ...
            $result=Memberloans::select('id','account_number','loan_type')->where('loan_type',$loanType)->where('account_number', 'LIKE', '%'.$input['query'].'%')/*->where('branch_id',$branchId)->limit(10)*/->get();
        }elseif($headid == 66){
            $result=Grouploans::select('id','account_number','loan_type')->where('account_number', 'LIKE', '%'.$input['query'].'%')/*->where('branch_id',$branchId)->limit(10)*/->get();
        }elseif($headid == 97 || $headid == 31 || $headid == 33 || $headid == 90 ){
            $result=Memberloans::select('id','account_number','loan_type')->where('account_number', 'LIKE', '%'.$input['query'].'%')->get();
        }
    ...
    {   
        ...
        $result=Vendor::select('id','name')->where('type',$request->userType)->where('name', 'LIKE', '%'.$input['query'].'%')->get();
...

    {
        ...
        if($headid == 58 || $headid == 77 || $headid == 57 || $headid == 78 || $headid == 79 || $headid == 80 || $headid == 81 || $headid == 82 || $headid == 83 || $headid == 84 || $headid == 85){
            $result=Memberinvestments::select('id','account_number')->where('plan_id',$planType)->where('account_number', 'LIKE', '%'.$input['query'].'%')/*->where('branch_id',$branchId)->limit(10)*/->get();
        }elseif($headid == 36){
            $result=Memberinvestments::select('id','account_number')->where('account_number', 'LIKE', '%'.$input['query'].'%')->where('plan_id','!=',1)->get();
        }else{
            $result=Memberinvestments::select('id','account_number')->where('account_number', 'LIKE', '%'.$input['query'].'%')->get();
        }
    ...
    {
        $input = $request->all();
        $result=Employee::with('branch')->select('id','employee_name','employee_code')->where('employee_name', 'LIKE', '%'.$input['query'].'%')
        /*->where('branch_id',$branchId)*/->get();
    ...
    {   
        ...
        $result=ShareHolder::with('member')->select('id','name','member_id')->where('head_id',$headid)->where('type',$pId)->where('name', 'LIKE', '%'.$input['query'].'%')->get();
    ...
    {   
        ...
        if($headid == 97){
            $result=LoanFromBank::select('id','loan_account_number')->where('loan_account_number', 'LIKE', '%'.$input['query'].'%')->get();
        }else{
            $result=LoanFromBank::select('id','loan_account_number')->where('account_head_id',$headid)->where('loan_account_number', 'LIKE', '%'.$input['query'].'%')->get();
        }
...

    {
        ...
        $headid = $request->headId;
        $input = $request->all();
        $result=SamraddhBankAccount::select('id','account_no')->where('account_head_id',$headid)->where('account_no', 'LIKE', '%'.$input['query'].'%')->get();
...

    {
        $input = $request->all();
        $branchId = $request->branchId;
        $result=Branch::select('id','name')->where('name', 'LIKE', '%'.$input['query'].'%')
        /*->where('branch_id',$branchId)*/->get();
        /**********************/
        $branch = [];
    ...
    {
        $input = $request->all();
        $result=RentLiability::select('id','owner_name')->where('owner_name', 'LIKE', '%'.$input['query'].'%')
        /*->where('branch_id',$branchId)*/->get();
    ...
    public function getCustomerDetail(Request $request)
    {
     ...
     public function VendorTransaction($type,$sub_type ,$type_id,$type_transaction_id ,$vendorid,$branch_id,$bankId,$accountId,$amount,$description,$payment_type,$payment_mode,$curr,$entry_date,$entry_time,$created_by,$created_by_id,$jv_unique_id)
    {
        $data['type']=$type;
      ...
      public function CustomerTransaction($type,$sub_type ,$type_id,$type_transaction_id ,$vendorid,$branch_id,$bankId,$accountId,$amount,$description,$payment_type,$payment_mode,$curr,$entry_date,$entry_time,$created_by,$created_by_id,$jv_unique_id)
    {
        $data['type']=$type;
    ...
    public function CreditCard($type,$sub_type ,$type_id,$type_transaction_id ,$creditCardId,$branch_id,$bankId,$accountId,$amount,$description,$payment_type,$payment_mode,$curr,$entry_date,$entry_time,$created_by,$created_by_id,$jv_unique_id)
    {
        $data['type']=$type;
 ...
 // Company Bond Details
    ...
    public function companyBond($DayBookRef,$id ,$date,$interest_amount,$interest_type,$tds_amount ,$received_bank_name,$received_bank_account,$tds_receive_year,$payment_type,$jv_unique_id,$payment_mode,$des)
    {
