...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $dashboardData = [];
	    $accountData['title'] = 'Account Balance';
	    $accountData['total'] = SavingAccount::where('account_no','9999999')->pluck('balance')->first();
	    $dashboardData[] = $accountData;
	    $commissionData['title'] = 'Total Commission';
	    $commissionData['total'] = number_format(AssociateCommission::where('member_id',1)->where('type', '>', 2)->sum('commission_amount'), 2, '.', ' ');
	    $dashboardData[] = $commissionData;
	    $lastMonthCommissionData['title'] = 'Last Month Commission';
	    $firstDateOfMonth = Carbon::now()->startOfMonth()->subMonth()->toDateString();
	    $endDateOfMonth = Carbon::now()->subMonth()->endOfMonth()->toDateString();
	    $lastMonthCommissionData['total'] = number_format(AssociateCommission::where('member_id',1)->where('type', '>', 2)->whereDate('created_at','>=',
		    $firstDateOfMonth)->whereDate('created_at','<=',$endDateOfMonth)->sum('commission_amount'), 2, '.',' ');


	    $dashboardData[] = $lastMonthCommissionData;
	    $data['status'] = $dashboardData;

        return view('templates.super_admin.dashboard.index', $data);
    }    
    ...
    public function Loancompleted()
    {
        ...
        return view('templates.admin.loan.completed', $data);
    }    
    ...
    public function Loanhold()
    {
        ...
        return view('templates.admin.loan.on-hold', $data);
    }     
    ...
    public function Loanpending()
    {
        ...
        return view('templates.admin.loan.pending', $data);
    } 
    ...
    public function Ticket()
    {
        ...
        return view('templates.admin.user.ticket', $data);
    }   
    ...
    public function Email($id,$name)
    {
		...
		$data['email']=$id;
		$data['name']=$name;
        return view('templates.admin.user.email', $data);
    }    
    ...
    public function Promo()
    {
        ...
        return view('templates.admin.user.promo', $data);
    } 
    ...
    public function Manageuser($id)
    {
        ...
        return view('templates.admin.user.edit', $data);
    }     
    ...
    public function Manageticket($id)
    {
        ...
        return view('templates.admin.user.edit-ticket', $data);
    }    
