...
*/
class CommanAppEpassbookController extends Controller
{
    /**
    ...
    {
        $cheque = \App\Models\ReceivedCheque::where('status', 2)->get(['id', 'cheque_no', 'amount']);
     ...
     * @return \Illuminate\Http\Response
     */
    public static function createSavingAccountDescriptionModify($memberId, $branch_id, $branchCode, $amount, $payment_mode, $investmentId, $miCode, $investmentAccountNoSsb, $is_primary, $faCode, $description, $associate_id)
    {
        $ssbArray = array();
        $miCodePassbook = str_pad($miCode, 5, '0', STR_PAD_LEFT);
        // pass fa id 20 for passbook
    ...
    public static function createDayBookNew($transaction_id, $satRefId, $transaction_type, $account_id, $associateId, $memberId, $openingBalance, $deposite, $withdrawal, $description, $referenceno, $branch_id, $branchCode, $amountArray, $payment_mode, $deposit_by_name, $deposit_by_id, $account_no, $cheque_dd_no, $bank_name, $branch_name, $payment_date, $online_payment_id, $online_payment_by, $saving_account_id, $payment_type, $received_cheque_id, $cheque_deposit_bank_id, $cheque_deposit_bank_ac_id, $online_deposit_bank_id, $online_deposit_bank_ac_id, $Appuser, $isApp, $daybookRefRD, $company_id)
    {
        ...
        foreach ($amountArray as $key => $option) {
            ...
            $data_log['created_by_id'] = $Appuser;
            $data_log['created_by'] = 4;
            $data_log['app_login_user_id'] = $Appuser;
            $data_log['is_app'] = $isApp;
            if ($isApp == 1) {
            ...
            $data_log['is_renewal'] = 0;
            $data_log['daybook_ref_id'] = $daybookRefRD;
    ...
    public function bankChkbalance(Request $request)
    {
        ...
        $bankBla = \App\Models\SamraddhBankClosing::select('id', 'balance', 'bank_id')->where('bank_id', $bank_id_from_c)->where('account_id', $bank_ac_id_from_c)->whereDate('entry_date', '<=', $entry_date)->orderby('entry_date', 'desc')->first();
        ...
        $getRecord = \App\Models\SamraddhBank::select('id', 'bank_name', 'created_at')->where('id', $bank_id_from_c)->first();
        if ($getRecord) {
     ...
     * @return \Illuminate\Http\Response
     */
    public static function SSBDateCR($account_id, $account_no, $balance, $amount, $description, $currency_code, $payment_type, $payment_mode, $branch_id, $associate_id, $type, $date)
    {
    ...
    */
    ...
    public static function gstTransaction($dayBookId = NULL, $companyGstNo = NULL, $customerGstNo = NULL, $taxValue = NULL, $rateofTax = NULL, $amountIgstTax = NULL, $amountCgstTax = NULL, $amountSgstTax = NULL, $totalAmount = NULL, $headId = NULL, $entryDate, $flag, $type_id, $branchId)
    {
        $globaldate = Session::get('created_at');
