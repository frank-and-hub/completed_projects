...
function City5AverageRentalPriceSection() {
  return (
      ...
      <Container size={"lg"}>
        <div className="average_rental_prices_container">
          ...
          <Flex align={"center"} justify={"center"} direction={"column"}>
            <h2>
              average rental price In <span>western Cape</span>{" "}
            </h2>
            <h3>How Much Does It Cost to Rent in Western Cape?</h3>
            <div className="average_rental_prices_box">
              {AverageRentalData.map((ele, i) => (
                <Flex
                  key={i}
                  align={"center"}
...
export default City5AverageRentalPriceSection;
