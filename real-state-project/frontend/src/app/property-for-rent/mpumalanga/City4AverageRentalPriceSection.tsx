...
function City4AverageRentalPriceSection() {
  return (
     ...
     size={"lg"}>
      ...
      className="logoImage"
        ...
        />
          ...
          <h2>average rental price In <span>Mpumalanga</span> </h2>
          <h3>How Much Does It Cost to Rent in Mpumalanga?</h3>
...
export default City4AverageRentalPriceSection