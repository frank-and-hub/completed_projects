...
function City2AverageRentalPriceSection() {
  return (
    ...
    <Container size={"lg"}>
      ...
      className="logoImage"
        ...
        />
          ...
          <h2>average rental price In <span>KwaZulu-Natal</span> </h2>
          <h3>How Much Does It Cost to Rent in KwaZulu-Natal?</h3>
...
export default City2AverageRentalPriceSection