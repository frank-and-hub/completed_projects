            ...
            <div class="card-body">
                <div class="row d-flex justify-content-between align-items-center">
                    ...
                    <!-- <div class="text-right">
                                <a href="{{ route('adminSubUser.property.add') }}" data-toggle="tooltip" data-original-title="Add New" class="btn  btn-danger  mr-2"><i class="fa fa-plus"> </i> Add New</a>
                            </div> -->
                </div>
                <div class="row">
                    <div class="col-12">
