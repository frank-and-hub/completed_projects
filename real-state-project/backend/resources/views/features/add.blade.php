        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="cmxform" id="add_features" name="add_features" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="heading">Heading <span class="text-danger">*</span></label>
                            <input id="heading" class="form-control" name="heading" type="text">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-6 form-group">
                                ...
                                <input type="file" class="form-control" name="features_img" id="features_img"
                                    onchange="upload()">
                            </div>
                            <div class="col-6">
...
@push('custom-script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("form[name='add_features']").validate({
                rules: {
                    heading: {
                        required: true
                    },
