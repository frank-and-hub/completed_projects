    ...
    <div class="page-header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="{{ route('adminSubUser.agent.index') }}">List</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="cmxform" id="add_agency" name="add_agency" enctype="multipart/form-data">
                        ...
                        <div class="alert alert-success  success_msg">edededeed</div>
                        <div class="alert alert-danger error_msg">cdcdcdcd</div>
...
@push('custom-script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            // $('.suceess_msg').html("response.message");
            ...
            $("form[name='add_agency']").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('adminSubUser.agent.store') }}",
                        type: "POST",
                        ...
                        success: function(response) {
                            if (response.status == true) {
                                $("form[name='add_agency']").find('.error_msg').remove();
