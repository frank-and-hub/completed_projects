...
Route::prefix('admin')->name('admin.')->middleware('auth:admin', 'prevent-back-history')->group(function () {
    ...
    // Route::get('workout-add', [AdminWorkoutController::class, 'userAdd'])->name('userAdd');
    // Route::get('workout-create', [AdminWorkoutController::class, 'workoutCreate'])->name('workoutCreate');
    ...
    // Route::post('exercise-save', [AdminWorkoutController::class, 'exerciseSave'])->name('exerciseSave');
    Route::delete('delete/{id}', [AdminWorkoutController::class, 'workoutPlanDelete'])->name('workoutPlanDelete');
    //  Route::get('/create_meal', [AdminWorkoutController::class, 'meal'])->name('meal');
    ...
    //         Route::get('/workout_settings', 'workout')->name('workout');
    //         Route::get('/create_meal', 'meal')->name('meal');
    //         Route::get('/admin/meals', 'getMealsByPreference')->name('get.meals.by.preference');

    //         Route::post('/update_meal', 'saveUserMeals')->name('saveUserMeals');
    //         Route::get('/filter_meal', 'mealfilter')->name('mealfilter');
    //         Route::post('/workout_update', 'workoutupdate')->name('workoutupdate');
