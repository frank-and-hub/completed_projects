...
@section('content')
@section('admin-title', 'Edit workout plan')

<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

<form action="{{ route('admin.workoutPlansUpdate', $workout->id) }}" method="POST" enctype="multipart/form-data"
    id="editExerCise">
    @csrf
    @method('POST')
    <input type="hidden" name="weeks_data" id="weeks_data" value="{{ json_encode($workout->getFormattedWeeksData()) }}">
        ...
        <div class="pate-content-wrapper">
            ...
            <div class="m-card-min-hight">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control form-control-lg" id="title" name="title"
                                    placeholder="Enter title" value="{{ old('title', $workout->title) }}"
                                    maxlength="50">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="number" class="form-control form-control-lg" id="duration"
                                    ...
                                    value="{{ old('duration_weeks', $workout->duration_weeks) }}">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($workout->image)
                                <div class="my-2 workout-plan-image">
                                    <img src="{{ asset($workout->image) }}" width="100" class="img-thumbnail">
                                </div>
                            @endif
                        ...
                        <div class="">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="level" id="level"
                                    value="1" {{ $workout->level == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="level" id="level-2"
                                    value="2" {{ $workout->level == 2 ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="level" id="level-3"
                                    value="3" {{ $workout->level == 3 ? 'checked' : '' }}>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter description"
                                maxlength="12000">{{ old('description', $workout->description) }}</textarea>
                ...
                <div class="text-end mb-3">
                    ...
                    {{-- <button type="submit" name="action" value="next" class="btn btn-primary btn-sm" id="submitBtn1">Next</button> --}}
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control" id="exerciseReps"
                                placeholder="Enter Reps (max-100)" min="0" max="100"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control" id="exerciseSets"
                                placeholder="Enter Sets (max-100)" min="0" max="100"
                                oninput="validateRestSeconds(this)">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="number" class="form-control" id="exerciseRestTime"
                                placeholder="Enter Rest Time (max-60)"
                                value="{{ old('restTime', $workout->restTime) }}" oninput="validateRestSeconds(this)"
                                max="60" min="0">
