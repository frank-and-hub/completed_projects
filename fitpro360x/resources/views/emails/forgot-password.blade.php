                    ...
                    <table
                        ...
                        <tr>
                            <td
                                ...
                                <p>We received a request to reset the password for your <b> {{ env('APP_NAME') }} </b> account.
                                </p>
                                ...
                                <p>We received a request to reset your password. Please use the OTP below to complete
                                    your request. The OTP will expire in 10 minutes.</p>
                                <br>
                                ...
                                <p style="line-height: 28px;margin: 0 0 20px 0;">
                                    <strong>{{ env('APP_NAME') }} App,</strong><br />
                                </p>
                            </td>
                        </tr>
                    </table>
