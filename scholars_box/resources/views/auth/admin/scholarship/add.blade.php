  ...
  <div class="col-md-12 stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.scholarship.save') }}">
          @csrf
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('company_name') is-invalid @enderror" placeholder="Enter company name" name="company_name" value="{{ old('company_name') }}">
                @error('company_name')
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('tag') is-invalid @enderror" placeholder="Enter tag" name="tag" value="{{ old('tag') }}">
                @error('tag')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div class="mb-3">
                ...
                <textarea class="form-control @error('who_can_apply_info') is-invalid @enderror" rows="5" placeholder="Enter information about who can apply" name="who_can_apply_info">{{ old('who_can_apply_info') }}</textarea>
            ...
            <div class="col-sm-12">
              <div class="mb-3">
                ...
                <textarea class="form-control @error('faqs') is-invalid @enderror" rows="5" placeholder="Enter frequently asked questions" name="faqs">{{ old('faqs') }}</textarea>
                @error('faqs')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="col-sm-12">
              <div class="mb-3">
                ...
                <textarea class="form-control @error('contact_details') is-invalid @enderror" rows="5" placeholder="Enter contact details" name="contact_details">{{ old('contact_details') }}</textarea>
