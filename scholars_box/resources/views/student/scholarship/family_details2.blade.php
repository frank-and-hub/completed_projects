<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <input  type="text"  name="guardian_name"  class="form-input-one"  placeholder=""  value="{{ isset($draft) && $draft->guardian_name != '' ? $draft->guardian_name : optional($user->student->guardianDetails)->name }}"  {{$scholarships[0]->apply_now->principal_guardian_name_r == '1' ? 'required="true"' : '' }} />
        </div> 
    </div>  
    @endif
    ...
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <select  name="guardian_relationship"  class="form-input-one"  {{$scholarships[0]->apply_now->relationship_with_the_principal_guardian_r == '1' ? 'required="true"' : '' }} >
                ...
                <option value="Father" {{ (isset($draft) && $draft->guardian_relationship != '' ? $draft->guardian_relationship : optional($user->student->guardianDetails)->relationship) === 'Father' ? 'selected' : '' }}>Father</option>
                <option value="Mother" {{ (isset($draft) && $draft->guardian_relationship != '' ? $draft->guardian_relationship : optional($user->student->guardianDetails)->relationship) === 'Mother' ? 'selected' : '' }}>Mother</option>
                <option value="Others" {{ (isset($draft) && $draft->guardian_relationship != '' ? $draft->guardian_relationship : optional($user->student->guardianDetails)->relationship) === 'Others' ? 'selected' : '' }}>Others</option>
            </select>
        </div>
    </div>
    @endif    
    ...
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <input  type="text" name="guardian_occupation"  class="form-input-one"  value="{{ isset($draft) && $draft->guardian_occupation != '' ? $draft->guardian_occupation : optional($user->student->guardianDetails)->occupation }}"  placeholder="" {{$scholarships[0]->apply_now->occupation_of_the_principal_guardian_r == '1' ? 'required="true"' : '' }} />
        </div>
    </div>
    @endif
...
@endif
    ...
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <select name="number_of_siblings" class="form-input-one" {{$scholarships[0]->apply_now->no_of_siblings_r == '1' ? 'required="true"' : '' }}>
                ...
                <option value="only_child" {{ (isset($draft) && $draft->number_of_siblings != '' ? $draft->number_of_siblings : optional($user->student->guardianDetails)->number_of_siblings) === 'only_child' ? 'selected' : '' }}> Only Child</option>
                <option value="1" {{ (isset($draft) && $draft->number_of_siblings != '' ? $draft->number_of_siblings : optional($user->student->guardianDetails)->number_of_siblings) === '1' ? 'selected' : '' }}> 1</option>
                <option value="2" {{ (isset($draft) && $draft->number_of_siblings != '' ? $draft->number_of_siblings : optional($user->student->guardianDetails)->number_of_siblings) === '2' ? 'selected' : '' }}> 2</option>
                <option value="3" {{ (isset($draft) && $draft->number_of_siblings != '' ? $draft->number_of_siblings : optional($user->student->guardianDetails)->number_of_siblings) === '3' ? 'selected' : '' }}> 3</option>
                <option value="4" {{ (isset($draft) && $draft->number_of_siblings != '' ? $draft->number_of_siblings : optional($user->student->guardianDetails)->number_of_siblings) === '4' ? 'selected' : '' }}> 4</option>
                <option value="5" {{ (isset($draft) && $draft->number_of_siblings != '' ? $draft->number_of_siblings : optional($user->student->guardianDetails)->number_of_siblings) === '5' ? 'selected' : '' }}> 5</option>
                <option value="6" {{ (isset($draft) && $draft->number_of_siblings != '' ? $draft->number_of_siblings : optional($user->student->guardianDetails)->number_of_siblings) === '6' ? 'selected' : '' }}> 6</option>
            </select>
        </div>
    </div>
    @endif
    ...
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <input  type="text" name="annual_income"  value="{{ isset($draft) && $draft->annual_income != '' ? $draft->annual_income : optional($user->student->guardianDetails)->annual_income }}"  class="form-input-one digitsOnly"  placeholder="Annual Income"  {{$scholarships[0]->apply_now->familys_annual_income_r == '1' ? 'required="true"' : '' }} />
        </div>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <select name="current_house_type" class="form-input-one" {{$scholarships[0]->apply_now->current_house_type_r == '1' ? 'required="true"' : '' }}>
                ...
                <option value="self_family_owned_katcha_house" {{ (isset($draft) && $draft->current_house_type != '' ? $draft->current_house_type : optional($user->student->addressDetails->firstWhere('type', 'current'))->house_type) === 'self_family_owned_katcha_house' ? 'selected' : '' }}> Self/Family Owned Katcha House (Mud House, Tin Shed)</option>
                <option value="self_family_owned_pakka_house" {{ (isset($draft) && $draft->current_house_type != '' ? $draft->current_house_type : optional($user->student->addressDetails->firstWhere('type', 'current'))->house_type) === 'self_family_owned_pakka_house' ? 'selected' : '' }}> Self/Family Owned Pakka House</option>
                <option value="rented_katcha_house" {{ (isset($draft) && $draft->current_house_type != '' ? $draft->current_house_type : optional($user->student->addressDetails->firstWhere('type', 'current'))->house_type) === 'rented_katcha_house' ? 'selected' : '' }}> Rented Katcha (Mud House/Tin Shed)</option>
                <option value="rented_pakka_house" {{ (isset($draft) && $draft->current_house_type != '' ? $draft->current_house_type : optional($user->student->addressDetails->firstWhere('type', 'current'))->house_type) === 'rented_pakka_house' ? 'selected' : '' }}> Rented Pakka House</option>
            </select>
        </div>
    </div>
@endif
@if(isset($scholarships[0]->apply_now->current_address_h_s) && ($scholarships[0]->apply_now->current_address_h_s == '1'))
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <textarea name="current_address" class="form-input-one" placeholder="Address" {{$scholarships[0]->apply_now->current_address_r == '1' ? 'required="true"' : '' }} >{{ (isset($draft) && $draft->current_address != '') ? $draft->current_address : (optional($user->student->addressDetails->firstWhere('type', 'current'))->address??'') }}</textarea>
        </div>
    </div>
    @endif
    ...
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <select class="form-input-one current_state" name="current_state" id="current_state" {{$scholarships[0]->apply_now->current_state_r == '1' ? 'required="true"' : '' }}>
                ...
                @foreach($state as $s)
                <option value="{{$s->name}}" class="" data-val="{{$s->id}}"{{ ((isset($draft) && ($draft->current_state != '') ? $draft->current_state : (optional($user->student->addressDetails->firstWhere('type', 'current'))->state)) == $s->name) ? 'selected' : '' }} >{{$s->name}}</option>
                @endforeach
            </select>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <select id="current_district" name="current_district" class="form-input-one" {{$scholarships[0]->apply_now->current_district_r == '1' ? 'required="true"' : '' }}  selected-district-is="{{(optional($user->student->addressDetails->firstWhere('type', 'current'))->district)}}">
    ...
    <div class="col-md-4">
        <div class="form-box-one">
            ...
            <input  type="text" name="current_pincode"  id="current_pincode"  class="form-input-one digitsOnly"  placeholder="Pincode"  value="{{ (isset($draft) && $draft->current_pincode != '') ? ($draft->current_pincode) : (optional($user->student->addressDetails->firstWhere('type', 'current'))->pincode) }}"  {{$scholarships[0]->apply_now->current_pin_code_r == '1' ? 'required="true"' : '' }} />
            <div id="pincodeError" style="color: red;"></div>
        </div>
    </div>
    <?php
    $is_pm_same_as_current = 0;
    if(isset($scholarships[0])){
        if($scholarships[0]->apply_now){
            if(optional($user->student->addressDetails->firstWhere('type', 'current'))->house_type == optional($user->student->addressDetails->firstWhere('type', 'permanent'))->house_type){
                if(optional($user->student->addressDetails->firstWhere('type', 'current'))->address == optional($user->student->addressDetails->firstWhere('type', 'permanent'))->address){
                    if(optional($user->student->addressDetails->firstWhere('type', 'current'))->state == optional($user->student->addressDetails->firstWhere('type', 'permanent'))->state){
                        if(optional($user->student->addressDetails->firstWhere('type', 'current'))->district == optional($user->student->addressDetails->firstWhere('type', 'permanent'))->district){
                            if(optional($user->student->addressDetails->firstWhere('type', 'current'))->pincode == optional($user->student->addressDetails->firstWhere('type', 'permanent'))->pincode){
                                $is_pm_same_as_current = 1;
                            }
                        }
                    }
                }
