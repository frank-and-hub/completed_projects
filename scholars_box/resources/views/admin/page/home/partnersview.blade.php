                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        placeholder="Enter title" name="title" value="{{ old('partners', $partner->title) }}" readonly>
                                    @error('blog_title')
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    @if ($partner->image)
                                    <img src="{{ asset('uploads/' . $partner->image) }}" alt="Blog Image" class="mb-2" style="max-width: 200px;">
                                @endif
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="summernote" name="description" readonly>{!!$partner->description!!}</textarea>
                                        @error('blog_content')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
