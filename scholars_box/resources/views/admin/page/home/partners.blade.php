        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                        ...
                        <a href="{{ route('admin.home.partner.add') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (condication(auth()->user(), '3', 'edit'))
                                                <a href="{{ route('admin.home.partner.edit', $value->id) }}" class="btn btn-none bg-none border-0" >
                                                    <i class="fas fa-edit"></i> <!-- Edit icon -->
                                                </a> |
                                                @endif @if (condication(auth()->user(), '3', 'view'))
                                                    <a href="{{ route('admin.home.partner.view', $value->id) }}" class="btn btn-none bg-none border-0" >
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            <!--<button type="button" class="btn btn-primary" data-dismiss="modal">-->
                                                <a href="{{ route('admin.home.partner.delete', $value->id) }}" class="text-white btn btn-primary">
                                                    Yes
                                                </a>
                                            <!--</button>-->
