...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">CMS Form</h6>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('page_title') is-invalid @enderror"
                                        placeholder="Enter page title" name="page_title" value="{{ $pageEdit->page_name }}">
                                    @error('page_title')
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="summernote" name="page_content">{!! $pageEdit->content !!}</textarea>
                                        @error('page_content')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
