...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      ...
      <a href="{{route('admin.study.add')}}"><h6 style="float:right;" class="card-title">Add New</h6></a>
    @endif
              ...
              <tr>
                ...
                <td>
                    @if(condication(auth()->user(),'3','edit'))
                        <a href="{{ route('admin.study.edit', $value->id) }}"  class="btn btn-none bg-none border-0" >
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Delete Study Material</h5>
                              ...
                              <div class="modal-footer">
                                <!--<button type="button" class="btn btn-primary" data-dismiss="modal">-->
                                    <a href="{{ route('admin.study.delete', $value->id) }}" class="text-white btn btn-primary">
                                        Yes
                                    </a>
                                <!--</button>-->
