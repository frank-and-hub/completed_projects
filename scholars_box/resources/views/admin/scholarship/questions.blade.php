  ...
  <div class="col-md-12 stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h5>
          Question {{ ++$key }}:- {{$value->question}} ({{$value->type}})
          <a href="{{ route('admin.scholarship.deleteQuestion', $value->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this question?')">Delete</a>
        </h5>
        <ul>
          @foreach($value->options as $data)de
