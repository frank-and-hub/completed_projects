      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              @forelse($company as $student)
            <tr>
                <td>{{$student->company_name??''}}</td>
                <td>{{$student->email}}</td>
                 <th>{{date('Y-m-d',strtotime($student->created_at))}}</th>
                <td>
                    <a href="{{ route('company.edit', $student->id) }}" class="btn btn-none bg-none border-0" >
                        <i class="fas fa-edit"></i> <!-- Edit icon -->
                    </a><span>  </span> | <span>  </span> 
                    <a href="{{ route('company.show', $student->id) }}" class="btn btn-none bg-none border-0" >
                    ...
                    <a href="{{ route('company.permission',$student->id)}}" class="btn btn-none bg-none border-0" >
                        <i class="fas fa-lock"></i> <!-- Application icon -->
                    </a>
                    <a href="{{ route('company.details.create', $student->id) }}" class="btn btn-none bg-none border-0" >
                      <i class="fas fa-building"></i> <!-- Edit icon -->
                  </a>
                </td>
            </tr>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <!--<button type="button" class="btn btn-primary" data-dismiss="modal">-->
                        <a href="{{ route('company.delete', $student->id) }}" class="text-white btn btn-primary">
                            Yes
                        </a>
                    <!--</button>-->
