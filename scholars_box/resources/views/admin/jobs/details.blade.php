                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4 class="value">{{ $data->first_name }}</h4>
                                    </td>
                                    ...
                                    <td>
                                        <h4 class="value">{{ $data->last_name }}</h4>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4 class="value">{{ $data->category }}</h4>
                                    </td>
                                    <td>
                                        <h4>Phone Number :</h4>
                                    </td>
                                    <td>
                                        <h4 class="value">{{ $data->filed1 }}</h4>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4 class="value">{{ $data->message }}</h4>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    @if ($data->filed2)
                        <img src="{{ asset('uploads/' . $data->filed2) }}" alt="Blog Image" class="mb-2" style="max-width: 200px;">
                    @endif
                                </td>
