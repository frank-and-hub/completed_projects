...
@section('content')
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add MicroSite</li>
        </ol>
    </nav>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="about_title" placeholder="Enter about title">
                                    @error('about_title')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('about_description') is-invalid @enderror" id="summernote" name="about_description"></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('detail_description') is-invalid @enderror" id="summernote" name="detail_description"></textarea>
