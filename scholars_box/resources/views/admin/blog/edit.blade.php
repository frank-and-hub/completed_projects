          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('blog_title') is-invalid @enderror" placeholder="Enter blog title" name="blog_title" value="{{ old('blog_title', $blog->blog_title) }}">
                @error('blog_title')
    ...
    <div class="mb-3">
        ...
        @enderror
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="mb-3">
                ...
                <textarea id="summernote" name="blog_content">{{ old('blog_content', $blog->description) }}</textarea>
                @error('blog_content')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
          ...
          <div class="mb-12">
                          ...
                          <textarea  class="form-control" name="tags" id="tags">{{ old('tags', $blog->tags) }}</textarea>
                          @error('tags')
                          <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                      </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('blog_tag') is-invalid @enderror" placeholder="Enter blog title" name="blog_tag" value="{{ old('tags', $blog->teg) }}">
                @error('blog_tag')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
