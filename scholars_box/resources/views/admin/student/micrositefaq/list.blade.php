...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
          @if(condication(auth()->user(),'7','add'))
      <a href="{{route('admin.mfaq.add')}}"><h6 style="float:right;" class="card-title">Add New</h6></a>
  @endif
          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    @if(condication(auth()->user(),'7','edit'))
                    <a href="{{ route('admin.faq.edit', $value->id) }}" class="btn btn-none bg-none border-0" >
                        <i class="fas fa-edit"></i> <!-- Edit icon -->
                    </a> | @endif @if(condication(auth()->user(),'7','view'))
                    <a href="{{ route('admin.faq.view', $value->id) }}" class="btn btn-none bg-none border-0" >
                        <i class="fas fa-eye"></i> <!-- View icon -->
                    </a> | @endif @if(condication(auth()->user(),'7','delete'))
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <!--<button type="button" class="btn btn-primary" data-dismiss="modal">-->
                            <a href="{{ route('admin.faq.delete', $value->id) }}" class="text-white btn btn-primary">
                                Yes
                            </a>
                        <!--</button>-->
