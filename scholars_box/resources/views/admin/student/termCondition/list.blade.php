...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Terms List</li>
  </ol>
</nav>
...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      ...
      <a href="{{route('admin.term.add')}}"><h6 style="float:right;" class="card-title">Add New</h6></a>
    @endif
        <h6 class="card-title">Terms List</h6>
              ...
              <tr>
                ...
                <td>
                    @if(condication(auth()->user(),'3','edit'))
                        <a href="{{ route('admin.term.edit', $value->id) }}"  class="btn btn-none bg-none border-0" >
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <!--<button type="button" class="btn btn-primary" data-dismiss="modal">-->
                                    <a href="{{ route('admin.term.delete', $value->id) }}" class="text-white btn btn-primary">
                                        Yes
                                    </a>
                                <!--</button>-->
