    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-control" id="multibutton" style="display: none;">
            <button type="button" class="btn btn-secondary">Send Notificatin</button>
        </div>
                ...
                @foreach($students as $student)
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('admin.scholarship.notification',[$student->user_id]) }}" title="Notification" >
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                    <a  href="{{ route('student.delete', $student->user_id) }}" class="text-white btn btn-primary ">
                                        Yes
                                    </a>
