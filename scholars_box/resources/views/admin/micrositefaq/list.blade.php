          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              ...
              <tr>
               ...
               <a href="{{route('admin.mfaq.edit',$value->id)}}"> <button type="button" class="btn btn-none bg-none border-0" title="edit">
                      <i class="fas fa-edit"></i> <!-- Delete icon -->
                    </button></a>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <!--<button type="button" class="btn btn-primary" data-dismiss="modal">-->
                            <a href="{{ route('admin.mfaq.delete', $value->id) }}" class="text-white btn btn-primary">
                                Yes
                            </a>
                        <!--</button>-->
