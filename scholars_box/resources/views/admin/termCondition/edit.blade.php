...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Terms & Conditions Form</h6>
                                    ...
                                    <select name="scholarship_name" class="form-control select2">
                                        ...
                                        @foreach ($microsite as $value)
                                            <option value="{{ $value->id }}"
                                                @if ($value->id == $blog->ani1) selected @endif>{{ $value->company_name }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="summernote" name="desc">{{ old('desc', $blog->desc) }}</textarea>
                                        @error('desc')
