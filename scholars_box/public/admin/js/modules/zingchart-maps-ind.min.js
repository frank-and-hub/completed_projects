...
ZC.WI.push("maps-ind"),
  (function () {
    zingchart.maps.ind || (zingchart.maps.ind = {}),
      zingchart.maps.data.ind || (zingchart.maps.data.ind = {});
    var t = {
      TN: [
        [78.236, 12.776],
        [78.356, 12.637],
    ...
    (zingchart.maps.data.ind = {
      _GROUPS_: {},
      _DEFAULTS_: zingchart.maps._DEFAULTS_,
      TN: {
        coords: t.TN,
        tooltip: { text: "Tamil Nadu" },
        label: { text: "TN" },
      },
      AS: { coords: t.AS, tooltip: { text: "Assam" }, label: { text: "AS" } },
      BR: { coords: t.BR, tooltip: { text: "Bihar" }, label: { text: "BR" } },
      JH: {
        coords: t.JH,
        tooltip: { text: "Jharkhand" },
        label: { x: "85.05lon", y: "23.48lat", text: "JH" },
      },
      CT: {
        coords: t.CT,
        tooltip: { text: "Chhattisgarh" },
        label: { x: "82.31lon", y: "22.11lat", text: "CT" },
      },
      KL: { coords: t.KL, tooltip: { text: "Kerala" }, label: { text: "KL" } },
      JK: {
        coords: t.JK,
        tooltip: { text: "Jammu and Kashmir" },
        label: { text: "JK" },
      }, LA: {
        coords: t.LA,
        tooltip: { text: "Ladakh" },
      ...
      AP: {
        coords: t.AP,
        tooltip: { text: "Andhra Pradesh" },
        label: { text: "AP" },
      },
      TL: {
        coords: t.TL,
        tooltip: { text: "Telangana" },
        label: { text: "TL" },
      },
      HP: {
        coords: t.HP,
        tooltip: { text: "Himachal Pradesh" },
        label: { text: "HP" },
      },
      CH: {
        coords: t.CH,
        tooltip: { text: "Chandigarh" },
        label: { text: "CH" },
      },
      UP: {
        coords: t.UP,
        tooltip: { text: "Uttar Pradesh" },
        label: { text: "UP" },
      },
      RJ: {
        coords: t.RJ,
        tooltip: { text: "Rajasthan" },
        label: { text: "RJ" },
      },
      AR: {
        coords: t.AR,
        tooltip: { text: "Arunachal Pradesh" },
        label: { x: "94.65lon", y: "28.45lat", text: "AR" },
      },
      DL: { coords: t.DL, tooltip: { text: "Delhi" }, label: { text: "DL" } },
      PB: { coords: t.PB, tooltip: { text: "Punjab" }, label: { text: "PB" } },
      AN: {
        coords: t.AN,
        tooltip: { text: "Andaman and Nicobar" },
        label: { x: "93.55lon", y: "10.97lat", text: "AN" },
      },
      UT: {
        coords: t.UT,
        tooltip: { text: "Uttaranchal" },
        label: { text: "UT" },
      },
      HR: { coords: t.HR, tooltip: { text: "Haryana" }, label: { text: "HR" } },
      SK: { coords: t.SK, tooltip: { text: "Sikkim" }, label: { text: "SK" } },
      WB: {
        coords: t.WB,
        tooltip: { text: "West Bengal" },
        label: { text: "WB", x: "87.63lon", y: "23.00lat" },
      },
      NL: {
        coords: t.NL,
        tooltip: { text: "Nagaland" },
        label: { text: "NL" },
      },
      MP: {
        coords: t.MP,
        tooltip: { text: "Madhya Pradesh" },
        label: { x: "78.27lon", y: "22.97lat", text: "MP" },
      },
      ML: {
        coords: t.ML,
        tooltip: { text: "Meghalaya" },
        label: { text: "ML" },
      },
      MN: { coords: t.MN, tooltip: { text: "Manipur" }, label: { text: "MN" } },
      GJ: { coords: t.GJ, tooltip: { text: "Gujarat" }, label: { text: "GJ" } },
      TR: { coords: t.TR, tooltip: { text: "Tripura" }, label: { text: "TR" } },
      MZ: { coords: t.MZ, tooltip: { text: "Mizoram" }, label: { text: "MZ" } },
      OR: { coords: t.OR, tooltip: { text: "Orissa" }, label: { text: "OR" } },
      MH: {
        coords: t.MH,
        tooltip: { text: "Maharashtra" },
        label: { x: "75.03lon", y: "19.53lat", text: "MH" },
      },
      DD: {
        coords: t.DD,
        tooltip: { text: "Daman and Diu" },
        label: { text: "DD" },
      },
      DN: {
        coords: t.DN,
        tooltip: { text: "Dadra and Nagar Haveli" },
        label: { text: "DN" },
      },
      KA: {
        coords: t.KA,
        tooltip: { text: "Karnataka" , values: "2" },
        label: { x: "75.59lon", y: "14.12lat", text: "KA"  },
        
      },

      GA: { coords: t.GA, tooltip: { text: "Goa" }, label: { text: "GA" } },
      PY: {
        coords: t.PY,
        tooltip: { text: "Puducherry" },
        label: { text: "PY" },
      },
    }),
      zingchart.maps.upgrade("ind");
  })(),
  (zingchart.maps.ind = function (t, o, a) {
    return zingchart.maps.convert({
      loader: this,
      loaderdata: o || {},
      graphid: "undefined" == typeof t.graphid ? 0 : t.graphid,
      data: a,
      id: t.id || "ind",
      x: "undefined" == typeof t.x ? 0 : t.x,
      y: "undefined" == typeof t.y ? 0 : t.y,
      width: "undefined" == typeof t.width ? 1 : t.width,
      height: "undefined" == typeof t.height ? 1 : t.height,
      level: "undefined" == typeof t.level ? 1 : t.level,
      groups: t.groups || [],
      items: t.items || [],
      ignore: t.ignore || [],
      bbox: t.bbox || null,
      map: zingchart.maps.data.ind,
    });
  });
