...
use App\Http\Controllers\admin\MfaqController;
...
use App\Http\Controllers\admin\termConditionController;
...
Route::post('/import-csv', [StudentController::class, 'importTest'])->name('import.csv');
Route::post('/importdata-csv', [StudentController::class, 'importdatacsv'])->name('importdata.csv');
...
Route::middleware('admin')->group(function () {
    ...
    Route::get('/delete/resourse', [StudentController::class, 'deleteResourse']); 
    ...
    Route::post('/student/delete', [StudentController::class, 'deletemultipleApplicants'])->name('admin.multiDelete.status');
    Route::post('/webinars/add', [StudentController::class, 'addMultipleWebinars'])->name('admin.multiplewebninars.add');
    ...
    Route::get('/student/request/delete', [StudentController::class, 'requestDelete'])->name('admin.request.delete');
    ...
    Route::get('/student/request/details/{id?}', [StudentController::class, 'requestDetails'])->name('admin.request.details');
    ...
    Route::get('/microsite/faq/list', [MfaqController::class, 'index'])->name('admin.mfaq.list');
    Route::get('/microsite/faq/edit/{id}', [MfaqController::class, 'edit'])->name('admin.mfaq.edit');
    Route::get('/microsite/faq/view/{id}', [MfaqController::class, 'view'])->name('admin.mfaq.view');
    Route::get('/microsite/faq/delete/{id}', [MfaqController::class, 'delete'])->name('admin.mfaq.delete');
    Route::get('/microsite/faq/add', [MfaqController::class, 'add'])->name('admin.mfaq.add');
    Route::put('/microsite/faq/update/{id}', [MfaqController::class, 'update'])->name('admin.mfaq.update');
    Route::post('/microsite/faq/store', [MfaqController::class, 'store'])->name('admin.mfaq.store');


    Route::get('/microsite/term/list', [termConditionController::class, 'index'])->name('admin.term.list');
    Route::get('/microsite/term/edit/{id}', [termConditionController::class, 'edit'])->name('admin.term.edit');
    Route::get('/microsite/term/view/{id}', [termConditionController::class, 'view'])->name('admin.term.view');
    Route::get('/microsite/term/delete/{id}', [termConditionController::class, 'delete'])->name('admin.term.delete');
    Route::get('/microsite/term/add', [termConditionController::class, 'add'])->name('admin.term.add');
    Route::put('/microsite/term/update', [termConditionController::class, 'update'])->name('admin.term.update');
    Route::post('/microsite/term/store', [termConditionController::class, 'store'])->name('admin.term.store');
    ...
    Route::post('/awarded/students/verify', [ScholarshipController::class, 'verifydoc'])->name('admin.verifydoc');
    ...
    Route::prefix('notification')->group(function(){
        Route::get('/fetch', [NotificationController::class, 'fetch'])->name('admin.notification.fetch');
        Route::get('/fetch-all', [NotificationController::class, 'fetchAll'])->name('admin.notification.fetch-all');
        Route::post('/markAsRead', [NotificationController::class, 'markAsRead'])->name('admin.notification.mark-as-read');
    });
});
