  ...
  <table style="width:100%; border-collapse:collapse; font-family: 'Roboto', sans-serif; font-size: 14px;" >
    ...
    <tr>
      <td style="text-align:left; padding:20px 20px; word-break: break-word; color: #000000; font-size: 14px; " >
        ...
        <p>Your One-Time Password (OTP) for verifying your {{ config('app.name') }} account is:</p>

        <br>

        <p style="margin-bottom: 20px;">
          <a href="#" style="background: #EC5D1F; padding: 10px 20px; color: #fff; font-size: 14px; font-weight: bold; text-decoration: none; ">{{ $otp }}</a>
        </p>
        <br>
        <p>This OTP is valid for the next 10 minutes. Please do not share it with anyone.</p>
        <p>If you did not request this, please ignore this message.</p>
        <p>Thanks, <br>
                <strong>Team {{ config('app.name') }}</strong><br />
        </p>
