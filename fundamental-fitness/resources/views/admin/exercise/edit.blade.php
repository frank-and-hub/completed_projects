                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <div class="planfreq">
                                        ...
                                        <div class="pt-1">
                                            @if (!empty($workout) && $workout->workout_frequency_id)
                                                {{-- Show only populated value --}}
                                                <p class="mb-0 showcasevalue">
                                                    {{ $workoutFrequencies->firstWhere('id', $workout->workout_frequency_id)->name ?? 'N/A' }}
                                                </p>
                                                <input type="hidden" name="workout_frequency"
                                                    value="{{ $workout->workout_frequency_id }}">
                                            @else
                                                {{-- Show radios (create mode) --}}
                                                @foreach ($workoutFrequencies as $key => $workoutFrequency)
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="{{ $workoutFrequency->days_in_week }}">{{ $workoutFrequency->name }}</label>
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <div class="planfreq">
                                        ...
                                        <div class="pt-1">
                                            @if (!empty($workout) && $workout->meso_id)
                                                <p class="mb-0 showcasevalue">
                                                    {{ $mesos->firstWhere('id', $workout->meso_id)->name ?? 'N/A' }}
                                                </p>
                                                <input type="hidden" name="meso" value="{{ $workout->meso_id }}">
                                            @else
                                ...
                                <div class="col-sm-12 col-lg-4">
                                    <div class="planfreq">
                                        ...
                                        <div class="pt-1" id="week-container">
                                            @if (!empty($workout) && $workout->week_id)
                                                <p class="mb-0 showcasevalue">Week {{ $workout->week_id }}</p>
                                                <input type="hidden" name="week" value="{{ $workout->week_id }}">
                                            @else
                                                @for ($i = 1; $i <= 4; $i++)
                                                    <div class="form-check form-check-inline">
                        ...
                        <div class="col-sm-12 mt-4">
                            ...
                            <div class="accordion darkaccordian w-100" id="daysAccordion">
                                ...
                                @for ($day = 1; $day <= $maxDays; $day++)
                                    <div class="accordion-item day-item" data-day="{{ $day }}"
                                        style="{{ $currentDay == $day ? '' : 'display: none;' }}">
                                        <h2 class="accordion-header"
                                            id="heading{{ ucfirst(Str::words(Str::studly('Day' . $day), 1, '')) }}">
                                            <button
                                                class="accordion-button {{ $currentDay != $day ? 'collapsed' : '' }}"
                                                type="button" data-bs-toggle="collapse"
                                                data-bs-target="#collapse{{ ucfirst(Str::words(Str::studly('Day' . $day), 1, '')) }}"
                                                aria-expanded="{{ $currentDay == $day ? 'true' : 'false' }}"
                                                aria-controls="collapse{{ ucfirst(Str::words(Str::studly('Day' . $day), 1, '')) }}">
                                                Day {{ $day }}
                                            </button>
                                        </h2>
                                        <div id="collapse{{ ucfirst(Str::words(Str::studly('Day' . $day), 1, '')) }}"
                                            class="accordion-collapse collapse {{ $currentDay == $day ? 'show' : '' }}"
                                            aria-labelledby="heading{{ ucfirst(Str::words(Str::studly('Day' . $day), 1, '')) }}"
                                                                    ...
                                                                    <select name="exercise_id[]"
                                                                        ...
                                                                        @foreach ($exercises as $exercise)
                                                                            <option value="{{ $exercise->id }}"
                                                                                ...
                                                                                {{ $workout->exercise_id == $exercise->id ? 'selected' : '' }}>
                                                                                {{ $exercise->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="row setcolswidh">
                                                                <div class="col-xxl-8 col-xl-12">
                                                                        ...
                                                                        <div class="pt-1">
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    id="Beginner_day{{ $day }}"
                                                                                    value="1"
                                                                                    {{ $workout->level == 1 ? 'checked' : '' }}>
                                                                                <label class="form-check-label"
                                                                                    for="Beginner_day{{ $day }}">Beginner</label>
                                                                            </div>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input"
                                                                                    type="radio"
                                                                                    name="level_day{{ $day }}[]"
                                                                                    id="Intermediate_day{{ $day }}"
                                                                                    value="2"
                                                                                    {{ $workout->level == 2 ? 'checked' : '' }}>
                                                                                <label class="form-check-label"
                                                                                    for="Intermediate_day{{ $day }}">Intermediate</label>
                                                                            </div>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input"
                                                                                    type="radio"
                                                                                    ...
                                                                                    id="Advanced_day{{ $day }}"
                                                                                    value="3"
                                                                                    {{ $workout->level == 3 ? 'checked' : '' }}>
                                                                                <label class="form-check-label"
                                                                                    for="Advanced_day{{ $day }}">Advanced</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="d-block w-full mb-3 p-2 setsformbox rounded-3 normal-exercise"
                                                                        style="{{ (isset($workout->exercise) && $workout->exercise->type == 'running') || $workout->exercise_id == $runId ? 'display: none !important;' : '' }}">
                                                                                            ...
                                                                                            <td valign="top"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div class="input-group rpe-percentage-input"
                                                                                                        style="width: 70px; {{ $set->rpe == 0 ? '' : 'display: none;' }}">
                                                                                                        <input
                                                                                                            type="text"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td valign="top">
                                                                                                ...
                                                                                                <select
                                                                                                    ...
                                                                                                    <option
                                                                                                        value="1"
                                                                                                        {{ $set->reps_unit == 'min' ? 'selected' : '' }}>
                                                                                                        Duration
                                                                                                    </option>
                                                                                                    <option
                                                                                                        value="2"
                                                                                                        {{ $set->reps_unit == 'km' ? 'selected' : '' }}>
                                                                                                        Distance
                                                                                                    </option>
                                                                                                </select>
                                                                                            </td>
                                                                                            <td valign="top">
                                                                                                <div
                                                                                                    ...
                                                                                                    <span
                                                                                                        ...
                                                                                                        style="width:40px;">{{ $set->reps_unit }}</span>
                                                                                                </div>
                                                                                            </td>
                                                                                            <td valign="top">
                                                                                                <div
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                @else
                                                                                    <div
                                                                                        ...
                                                                                        <span class="filesizebox">
                                                                                            <img src="{{ asset('assets/images/login-left-img.png') }}"
                                                                                                alt="image" />
                                                                                        </span>
                                                                                        <span
                                                                                            class="deletelinkbtn" data-type="image">Delete</span>
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                @if ($workout->gif)
                                                                                    <div class="uploadedfiledisplay">
                                                                                        <span class="filesizebox">
                                                                                            <a href="{{ asset('/' . $workout->gif) }}"
                                                                                                target="_blank"
                                                                                                rel="noopener noreferrer">
                                                                                                <img src="{{ asset('/' . $workout->gif) }}"
                                                                                                    alt="GIF Image"
                                                                                                    style="width: 100%; height: 100%; object-fit: cover; border-radius: 4px; cursor: pointer;" />
                                                                                            </a>
                                                                                        </span>
...
<script>
    $(document).ready(function() {
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="position-relative w-100">
                                <select name="exercise_id[]" class="form-control form-select exercise-select" required>
                                    <option value="">Select Exercise</option>
                                    @foreach ($exercises as $exercise)
                                        <option value="{{ $exercise->id }}" data-type="{{ $exercise->type ?? 'normal' }}">
                                            {{ $exercise->name }}
                                        </option>
                                    @endforeach
                                </select>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="uploadedfiledisplay d-none">
                                                <span class="filesizebox">
                                                    <img src="{{ asset('assets/images/login-left-img.png') }}" alt="image" />
                                                </span>
        ...
        $(document).on('click', '.submit-btn', function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.exerciseUpdate') }}",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
