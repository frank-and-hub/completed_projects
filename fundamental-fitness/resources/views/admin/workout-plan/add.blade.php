...
@section('content')
@section('admin-title', 'Add Workout Plan')

<!-- Add jQuery CDN -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

<form action="{{ route('admin.workoutPlansSave') }}" method="POST" enctype="multipart/form-data" id="addExerCise">
    @csrf
                ...
                <div class="row create-workout-form">
                    ...
                    {{-- <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <select class="form-control form-control-lg" id="goal" name="goal">
                                    <option value="">Select goal</option>
                                    <option value="Muscle Gain" {{ old('goal') == 'Muscle Gain' ? 'selected' : '' }}>
                                        Muscle Gain</option>
                                    <option value="Weight Loss" {{ old('goal') == 'Weight Loss' ? 'selected' : '' }}>
                                        Weight Loss</option>
                                    <option value="Get Shredded" {{ old('goal') == 'Get Shredded' ? 'selected' : '' }}>
                                        Get Shredded</option>
                                </select>
