...
<div class="container-fluid pt-3 bg">
    <div class="page-content-wrapper">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="whiteBg">
                    <form action="<?php echo e(route('admin.workoutPlansUpdate', $singleUser->id)); ?>" method="post"
...
<?php echo $__env->make('admin.layout.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/app.fundamental-fit.co.uk/releases/20251124_065248/resources/views/admin/workout-plan/view.blade.php ENDPATH**/ ?>