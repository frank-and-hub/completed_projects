...
<?php $__env->startSection('admin-title', 'Add Workout Plan'); ?>

<!-- Add jQuery CDN -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

<form action="<?php echo e(route('admin.workoutPlansSave')); ?>" method="POST" enctype="multipart/form-data" id="addExerCise">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="weeks_data" id="weeks_data">
    <div class="container-fluid">
        <div class="pate-content-wrapper">
            <div class="page-title-row">
                <h5>Create Workout Program</h5>
            </div>
            <div class="m-card-min-hight">
                <div class="row create-workout-form">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control form-control-lg" id="title" name="title"
                                    placeholder="Enter title" value="<?php echo e(old('title')); ?>" maxlength="50">
                                <div id="titleError" class="text-danger mt-1" style="display: none;"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="number" class="form-control form-control-lg" id="duration"
                                    ...
                                    max="100" step="1" oninput="validateDuration(this)"
                                    value="<?php echo e(old('duration_weeks')); ?>">
                    ...
                    <div class="col-md-6 uploa">
                       <div class="mb-3">
                            <label for="workoutImage" class="form-label">Upload Image<span
                                    style="color:red;">*</span></label>
                            <div class="rounded py-2"> <!-- Added padding and border container -->
                                <input class="form-control form-control-lg" id="workoutImage" name="image"
                                    type="file" accept=".jpg,.jpeg,.png">
                            </div>
                            <small class="text-muted mt-1 d-block">Please upload a 120x120 pixel image for best
                                view.</small>
                                        ...
                                        <table class="table align-middle">
                                            ...
                                            <tbody>
                                                <tr class="no-exercises">
                                                    <td colspan="9" class="text-center">No exercises added yet</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="number" class="form-control" id="exerciseRestTime"
                                placeholder="Enter Rest Time (max-1800)" min="1" max="1800" step="1"
...
<script>
    $(document).ready(function() {
        ...
        $('#exerciseSelect').on('change', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.exercises.details')); ?>",
                type: 'GET',
                data: {
                    id: exerciseId
                },
        ...
        $('#addExerCise').on('submit', function(e) {
            ...
            if (!title) {
                ...
                $('#titleError').text('Title must be less than 100 characters').show();
                isValid = false;
            }
            ...
            if (!description) {
                ...
                $('#descriptionError').text('Description must be less than 1200 characters').show();
                isValid = false;
            }

            // Validate at least one week exists
            if ($('.week').length === 0) {
                alert('Please add at least one week to the workout plan');
                isValid = false;
            } else {
                // Validate all days have either exercises or are rest days
                isValid = validateAllDays() && isValid;

                // Validate at least one exercise exists somewhere in the workout
        ...
        $(document).on('change', '.rest-day-toggle', function() {
            ...
            if ($(this).is(':checked')) {
                ...
                tableBody.html(
                    '<tr class="no-exercises"><td colspan="9" class="text-center">No exercises added yet</td></tr>'
                    );
        ...
        $(document).on('input', '.exercise-search', function() {
            ...
            if (!hasResults && tableBody.find('tr[data-exercise-id]').length > 0) {
                tableBody.append(
                    '<tr class="no-results"><td colspan="9" class="text-center">No results found</td></tr>'
                    );
            }
        });
...
<?php echo $__env->make('admin.layout.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/app.fundamental-fit.co.uk/releases/20251124_065248/resources/views/admin/workout-plan/add.blade.php ENDPATH**/ ?>