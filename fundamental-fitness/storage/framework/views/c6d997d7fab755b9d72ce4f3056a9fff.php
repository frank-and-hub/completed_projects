...
<body>
    ...
    <div class="container">
      <header class="section">
        ...
        <section class="section">
            ...
            <p>Please refer to our <a href="<?php echo e(route('privacy-policy')); ?>" class="contact-info">Privacy Policy</a> for information on how we collect, use, and protect your personal data.</p>
        </section>
    ...
    <footer>
        <p>© <?php echo e(date('Y')); ?> FundamentalFitness. All rights reserved.</p>
    </footer>

</body>

</html>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script><?php /**PATH /var/www/app.fundamental-fit.co.uk/releases/20251124_065248/resources/views/terms-condition.blade.php ENDPATH**/ ?>