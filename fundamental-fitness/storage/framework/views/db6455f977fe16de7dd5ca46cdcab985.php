...
<?php $__env->startSection('admin-title', 'Verify OTP'); ?>
        ...
        <div class="loginRightImg">
            <div class="login-container">
                <div class="text-center mb-5">
                    <img src="<?php echo e(asset('assets/images/logo-login.svg')); ?>">
                </div>
                <form method="post" action="<?php echo e(route('admin.verifyOtp')); ?>" id="otpForm">
                    <?php echo csrf_field(); ?>
                    <div class="whiteBg">
                        <h4>Enter OTP</h4>
...
<?php echo $__env->make('admin.auth.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/app.fundamental-fit.co.uk/releases/20251124_065248/resources/views/admin/auth/otp_verify.blade.php ENDPATH**/ ?>