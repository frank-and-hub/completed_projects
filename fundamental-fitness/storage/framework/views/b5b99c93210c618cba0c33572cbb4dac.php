        ...
        <tr>
            <td style="padding: 30px;">
                <p style="font-size: 16px; color: #2d3748; margin: 0 0 16px;">
                    <strong>Hi <?php echo e(ucfirst($name)); ?>,</strong>
                </p>

                <p style="font-size: 15px; color: #4a5568; line-height: 1.6;">
                    We received a request to reset the password for your <?php echo e(config('app.name')); ?> Account.
                </p>
                ...
                <p style="font-size: 14px; color: #4a5568; margin-top: 24px;">
                 Thanks,<br>  <strong> Team <?php echo e(config('app.name')); ?> </strong>
                </p>
            </td>
        </tr>
    </table>
...
<?php /**PATH /var/www/app.fundamental-fit.co.uk/releases/20251124_065248/resources/views/emails/reset-password.blade.php ENDPATH**/ ?>