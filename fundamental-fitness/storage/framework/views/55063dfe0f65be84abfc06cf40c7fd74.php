...
<?php $__env->startSection('admin-title', 'Add Exercise'); ?>
                                            ...
                                            <?php $__currentLoopData = $workoutFrequencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $workoutFrequency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="<?php echo e($workoutFrequency->days_in_week); ?>"><?php echo e($workoutFrequency->name); ?>
                                            ...
                                            <?php for($i = 1; $i <= 4; $i++): ?>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input week-radio" type="radio"
                                                        ...
                                                        value="<?php echo e($i); ?>" <?php echo e($i === 1 ? '' : ''); ?>>
                                                            ...
                                                            <select name="exercise_id[]"
                                                                ...
                                                                <?php $__currentLoopData = $exercises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($exercise->id); ?>"
                                                                        ...
                                                                        <?php echo e($exercise->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="uploadedfiledisplay d-none">
                                                                            <span class="filesizebox"><img
                                                                                    src="<?php echo e(asset('assets/images/login-left-img.png')); ?>"
                                                                                    alt="image" /></span>
...
<script>
            ...
            <div class="form-group mb-3">
                ...
                <div class="position-relative w-100">
                    <select name="exercise_id[]" class="form-control form-select exercise-select" required>
                        <option value="">Select Exercise</option>
                        <?php $__currentLoopData = $exercises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($exercise->id); ?>" data-type="<?php echo e($exercise->type ?? 'normal'); ?>"><?php echo e($exercise->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="uploadedfiledisplay d-none">
                                    <span class="filesizebox"><img src="<?php echo e(asset('assets/images/login-left-img.png')); ?>" alt="image"/></span>
                                    <span class="deletelinkbtn">Delete</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="uploadedfiledisplay d-none">
                                    <span class="filesizebox isvideobg"><img src="<?php echo e(asset('assets/images/login-left-img.png')); ?>" alt="image"/></span>
                                    <span class="deletelinkbtn">Delete</span>
                                </div>
                            </div>
                        </div>
    ...
    `;
        ...
        $(document).on('click', '.submit-btn', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.exerciseSave')); ?>",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
    ...
    function checkExistingData() {
        ...
        $.ajax({
            url: "<?php echo e(route('admin.checkExistingExerciseData')); ?>",
            type: 'GET',
            data: {
...
<?php echo $__env->make('admin.layout.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/app.fundamental-fit.co.uk/releases/20251124_065248/resources/views/admin/exercise/add.blade.php ENDPATH**/ ?>