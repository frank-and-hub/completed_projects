                ...
                <div class="mb-3 headerserarch ">
                    <form method="GET" action="<?php echo e(route('admin.workoutPlansIndex')); ?>" class="d-flex mb-2 align-items-center">
                        <input type="text" class="form-control" name="search" value="<?php echo e(request('search')); ?>"
                            class="form-control icon-holder me-2" placeholder="Search name, email...">
    ...
    $(document).ready(function() {
        ...
        $('#confirmDeleteExercise').click(function() {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    $('#deleteExerciseModal').modal('hide');
                    $('#successMessage').text('Error deleting workout plan. this plan is assign to users.');
                    $('#successModal').modal('show');
                }
            });
        });
...
<?php echo $__env->make('admin.layout.index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/app.fundamental-fit.co.uk/releases/20251124_065248/resources/views/admin/workout-plan/index_old.blade.php ENDPATH**/ ?>