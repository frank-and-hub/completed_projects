...
@section('content')
    ...
    <div class="card">
        <div class="card-header bg-lightblue mb-0">
            <div class="d-flex">
                ...
                <div class="form-inline ml-3 d-flex">
                    <label for="type" class="form-label">Type:</label>
                    <select name="type" id="type" class="ml-2 selectpicker" data-width="190px"
                        data-style="border border-muted">
                        <option value="all" selected="">
        ...
        <div style="position: relative">
            <div id="parent_feature" class="d-none">
                <x-admin.datatable id="feature_type-table" title="{{-- Parent Features --}}" loaderID="dt-loader">
                    <x-slot:headings>
                        <th>Name</th>
                        {{-- <th>Priority</th> --}}
                        <th>Type</th>
        ...
        {{-- Child table --}}
        <div style="position: relative" >
            <div id="child_feature" class="d-none">
                <x-admin.datatable id="child-feature-dt-table" title="{{-- Child Features --}}" loaderID='child-feature-dt-loader'>
                    <x-slot:headings>
                        <th>Name</th>
                        <th>Type</th>
    ...
    <div style="position: relative">
        <div id="popular_child_feature" class="d-block">
            <x-admin.datatable id="feature-table" title="" loaderID='popular-child-feature-dt-loader'>
                <x-slot:headings>
                    <th>Name</th>
                    {{-- <th>Parent Feature / Total Child Count</th> --}}
                    <th>Related Parks</th>
                    <th>Action</th>
                </x-slot:headings>
            </x-admin.datatable>
...
@push('script')
    <script type="text/javascript">
        ...
        var childFeatureUrl = "{{ route('admin.feature_type.new_dt_list') }}";
