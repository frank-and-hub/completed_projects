...
@section('content')
    <div class="d-flex align-items-center py-3 mb-4">
        <h5 class="fw-bold mb-0" style="flex: 1"><span><a href="{{ route('admin.dashboard') }}"`><u
                ...
                </a></span><span class="text-primary fw-light"> / </span>Delete Account Requests</h5>
...
@push('script')
    <script>
        var uRL = "{{ route('admin.delete.dt_list') }}";
    </script>
    <script src="{{ asset('assets/js/dt/delete-dt.js') }}"></script>
@endpush
