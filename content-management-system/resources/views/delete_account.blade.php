...
<body>
    ...
    <form role="form" method="post" action="{{ route('delete-account-save') }}" data-parsley-validate
        autocomplete="off">
        @csrf
        ...
        <h6 class="mt-2 text-center" style="color:black; ">Enter your details to send request to delete your account
        </h6>
        <div class="">
        ...
        <div class="">
            <label for="reasom" class="form-label text-primary">Reason for deleting the account</label>
            <textarea type="text" class="form-control" id="reason" name="reason" placeholder="Enter your reason"
                required max=255></textarea>
        </div>

        <div class="btn-container mt-5">
            <button class="btn btn-primary d-grid w-100" type="submit">Send Request </button>
        </div>
    </form>
