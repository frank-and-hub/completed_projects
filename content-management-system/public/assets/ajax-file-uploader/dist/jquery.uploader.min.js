                                ...
                                buttons: {
                                    confirm: {
                                        ...
                                        action: function () {
                                            ...
                                            if(r)
                                            {
                                                if($("#"+r).find('.removeBannerBtn').hasClass('removeBannerBtn')){
                                                    $("#bannerImg").attr('src',
                                                                 default_img);
                                                }
                                            }
                                            ...
                                            let l=-1;self.files.forEach(((e,i)=>{e.id===r&&(l=i)}));let s=self.files.splice(l,1);
                                            s.url&&d.revokeBlobUrl(s.url),
                                            self.$originEle.trigger("file-remove",...s),
                                            self.refreshValue(),
                                            self.refreshPreviewFileList()
                                        }
                                    },
                                    cancel: function () {
