...
(function ($) {
	...
	// 		'<div id="lcl_nav_cmd" style="/* position: relative; */">'+
	...
	'<div id="lcl_wrap" class="lcl_pre_show lcl_pre_first_el lcl_first_sizing lcl_is_resizing">'+
		'<div id="lcl_window">'+
			...
			'<div id="lcl_loader" class="lcl_loader_pre_first_el"><span id="lcll_1"></span><span id="lcll_2"></span></div>'+
			'<div id="lcl_nav_cmd" style="/* position: relative; */">'+
				'<div class="lcl_icon lcl_prev d-none" title="previous"></div>'+
				'<div class="lcl_icon lcl_next d-none" title="next"></div>'+
				'<div class="lcl_icon lcl_play" style="visibility:hidden;"></div>'+
				...
				'<div class="lcl_icon lcl_right_icon lcl_thumbs_toggle" title="toggle thumbnails"></div>'+
				'<div class="lcl_icon lcl_right_icon lcl_socials" title="toggle socials"></div>'+
                '<div style="margin:auto; position:relative; top:50% !important;">'+
	...
	var lcl = function(obj, settings) {
		...
		var lcl_settings = $.extend({
			...
			fs_img_behavior	: 'fill', // resize mode of the fullscreen image - smart/fit/fill
			...
			lcl_size_n_show_timeout = setTimeout(function() {
				...
				if(el.type == 'image') {
					if($('.lcl_fullscreen_mode').length) {
						...
						// $('.lcl_image_elem').css('background-size', '100% 100%');
					}
				}
